...
public class DuplicateGenericSchemaTest extends TalendSwtBotForTos {

    private TalendGenericSchemaItem genericSchemaItem;

    private static final String SCHEMANAME = "schema1"; //$NON-NLS-1$

    private static final String NEW_SCHEMANAME = "duplicate_schema1"; //$NON-NLS-1$
    ...
    public void duplicateGenericSchema() {
        genericSchemaItem.duplicate(NEW_SCHEMANAME);
    }
