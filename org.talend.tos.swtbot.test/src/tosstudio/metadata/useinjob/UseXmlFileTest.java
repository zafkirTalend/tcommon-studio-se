...
public class UseXmlFileTest extends TalendSwtBotForTos {
    ...
    public void createJobAndMetadata() throws IOException, URISyntaxException {
        ...
        metadataNode = Utilities.getTalendItemNode(tree, Utilities.TalendItemType.FILE_XML);
    ...
    public void useMetadataInJob() throws IOException, URISyntaxException {
        TalendXmlFileItem efItem = new TalendXmlFileItem();
        efItem.setItem(fileItem);
        efItem.setFilePath(System.getProperty("fileXml.filepath"));
        efItem.setComponentType("tFileInputXML");
