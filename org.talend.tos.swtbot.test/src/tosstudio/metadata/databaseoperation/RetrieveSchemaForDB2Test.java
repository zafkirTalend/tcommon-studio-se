...
public class RetrieveSchemaForDB2Test extends TalendSwtBotForTos {

    private TalendDBItem dbItem;

    private static String DB_NAME = "db2";
    ...
    public void createMetadata() {
        ...
        dbItem = new TalendDBItem(DB_NAME, Utilities.DbConnectionType.DB2);
        dbItem.create();
