...
public class CopyPastePositionalFile {
    ...
    @Test
    public void copyPositionalFile() {
        ...
        tree.expandNode("Metadata", "File positional").getNode(FILENAME + " " + DEFAULT_VERSION).contextMenu("Copy").click();
    }

    @Test
    public void pastePositionalFile() {
