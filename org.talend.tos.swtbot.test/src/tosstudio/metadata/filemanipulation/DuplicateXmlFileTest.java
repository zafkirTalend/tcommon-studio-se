...
public class DuplicateXmlFileTest extends TalendSwtBotForTos {

    private TalendXmlFileItem fileItem;

    private static final String FILENAME = "test_xml"; //$NON-NLS-1$

    private static final String NEW_FILENAME = "duplicate_xml"; //$NON-NLS-1$
