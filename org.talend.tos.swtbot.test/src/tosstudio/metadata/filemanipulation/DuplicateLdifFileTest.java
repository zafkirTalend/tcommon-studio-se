...
public class DuplicateLdifFileTest extends TalendSwtBotForTos {

    private TalendLdifFileItem fileItem;

    private static final String FILENAME = "test_ldif"; //$NON-NLS-1$

    private static final String NEW_FILENAME = "duplicate_ldif"; //$NON-NLS-1$
