...
public class CopyPasteLdifFile {
    ...
    public void copyLdifFile() {
        ...
        tree.expandNode("Metadata", "File ldif").getNode(FILENAME + " " + DEFAULT_VERSION).contextMenu("Copy").click();
    }

    @Test
    public void pasteLdifFile() {
