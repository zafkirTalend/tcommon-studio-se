...
public class DuplicateWebServiceTest extends TalendSwtBotForTos {

    private TalendWebServiceItem webserviceItem;

    private static final String WEBSERVICENAME = "webService1"; //$NON-NLS-1$

    private static final String NEW_WEBSERVICENAME = "dup_webService1"; //$NON-NLS-1$
    ...
    public void duplicateWebService() {
        webserviceItem.duplicate(NEW_WEBSERVICENAME);
    }
