...
public class DuplicateEdiTest extends TalendSwtBotForTos {

    private TalendEdiItem ediItem;

    private static final String EDINAME = "ediTest";

    private static final String NEW_EDINAME = "dup_ediTest";
    ...
    @Test
    public void duplicateEdi() {
        Utilities.duplicate(ediItem.getParentNode(), EDINAME, "0.1", NEW_EDINAME);
    }
