...
public class JobletWithOnlyInputTest extends TalendSwtBotForTos {
    ...
    @Test
    public void testJobletWithOnlyInput() {
        // config joblet with only input
        SWTBotGefEditor jobletEditor = jobletItem.getEditor();
        jobletEditor.show();
        jobletItem.deleteComponentInJoblet(getTalendComponentPart(jobletEditor, "OUTPUT_1"));
        ...
        // connet to tLogRow
        JobHelper.connect2TLogRow(jobletEditor, input, new Point(300, 100));
