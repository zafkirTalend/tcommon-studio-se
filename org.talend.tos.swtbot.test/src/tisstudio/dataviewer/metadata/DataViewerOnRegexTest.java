...
public class DataViewerOnRegexTest extends TalendSwtBotForTos {
    ...
    public void testDataViewer() {
        ...
        SWTBotGefEditPart regex = getTalendComponentPart(jobItem.getEditor(), FILENAME);
        Assert.assertNotNull("cann't get component " + fileItem.getComponentType() + "", regex);

        // data Viewer
        Utilities.dataView(jobItem, regex, fileItem.getComponentType());
