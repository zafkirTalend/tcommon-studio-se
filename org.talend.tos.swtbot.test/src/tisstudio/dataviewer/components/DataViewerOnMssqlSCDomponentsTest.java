...
public class DataViewerOnMssqlSCDomponentsTest extends TalendSwtBotForTos {
    ...
    public void dataViewer() {
        ...
        SWTBotGefEditPart gefEditPart = getTalendComponentPart(jobItem.getEditor(), "tMSSqlSCD_1");
        Assert.assertNotNull("cann't get component tMSSqlSCD_1", gefEditPart);
        ...
        Utilities.dataViewOnSCDComponent(jobItem, "tMSSqlSCD", DBNAME, gefEditPart);
    }
