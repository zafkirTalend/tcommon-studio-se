...
public class DataViewerOnOracleSDComponentsTest extends TalendSwtBotForTos {
    ...
    public void dataViewer() {
        ...
        SWTBotGefEditPart gefEdiPart = getTalendComponentPart(jobItem.getEditor(), "tOracleSCD_1");
        Assert.assertNotNull("cann't get component tOracleSCD_1", gefEdiPart);
        ...
        Utilities.dataViewOnSCDComponent(jobItem, "tOracleSCD", DBNAME, gefEdiPart);
    }
