...
public class DataViewerOnMysqlSDComponentsTest extends TalendSwtBotForTos {
    ...
    private static final String DBNAME1 = "mysql"; //$NON-NLS-1$
    ...
    public void createJob() {
        ...
        dbItem1 = new TalendDBItem(DBNAME1, DbConnectionType.MYSQL);
        dbItem1.create();
    ...
    public void dataViewer() {
        ...
        Utilities.dataViewerOnDBComponent(dbItem1, jobItem, "1a", DBNAME1, "tMysqlSCD");
    }
