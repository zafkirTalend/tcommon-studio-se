    ...
    protected void addIndicatorPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LiteralValue_indicator_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_LiteralValue_indicator_feature", "_UI_LiteralValue_type"),
                 DomainPackage.Literals.LITERAL_VALUE__INDICATOR,
                 true,
                 false,
                 true,
                 null,
