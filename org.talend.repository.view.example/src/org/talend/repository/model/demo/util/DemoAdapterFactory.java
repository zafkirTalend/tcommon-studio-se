 ...
 * $Id$
 */
package org.talend.repository.model.demo.util;
 ...
 * <!-- end-user-doc -->
 * @see org.talend.repository.model.demo.DemoPackage
 * @generated
 */
public class DemoAdapterFactory extends AdapterFactoryImpl {
    ...
    protected DemoSwitch<Adapter> modelSwitch =
        new DemoSwitch<Adapter>() {
            @Override
            public Adapter caseExampleDemoConnectionItem(ExampleDemoConnectionItem object) {
                return createExampleDemoConnectionItemAdapter();
            }
            @Override
            public Adapter caseExampleDemoConnection(ExampleDemoConnection object) {
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.demo.ExampleDemoConnectionItem <em>Example Demo Connection Item</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createExampleDemoConnectionItemAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.demo.ExampleDemoConnection <em>Example Demo Connection</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
