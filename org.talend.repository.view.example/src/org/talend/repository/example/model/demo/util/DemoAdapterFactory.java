...
public class DemoAdapterFactory extends AdapterFactoryImpl {
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.example.model.demo.ExampleDemoConnectionItem <em>Example Demo Connection Item</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.example.model.demo.ExampleDemoConnection <em>Example Demo Connection</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
