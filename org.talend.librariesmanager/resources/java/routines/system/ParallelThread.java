...
public class ParallelThread extends Thread {
	...
	/**
	 * Waiting for buffer is not null get and remove the buffer. Be called by
	 * ParallelThread.
	 * 
	 * @return
	...
	/**
	 * Waiting for buffer is null and set buffer if null Be called by main
	 * thread.
	 * 
	 * @param buffer
	 * @throws InterruptedException
	 */
	public synchronized void putBuffer(Object buffer)
			throws InterruptedException {
		this.set(buffer);
	}
	...
	public ParallelThread(java.util.Map<String, Object> globalMap,
			Object[] lockWrite) {
		super();
		this.globalMap = new ThreadedMap(globalMap);
		this.globalMap.myMap.put("PARALLEL_LOCK_WRITE", lockWrite);
	}
