    ...
    public void doOperations() throws Exception {
        ...
        for (int i = 0; i < nOperationsByOperator; i++) {
            try {
                ...
                System.out.println(System.currentTimeMillis() + ": Locked " + i);
                Thread.sleep(10);
            } finally {
                System.out.println(System.currentTimeMillis() + ": Unlocking " + i);
                try {
                    locker.unlock(i);
                } catch (Exception e) {
                    System.out.println(System.currentTimeMillis() + ": Error when Unlocking " + i);
                    throw e;
                }
            }
        }
