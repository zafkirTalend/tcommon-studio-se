...
public class InformationreportingPackageImpl extends EPackageImpl implements InformationreportingPackage {
    ...
    public static InformationreportingPackage init() {
        if (isInited)
            return (InformationreportingPackage) EPackage.Registry.INSTANCE.getEPackage(InformationreportingPackage.eNS_URI);
        ...
        InformationreportingPackageImpl theInformationreportingPackage = (InformationreportingPackageImpl) (EPackage.Registry.INSTANCE
                .get(eNS_URI) instanceof InformationreportingPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new InformationreportingPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEClass(reportAttributeEClass, ReportAttribute.class, "ReportAttribute", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(reportExecutionEClass, ReportExecution.class, "ReportExecution", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        ...
        initEAttribute(getReportGroup_GroupType(), this.getReportGroupType(), "groupType", null, 0, 1, ReportGroup.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getReportGroup_ReportQuery(), theDatatypesPackage.getQueryExpression(),
                theDatatypesPackage.getQueryExpression_ReportGroup(), "reportQuery", null, 0, -1, ReportGroup.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(reportPackageEClass, ReportPackage.class, "ReportPackage", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
