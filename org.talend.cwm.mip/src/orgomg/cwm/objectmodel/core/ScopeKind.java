 ...
 * <em><b>Scope Kind</b></em>', and utility methods for working with them. <!--
 * end-user-doc --> <!-- begin-model-doc --> In the metamodel ScopeKind defines
 * an enumeration that denotes whether a feature belongs to individual instances
 * or an entire classifier.
 * 
 * The default value is sk_instance. <!-- end-model-doc -->
 * 
...
public enum ScopeKind implements Enumerator {
    ...
    /**
     * The '<em><b>Sk instance</b></em>' literal value. <!-- begin-user-doc -->
     * <!-- end-user-doc --> <!-- begin-model-doc --> The feature pertains to
     * instances of a Classifier. For example, it is a distinct attribute in
     * each instance or an operation that works on an instance. <!--
     * end-model-doc -->
     * 
     * @see #SK_INSTANCE
    ...
    /**
     * The '<em><b>Sk classifier</b></em>' literal value. <!-- begin-user-doc
     * --> <!-- end-user-doc --> <!-- begin-model-doc --> The feature pertains
     * to an entire Classifier. For example, it is an attribute shared by the
     * entire Classifier or an operation that works on the Classifier, such as a
     * creation operation. <!-- end-model-doc -->
     * 
     * @see #SK_CLASSIFIER
     ...
     * @generated
     */
    private static final ScopeKind[] VALUES_ARRAY = new ScopeKind[] { SK_INSTANCE, SK_CLASSIFIER, };
    ...
    public static ScopeKind get(int value) {
        switch (value) {
        case SK_INSTANCE_VALUE:
            return SK_INSTANCE;
        case SK_CLASSIFIER_VALUE:
