...
public class MultiplicityImpl extends ElementImpl implements Multiplicity {
    ...
    public EList<MultiplicityRange> getRange() {
        if (range == null) {
            range = new EObjectContainmentWithInverseEList<MultiplicityRange>(MultiplicityRange.class, this,
                    CorePackage.MULTIPLICITY__RANGE, CorePackage.MULTIPLICITY_RANGE__MULTIPLICITY);
        }
        return range;
    }
