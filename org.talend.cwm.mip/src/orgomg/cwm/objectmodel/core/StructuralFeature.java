...
public interface StructuralFeature extends Feature {
    ...
    /**
     * Returns the value of the '<em><b>Changeability</b></em>' attribute. The
     * literals are from the enumeration
     * {@link orgomg.cwm.objectmodel.core.ChangeableKind}. <!-- begin-user-doc
     * --> <!-- end-user-doc --> <!-- begin-model-doc --> Specifies whether the
     * value may be modified after the object is created. <!-- end-model-doc -->
     * 
     ...
     * begin-model-doc --> The possible number of data values for the feature
     * that may be held by an instance. The cardinality of the set of values is
     * an implicit part of the feature. In the common case in which the
     * multiplicity is 1..1, then the feature is a scalar (i.e., it holds
     * exactly one value). <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Ordering</b></em>' attribute. The
     * literals are from the enumeration
     * {@link orgomg.cwm.objectmodel.core.OrderingKind}. <!-- begin-user-doc -->
     * <!-- end-user-doc --> <!-- begin-model-doc --> Specifies whether the set
     * of instances is ordered. The ordering must be determined and maintained
     * by Operations that add values to the feature. This property is only
     * relevant if the multiplicity is greater than one. <!-- end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.objectmodel.core.StructuralFeature#getOrdering
    ...
    /**
     * Returns the value of the '<em><b>Target Scope</b></em>' attribute. The
     * literals are from the enumeration
     * {@link orgomg.cwm.objectmodel.core.ScopeKind}. <!-- begin-user-doc -->
     * <!-- end-user-doc --> <!-- begin-model-doc --> Specifies whether the
     * targets are ordinary Instances or are Classifiers. <!-- end-model-doc -->
     * 
     ...
     * --> <!-- begin-model-doc --> Identifies the Classifier defining the type
     * of a StructuralFeature. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Slot</b></em>' reference list. The list
     * contents are of type {@link orgomg.cwm.objectmodel.instance.Slot}. It is
     * bidirectional and its opposite is '
     * {@link orgomg.cwm.objectmodel.instance.Slot#getFeature <em>Feature</em>}
     * '. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * Identifies the set of Slot instances containing values of the which the
     * StructuralFeature instance. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Indexed Feature</b></em>' reference
     ...
     * begin-model-doc --> Identifies the IndexedFeature instances that describe
     * how a particular StructuralFeature is used by the keys of Index
    ...
    /**
     * Returns the value of the '<em><b>Key Relationship</b></em>' reference
     * list. The list contents are of type
     * {@link orgomg.cwm.foundation.keysindexes.KeyRelationship}. It is
     * bidirectional and its opposite is '
     * {@link orgomg.cwm.foundation.keysindexes.KeyRelationship#getFeature
     * <em>Feature</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Identifies the KeyRelationship instances that employ
     * a particular StructuralFeature as part of their key. <!-- end-model-doc
     * -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Unique Key</b></em>' reference list. The
     * list contents are of type
     * {@link orgomg.cwm.foundation.keysindexes.UniqueKey}. It is bidirectional
     * and its opposite is '
     * {@link orgomg.cwm.foundation.keysindexes.UniqueKey#getFeature
     * <em>Feature</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Identifies the UniqueKey instances in which a
     * particular StructuralFeature participates. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Data Item</b></em>' reference list. The
     * list contents are of type {@link orgomg.cwmx.resource.dmsii.DataItem}. It
     * is bidirectional and its opposite is '
     * {@link orgomg.cwmx.resource.dmsii.DataItem#getStructure
     * <em>Structure</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Identifies the dataItems which a Set or DataSet
     * instance references. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Remap</b></em>' reference list. The list
     * contents are of type {@link orgomg.cwmx.resource.dmsii.Remap}. It is
     * bidirectional and its opposite is '
     * {@link orgomg.cwmx.resource.dmsii.Remap#getStructure <em>Structure</em>}
     * '. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
