...
public class GeneralizationImpl extends ModelElementImpl implements Generalization {
        ...
        if (child != null && child.eIsProxy()) {
            ...
            if (child != oldChild) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, RelationshipsPackage.GENERALIZATION__CHILD,
                            oldChild, child));
            }
        }
        return child;
    ...
    public NotificationChain basicSetChild(Classifier newChild, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    RelationshipsPackage.GENERALIZATION__CHILD, oldChild, newChild);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setChild(Classifier newChild) {
        if (newChild != child) {
            ...
            if (child != null)
                msgs = ((InternalEObject) child).eInverseRemove(this, CorePackage.CLASSIFIER__GENERALIZATION, Classifier.class,
                        msgs);
            if (newChild != null)
                msgs = ((InternalEObject) newChild).eInverseAdd(this, CorePackage.CLASSIFIER__GENERALIZATION, Classifier.class,
                        msgs);
    ...
    public Classifier getParent() {
        if (parent != null && parent.eIsProxy()) {
            ...
            if (parent != oldParent) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, RelationshipsPackage.GENERALIZATION__PARENT,
                            oldParent, parent));
            }
        }
        return parent;
    ...
    public NotificationChain basicSetParent(Classifier newParent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    RelationshipsPackage.GENERALIZATION__PARENT, oldParent, newParent);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setParent(Classifier newParent) {
        if (newParent != parent) {
            NotificationChain msgs = null;
            if (parent != null)
                msgs = ((InternalEObject) parent).eInverseRemove(this, CorePackage.CLASSIFIER__SPECIALIZATION, Classifier.class,
                        msgs);
            if (newParent != null)
                msgs = ((InternalEObject) newParent).eInverseAdd(this, CorePackage.CLASSIFIER__SPECIALIZATION, Classifier.class,
                        msgs);
            msgs = basicSetParent(newParent, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RelationshipsPackage.GENERALIZATION__PARENT, newParent,
                    newParent));
    }
