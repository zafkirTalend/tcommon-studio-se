...
public abstract class InstanceImpl extends ModelElementImpl implements Instance {
    ...
    public EList<Slot> getValueSlot() {
        if (valueSlot == null) {
            valueSlot = new EObjectWithInverseResolvingEList<Slot>(Slot.class, this, InstancePackage.INSTANCE__VALUE_SLOT,
                    InstancePackage.SLOT__VALUE);
        }
        return valueSlot;
    }
        ...
        if (classifier != null && classifier.eIsProxy()) {
            ...
            if (classifier != oldClassifier) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, InstancePackage.INSTANCE__CLASSIFIER,
    ...
    public NotificationChain basicSetClassifier(Classifier newClassifier, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, InstancePackage.INSTANCE__CLASSIFIER,
    ...
    public void setClassifier(Classifier newClassifier) {
        if (newClassifier != classifier) {
            ...
            if (classifier != null)
                msgs = ((InternalEObject) classifier).eInverseRemove(this, CorePackage.CLASSIFIER__INSTANCE, Classifier.class,
                        msgs);
            if (newClassifier != null)
                msgs = ((InternalEObject) newClassifier).eInverseAdd(this, CorePackage.CLASSIFIER__INSTANCE, Classifier.class,
                        msgs);
            msgs = basicSetClassifier(newClassifier, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, InstancePackage.INSTANCE__CLASSIFIER, newClassifier,
                    newClassifier));
    }
