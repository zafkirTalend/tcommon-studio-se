...
public class InstancePackageImpl extends EPackageImpl implements InstancePackage {
     ...
     * 
     * <p>
     * This method is used to initialize {@link InstancePackage#eINSTANCE} when
    ...
    public void initializePackageContents() {
        ...
        initEReference(getInstance_ValueSlot(), this.getSlot(), this.getSlot_Value(), "valueSlot", null, 0, -1, Instance.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getInstance_Classifier(), theCorePackage.getClassifier(), theCorePackage.getClassifier_Instance(),
                "classifier", null, 1, 1, Instance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(slotEClass, Slot.class, "Slot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSlot_Value(), this.getInstance(), this.getInstance_ValueSlot(), "value", null, 1, 1, Slot.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getSlot_Object(), this.getObject(), this.getObject_Slot(), "object", null, 0, 1, Slot.class, IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getSlot_Feature(), theCorePackage.getStructuralFeature(), theCorePackage.getStructuralFeature_Slot(),
                "feature", null, 1, 1, Slot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(dataValueEClass, DataValue.class, "DataValue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getDataValue_Value(), theCorePackage.getString(), "value", null, 0, 1, DataValue.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(objectEClass, orgomg.cwm.objectmodel.instance.Object.class, "Object", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getObject_Slot(), this.getSlot(), this.getSlot_Object(), "slot", null, 0, -1,
                orgomg.cwm.objectmodel.instance.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
