...
public interface BehavioralFeature extends Feature {
     ...
     * of the system unchanged. True indicates that the state is unchanged;
     * false indicates that side-effects may occur. <!-- end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.objectmodel.behavioral.BehavioralFeature#isIsQuery
     ...
     * --> <!-- begin-model-doc --> Identifies the Parameter instances that
     * describe the parameters of the BehavioralFeature. <!-- end-model-doc -->
     * 
