...
public class ParameterImpl extends ModelElementImpl implements Parameter {
    ...
    public NotificationChain basicSetDefaultValue(Expression newDefaultValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    BehavioralPackage.PARAMETER__DEFAULT_VALUE, oldDefaultValue, newDefaultValue);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newDefaultValue != defaultValue) {
            ...
            if (defaultValue != null)
                msgs = ((InternalEObject) defaultValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - BehavioralPackage.PARAMETER__DEFAULT_VALUE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, BehavioralPackage.PARAMETER__DEFAULT_VALUE, newDefaultValue,
                    newDefaultValue));
    }
    ...
    public BehavioralFeature getBehavioralFeature() {
        if (eContainerFeatureID() != BehavioralPackage.PARAMETER__BEHAVIORAL_FEATURE)
            return null;
    ...
    public void setBehavioralFeature(BehavioralFeature newBehavioralFeature) {
        if (newBehavioralFeature != eInternalContainer()
                || (eContainerFeatureID() != BehavioralPackage.PARAMETER__BEHAVIORAL_FEATURE && newBehavioralFeature != null)) {
            ...
            if (newBehavioralFeature != null)
                msgs = ((InternalEObject) newBehavioralFeature).eInverseAdd(this,
                        BehavioralPackage.BEHAVIORAL_FEATURE__PARAMETER, BehavioralFeature.class, msgs);
            msgs = basicSetBehavioralFeature(newBehavioralFeature, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BehavioralPackage.PARAMETER__BEHAVIORAL_FEATURE,
                    newBehavioralFeature, newBehavioralFeature));
    }
    ...
    public Event getEvent() {
        if (eContainerFeatureID() != BehavioralPackage.PARAMETER__EVENT)
            return null;
    ...
    public NotificationChain basicSetType(Classifier newType, NotificationChain msgs) {
        ...
        type = newType;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehavioralPackage.PARAMETER__TYPE,
                    oldType, newType);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case BehavioralPackage.PARAMETER__BEHAVIORAL_FEATURE:
            return eInternalContainer().eInverseRemove(this, BehavioralPackage.BEHAVIORAL_FEATURE__PARAMETER,
