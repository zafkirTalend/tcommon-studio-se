...
public class CallActionImpl extends ModelElementImpl implements CallAction {
    ...
    /**
     * The cached value of the '{@link #getActualArgument()
     * <em>Actual Argument</em>}' containment reference list. <!--
    ...
    public EList<Argument> getActualArgument() {
        if (actualArgument == null) {
            actualArgument = new EObjectContainmentWithInverseEList<Argument>(Argument.class, this,
                    BehavioralPackage.CALL_ACTION__ACTUAL_ARGUMENT, BehavioralPackage.ARGUMENT__CALL_ACTION);
        }
        ...
        if (operation != null && operation.eIsProxy()) {
            ...
            if (operation != oldOperation) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, BehavioralPackage.CALL_ACTION__OPERATION,
    ...
    public NotificationChain basicSetOperation(Operation newOperation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    BehavioralPackage.CALL_ACTION__OPERATION, oldOperation, newOperation);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setOperation(Operation newOperation) {
        if (newOperation != operation) {
            ...
            if (operation != null)
                msgs = ((InternalEObject) operation).eInverseRemove(this, BehavioralPackage.OPERATION__CALL_ACTION,
                        Operation.class, msgs);
            if (newOperation != null)
                msgs = ((InternalEObject) newOperation).eInverseAdd(this, BehavioralPackage.OPERATION__CALL_ACTION,
                        Operation.class, msgs);
            msgs = basicSetOperation(newOperation, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BehavioralPackage.CALL_ACTION__OPERATION, newOperation,
                    newOperation));
    }
    ...
    public EList<StepExecution> getStepExecution() {
        if (stepExecution == null) {
            stepExecution = new EObjectWithInverseResolvingEList<StepExecution>(StepExecution.class, this,
                    BehavioralPackage.CALL_ACTION__STEP_EXECUTION, WarehouseoperationPackage.STEP_EXECUTION__CALL_ACTION);
        }
