...
public class ArgumentImpl extends ModelElementImpl implements Argument {
    ...
    public NotificationChain basicSetValue(Expression newValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehavioralPackage.ARGUMENT__VALUE,
                    oldValue, newValue);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setValue(Expression newValue) {
        if (newValue != value) {
            ...
            if (value != null)
                msgs = ((InternalEObject) value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BehavioralPackage.ARGUMENT__VALUE,
                        null, msgs);
            if (newValue != null)
                msgs = ((InternalEObject) newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BehavioralPackage.ARGUMENT__VALUE,
                        null, msgs);
    ...
    public CallAction getCallAction() {
        if (eContainerFeatureID() != BehavioralPackage.ARGUMENT__CALL_ACTION)
            return null;
    ...
    public void setCallAction(CallAction newCallAction) {
        if (newCallAction != eInternalContainer()
                || (eContainerFeatureID() != BehavioralPackage.ARGUMENT__CALL_ACTION && newCallAction != null)) {
            ...
            if (newCallAction != null)
                msgs = ((InternalEObject) newCallAction).eInverseAdd(this, BehavioralPackage.CALL_ACTION__ACTUAL_ARGUMENT,
                        CallAction.class, msgs);
            msgs = basicSetCallAction(newCallAction, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BehavioralPackage.ARGUMENT__CALL_ACTION, newCallAction,
                    newCallAction));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case BehavioralPackage.ARGUMENT__CALL_ACTION:
            return eInternalContainer().eInverseRemove(this, BehavioralPackage.CALL_ACTION__ACTUAL_ARGUMENT, CallAction.class,
                    msgs);
        }
