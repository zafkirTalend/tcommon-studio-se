...
public interface Rendering extends Feature {
     ...
     * Implementation-dependent procedure for generating the Rendering (e.g., a
     * usage of XSL to generate an HTML document). Tracks the transformation
     * lineage of the Rendering. <!-- end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.analysis.informationvisualization.Rendering#getAction
    ...
    /**
     * Sets the value of the '
     * {@link orgomg.cwm.analysis.informationvisualization.Rendering#getFileName
    ...
    /**
     * Returns the value of the '<em><b>Defaulted Rendered Object</b></em>'
     ...
     * --> <!-- begin-model-doc --> RenderedObjects referencing this Rendering
     * as the default Rendering. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Defaulted Rendered Object</em>' reference
     *         list.
    ...
    /**
     * Returns the value of the '<em><b>Rendered Object Set</b></em>' container
     * reference. It is bidirectional and its opposite is '
     * {@link orgomg.cwm.analysis.informationvisualization.RenderedObjectSet#getRendering
     * <em>Rendering</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> RenderedObjectSet owning Renderings. <!--
     * end-model-doc -->
     * 
     * @return the value of the '<em>Rendered Object Set</em>' container
     *         reference.
