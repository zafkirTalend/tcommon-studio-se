...
public class RenderedObjectImpl extends ClassifierImpl implements RenderedObject {
    ...
    public NotificationChain basicSetFormula(ExpressionNode newFormula, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    InformationvisualizationPackage.RENDERED_OBJECT__FORMULA, oldFormula, newFormula);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newFormula != formula) {
            ...
            if (formula != null)
                msgs = ((InternalEObject) formula).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - InformationvisualizationPackage.RENDERED_OBJECT__FORMULA, null, msgs);
            if (newFormula != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, InformationvisualizationPackage.RENDERED_OBJECT__FORMULA,
    ...
    public void setAction(String newAction) {
        ...
        action = newAction;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, InformationvisualizationPackage.RENDERED_OBJECT__ACTION,
                    oldAction, action));
    }
    ...
    public void setFileName(String newFileName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, InformationvisualizationPackage.RENDERED_OBJECT__FILE_NAME,
    ...
    public void setType(String newType) {
        ...
        type = newType;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, InformationvisualizationPackage.RENDERED_OBJECT__TYPE, oldType,
                    type));
    }
    ...
    public void setUrl(String newUrl) {
        ...
        url = newUrl;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, InformationvisualizationPackage.RENDERED_OBJECT__URL, oldUrl,
                    url));
    }
    ...
    public EList<RenderedObject> getComposite() {
        if (composite == null) {
            composite = new EObjectWithInverseResolvingEList.ManyInverse<RenderedObject>(RenderedObject.class, this,
                    InformationvisualizationPackage.RENDERED_OBJECT__COMPOSITE,
                    InformationvisualizationPackage.RENDERED_OBJECT__COMPONENT);
        }
        return composite;
    }
    ...
    public EList<RenderedObject> getComponent() {
        if (component == null) {
            component = new EObjectWithInverseResolvingEList.ManyInverse<RenderedObject>(RenderedObject.class, this,
                    InformationvisualizationPackage.RENDERED_OBJECT__COMPONENT,
                    InformationvisualizationPackage.RENDERED_OBJECT__COMPOSITE);
        }
        return component;
            ...
            if (defaultRendering != oldDefaultRendering) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            InformationvisualizationPackage.RENDERED_OBJECT__DEFAULT_RENDERING, oldDefaultRendering,
                            defaultRendering));
            }
        }
    ...
    public NotificationChain basicSetDefaultRendering(Rendering newDefaultRendering, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    InformationvisualizationPackage.RENDERED_OBJECT__DEFAULT_RENDERING, oldDefaultRendering, newDefaultRendering);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDefaultRendering(Rendering newDefaultRendering) {
        if (newDefaultRendering != defaultRendering) {
            ...
            if (defaultRendering != null)
                msgs = ((InternalEObject) defaultRendering).eInverseRemove(this,
                        InformationvisualizationPackage.RENDERING__DEFAULTED_RENDERED_OBJECT, Rendering.class, msgs);
            if (newDefaultRendering != null)
                msgs = ((InternalEObject) newDefaultRendering).eInverseAdd(this,
                        InformationvisualizationPackage.RENDERING__DEFAULTED_RENDERED_OBJECT, Rendering.class, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    InformationvisualizationPackage.RENDERED_OBJECT__DEFAULT_RENDERING, newDefaultRendering, newDefaultRendering));
    }
    ...
    public ModelElement getModelElement() {
        if (modelElement != null && modelElement.eIsProxy()) {
            ...
            if (modelElement != oldModelElement) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            InformationvisualizationPackage.RENDERED_OBJECT__MODEL_ELEMENT, oldModelElement, modelElement));
            }
        }
        return modelElement;
    }
    ...
    public NotificationChain basicSetModelElement(ModelElement newModelElement, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    InformationvisualizationPackage.RENDERED_OBJECT__MODEL_ELEMENT, oldModelElement, newModelElement);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setModelElement(ModelElement newModelElement) {
        if (newModelElement != modelElement) {
            ...
            if (modelElement != null)
                msgs = ((InternalEObject) modelElement).eInverseRemove(this, CorePackage.MODEL_ELEMENT__RENDERED_OBJECT,
                        ModelElement.class, msgs);
            if (newModelElement != null)
                msgs = ((InternalEObject) newModelElement).eInverseAdd(this, CorePackage.MODEL_ELEMENT__RENDERED_OBJECT,
                        ModelElement.class, msgs);
            msgs = basicSetModelElement(newModelElement, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, InformationvisualizationPackage.RENDERED_OBJECT__MODEL_ELEMENT,
    ...
    public EList<RenderedObject> getNeighbor() {
        if (neighbor == null) {
            neighbor = new EObjectWithInverseResolvingEList.ManyInverse<RenderedObject>(RenderedObject.class, this,
                    InformationvisualizationPackage.RENDERED_OBJECT__NEIGHBOR,
                    InformationvisualizationPackage.RENDERED_OBJECT__REFERENCING_NEIGHBOR);
        }
        return neighbor;
    }
    ...
    public EList<RenderedObject> getReferencingNeighbor() {
        if (referencingNeighbor == null) {
            referencingNeighbor = new EObjectWithInverseResolvingEList.ManyInverse<RenderedObject>(RenderedObject.class, this,
                    InformationvisualizationPackage.RENDERED_OBJECT__REFERENCING_NEIGHBOR,
                    InformationvisualizationPackage.RENDERED_OBJECT__NEIGHBOR);
        }
