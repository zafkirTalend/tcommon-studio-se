 ...
 * <em><b>Rendering</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class RenderingImpl extends FeatureImpl implements Rendering {
    ...
    public NotificationChain basicSetFormula(ExpressionNode newFormula, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    InformationvisualizationPackage.RENDERING__FORMULA, oldFormula, newFormula);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newFormula != formula) {
            ...
            if (formula != null)
                msgs = ((InternalEObject) formula).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - InformationvisualizationPackage.RENDERING__FORMULA, null, msgs);
            if (newFormula != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, InformationvisualizationPackage.RENDERING__FORMULA, newFormula,
                    newFormula));
    }
    ...
    public void setAction(String newAction) {
        ...
        action = newAction;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, InformationvisualizationPackage.RENDERING__ACTION, oldAction,
                    action));
    }
    ...
    public void setFileName(String newFileName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, InformationvisualizationPackage.RENDERING__FILE_NAME,
    ...
    public EList<RenderedObject> getDefaultedRenderedObject() {
        if (defaultedRenderedObject == null) {
            defaultedRenderedObject = new EObjectWithInverseResolvingEList<RenderedObject>(RenderedObject.class, this,
                    InformationvisualizationPackage.RENDERING__DEFAULTED_RENDERED_OBJECT,
                    InformationvisualizationPackage.RENDERED_OBJECT__DEFAULT_RENDERING);
        }
    ...
    public RenderedObjectSet getRenderedObjectSet() {
        if (eContainerFeatureID() != InformationvisualizationPackage.RENDERING__RENDERED_OBJECT_SET)
            return null;
    ...
    public NotificationChain basicSetRenderedObjectSet(RenderedObjectSet newRenderedObjectSet, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newRenderedObjectSet,
                InformationvisualizationPackage.RENDERING__RENDERED_OBJECT_SET, msgs);
        return msgs;
    }
    ...
    public void setRenderedObjectSet(RenderedObjectSet newRenderedObjectSet) {
        if (newRenderedObjectSet != eInternalContainer()
                || (eContainerFeatureID() != InformationvisualizationPackage.RENDERING__RENDERED_OBJECT_SET && newRenderedObjectSet != null)) {
            ...
            if (newRenderedObjectSet != null)
                msgs = ((InternalEObject) newRenderedObjectSet).eInverseAdd(this,
                        InformationvisualizationPackage.RENDERED_OBJECT_SET__RENDERING, RenderedObjectSet.class, msgs);
            msgs = basicSetRenderedObjectSet(newRenderedObjectSet, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, InformationvisualizationPackage.RENDERING__RENDERED_OBJECT_SET,
                    newRenderedObjectSet, newRenderedObjectSet));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case InformationvisualizationPackage.RENDERING__RENDERED_OBJECT_SET:
            return eInternalContainer().eInverseRemove(this, InformationvisualizationPackage.RENDERED_OBJECT_SET__RENDERING,
                    RenderedObjectSet.class, msgs);
        }
