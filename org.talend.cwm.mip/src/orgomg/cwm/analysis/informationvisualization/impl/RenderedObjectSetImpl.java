...
public class RenderedObjectSetImpl extends PackageImpl implements RenderedObjectSet {
    ...
    public EList<Rendering> getRendering() {
        if (rendering == null) {
            rendering = new EObjectContainmentWithInverseEList<Rendering>(Rendering.class, this,
                    InformationvisualizationPackage.RENDERED_OBJECT_SET__RENDERING,
                    InformationvisualizationPackage.RENDERING__RENDERED_OBJECT_SET);
        }
        return rendering;
    }
