...
public class OlapSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case OlapPackage.CONTENT_MAP: {
            ...
            if (result == null)
                result = caseTransformationMap(contentMap);
            if (result == null)
                result = caseTransformation(contentMap);
            if (result == null)
                result = caseNamespace(contentMap);
            if (result == null)
                result = caseModelElement(contentMap);
            if (result == null)
                result = caseElement(contentMap);
            if (result == null)
        ...
        case OlapPackage.CUBE: {
            ...
            if (result == null)
                result = caseClass(cube);
            if (result == null)
                result = caseClassifier(cube);
            if (result == null)
                result = caseNamespace(cube);
            if (result == null)
                result = caseModelElement(cube);
            if (result == null)
                result = caseElement(cube);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.CUBE_DEPLOYMENT: {
            ...
            if (result == null)
                result = caseClass(cubeDeployment);
            if (result == null)
                result = caseClassifier(cubeDeployment);
            if (result == null)
                result = caseNamespace(cubeDeployment);
            if (result == null)
                result = caseModelElement(cubeDeployment);
            if (result == null)
                result = caseElement(cubeDeployment);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.CUBE_DIMENSION_ASSOCIATION: {
            ...
            if (result == null)
                result = caseClass(cubeDimensionAssociation);
            if (result == null)
                result = caseClassifier(cubeDimensionAssociation);
            if (result == null)
                result = caseNamespace(cubeDimensionAssociation);
            if (result == null)
                result = caseModelElement(cubeDimensionAssociation);
            if (result == null)
                result = caseElement(cubeDimensionAssociation);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.CUBE_REGION: {
            ...
            if (result == null)
                result = caseClass(cubeRegion);
            if (result == null)
                result = caseClassifier(cubeRegion);
            if (result == null)
                result = caseNamespace(cubeRegion);
            if (result == null)
                result = caseModelElement(cubeRegion);
            if (result == null)
                result = caseElement(cubeRegion);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.DEPLOYMENT_GROUP: {
            ...
            if (result == null)
                result = casePackage(deploymentGroup);
            if (result == null)
                result = caseNamespace(deploymentGroup);
            if (result == null)
                result = caseModelElement(deploymentGroup);
            if (result == null)
                result = caseElement(deploymentGroup);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        ...
        case OlapPackage.DIMENSION_DEPLOYMENT: {
            ...
            if (result == null)
                result = caseClass(dimensionDeployment);
            if (result == null)
                result = caseClassifier(dimensionDeployment);
            if (result == null)
                result = caseNamespace(dimensionDeployment);
            if (result == null)
                result = caseModelElement(dimensionDeployment);
            if (result == null)
                result = caseElement(dimensionDeployment);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.HIERARCHY: {
            ...
            if (result == null)
                result = caseClass(hierarchy);
            if (result == null)
                result = caseClassifier(hierarchy);
            if (result == null)
                result = caseNamespace(hierarchy);
            if (result == null)
                result = caseModelElement(hierarchy);
            if (result == null)
                result = caseElement(hierarchy);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.HIERARCHY_LEVEL_ASSOCIATION: {
            ...
            if (result == null)
                result = caseClass(hierarchyLevelAssociation);
            if (result == null)
                result = caseClassifier(hierarchyLevelAssociation);
            if (result == null)
                result = caseNamespace(hierarchyLevelAssociation);
            if (result == null)
                result = caseModelElement(hierarchyLevelAssociation);
            if (result == null)
                result = caseElement(hierarchyLevelAssociation);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.LEVEL_BASED_HIERARCHY: {
            ...
            if (result == null)
                result = caseHierarchy(levelBasedHierarchy);
            if (result == null)
                result = caseClass(levelBasedHierarchy);
            if (result == null)
                result = caseClassifier(levelBasedHierarchy);
            if (result == null)
                result = caseNamespace(levelBasedHierarchy);
            if (result == null)
                result = caseModelElement(levelBasedHierarchy);
            if (result == null)
                result = caseElement(levelBasedHierarchy);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.MEMBER_SELECTION_GROUP: {
            ...
            if (result == null)
                result = caseClass(memberSelectionGroup);
            if (result == null)
                result = caseClassifier(memberSelectionGroup);
            if (result == null)
                result = caseNamespace(memberSelectionGroup);
            if (result == null)
                result = caseModelElement(memberSelectionGroup);
            if (result == null)
                result = caseElement(memberSelectionGroup);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.MEMBER_SELECTION: {
            ...
            if (result == null)
                result = caseClass(memberSelection);
            if (result == null)
                result = caseClassifier(memberSelection);
            if (result == null)
                result = caseNamespace(memberSelection);
            if (result == null)
                result = caseModelElement(memberSelection);
            if (result == null)
                result = caseElement(memberSelection);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        ...
        case OlapPackage.VALUE_BASED_HIERARCHY: {
            ...
            if (result == null)
                result = caseHierarchy(valueBasedHierarchy);
            if (result == null)
                result = caseClass(valueBasedHierarchy);
            if (result == null)
                result = caseClassifier(valueBasedHierarchy);
            if (result == null)
                result = caseNamespace(valueBasedHierarchy);
            if (result == null)
                result = caseModelElement(valueBasedHierarchy);
            if (result == null)
                result = caseElement(valueBasedHierarchy);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.LEVEL: {
            ...
            if (result == null)
                result = caseMemberSelection(level);
            if (result == null)
                result = caseClass(level);
            if (result == null)
                result = caseClassifier(level);
            if (result == null)
                result = caseNamespace(level);
            if (result == null)
        ...
        case OlapPackage.CODED_LEVEL: {
            ...
            if (result == null)
                result = caseLevel(codedLevel);
            if (result == null)
                result = caseMemberSelection(codedLevel);
            if (result == null)
                result = caseClass(codedLevel);
            if (result == null)
                result = caseClassifier(codedLevel);
            if (result == null)
                result = caseNamespace(codedLevel);
            if (result == null)
                result = caseModelElement(codedLevel);
            if (result == null)
                result = caseElement(codedLevel);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.MEASURE: {
            ...
            if (result == null)
                result = caseAttribute(measure);
            if (result == null)
                result = caseStructuralFeature(measure);
            if (result == null)
                result = caseFeature(measure);
            if (result == null)
                result = caseModelElement(measure);
            if (result == null)
                result = caseElement(measure);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case OlapPackage.STRUCTURE_MAP: {
            ...
            if (result == null)
                result = caseTransformationMap(structureMap);
            if (result == null)
                result = caseTransformation(structureMap);
            if (result == null)
                result = caseNamespace(structureMap);
            if (result == null)
                result = caseModelElement(structureMap);
            if (result == null)
                result = caseElement(structureMap);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
