...
public interface HierarchyLevelAssociation extends orgomg.cwm.objectmodel.core.Class {
    ...
    /**
     * Returns the value of the '<em><b>Level Based Hierarchy</b></em>'
     * container reference. It is bidirectional and its opposite is '
     * {@link orgomg.cwm.analysis.olap.LevelBasedHierarchy#getHierarchyLevelAssociation
     * <em>Hierarchy Level Association</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The LevelBasedHierarchy owning
     * HierarchyLevelAssocs. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Level Based Hierarchy</em>' container
     *         reference.
    ...
    /**
     * Returns the value of the '<em><b>Current Level</b></em>' reference. It is
     * bidirectional and its opposite is '
     * {@link orgomg.cwm.analysis.olap.Level#getHierarchyLevelAssociation
     * <em>Hierarchy Level Association</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The Level designated by a
     * HierarchyLevelAssoc as its current level. <!-- end-model-doc -->
     * 
     ...
     * by a HierarchyLevelAssociation. <!-- end-model-doc -->
     * 
