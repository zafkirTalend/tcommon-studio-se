...
public interface CubeDimensionAssociation extends orgomg.cwm.objectmodel.core.Class {
     ...
     * {@link orgomg.cwm.analysis.olap.Cube#getCubeDimensionAssociation
     * <em>Cube Dimension Association</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The Cube owning CubeDimAssocs.
     * <!-- end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.analysis.olap.Dimension#getCubeDimensionAssociation
     * <em>Cube Dimension Association</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The Dimension referenced by
     * CubeDimAssocs. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Calc Hierarchy</b></em>' reference. It
     * is bidirectional and its opposite is '
     * {@link orgomg.cwm.analysis.olap.Hierarchy#getCubeDimensionAssociation
     * <em>Cube Dimension Association</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The Hierarchy designated by a
     * CubeDimAssoc as the default Hierarchy to be used in consolidation
     * calculations performed on the Cube. <!-- end-model-doc -->
     * 
