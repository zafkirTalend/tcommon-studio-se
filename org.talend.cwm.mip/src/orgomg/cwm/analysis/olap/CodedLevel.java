...
public interface CodedLevel extends Level {
    ...
    /**
     * Returns the value of the '<em><b>Encoding</b></em>' containment
     * reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Encoding is an expression that generates a unique
     * encoding, or label, for each member of a CodedLevel. <!-- end-model-doc
     * -->
     * 
