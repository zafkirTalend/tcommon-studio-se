...
public class LevelImpl extends MemberSelectionImpl implements Level {
     ...
     * <em>Hierarchy Level Association</em>}' reference list. <!--
    ...
    public EList<HierarchyLevelAssociation> getHierarchyLevelAssociation() {
        if (hierarchyLevelAssociation == null) {
            hierarchyLevelAssociation = new EObjectWithInverseResolvingEList<HierarchyLevelAssociation>(
                    HierarchyLevelAssociation.class, this, OlapPackage.LEVEL__HIERARCHY_LEVEL_ASSOCIATION,
                    OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__CURRENT_LEVEL);
        }
