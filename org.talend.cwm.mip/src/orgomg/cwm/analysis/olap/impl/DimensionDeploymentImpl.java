 ...
 * <em><b>Dimension Deployment</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class DimensionDeploymentImpl extends ClassImpl implements DimensionDeployment {
    ...
    public HierarchyLevelAssociation getHierarchyLevelAssociation() {
        if (eContainerFeatureID() != OlapPackage.DIMENSION_DEPLOYMENT__HIERARCHY_LEVEL_ASSOCIATION)
            return null;
     ...
     * @generated
     */
    public NotificationChain basicSetHierarchyLevelAssociation(HierarchyLevelAssociation newHierarchyLevelAssociation,
            NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newHierarchyLevelAssociation,
                OlapPackage.DIMENSION_DEPLOYMENT__HIERARCHY_LEVEL_ASSOCIATION, msgs);
        return msgs;
    }
    ...
    public void setHierarchyLevelAssociation(HierarchyLevelAssociation newHierarchyLevelAssociation) {
        if (newHierarchyLevelAssociation != eInternalContainer()
                || (eContainerFeatureID() != OlapPackage.DIMENSION_DEPLOYMENT__HIERARCHY_LEVEL_ASSOCIATION && newHierarchyLevelAssociation != null)) {
            ...
            if (newHierarchyLevelAssociation != null)
                msgs = ((InternalEObject) newHierarchyLevelAssociation).eInverseAdd(this,
                        OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__DIMENSION_DEPLOYMENT, HierarchyLevelAssociation.class, msgs);
            msgs = basicSetHierarchyLevelAssociation(newHierarchyLevelAssociation, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.DIMENSION_DEPLOYMENT__HIERARCHY_LEVEL_ASSOCIATION,
                    newHierarchyLevelAssociation, newHierarchyLevelAssociation));
    }
    ...
    public ValueBasedHierarchy getValueBasedHierarchy() {
        if (eContainerFeatureID() != OlapPackage.DIMENSION_DEPLOYMENT__VALUE_BASED_HIERARCHY)
            return null;
    ...
    public NotificationChain basicSetValueBasedHierarchy(ValueBasedHierarchy newValueBasedHierarchy, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newValueBasedHierarchy,
                OlapPackage.DIMENSION_DEPLOYMENT__VALUE_BASED_HIERARCHY, msgs);
        return msgs;
    }
    ...
    public void setValueBasedHierarchy(ValueBasedHierarchy newValueBasedHierarchy) {
        if (newValueBasedHierarchy != eInternalContainer()
                || (eContainerFeatureID() != OlapPackage.DIMENSION_DEPLOYMENT__VALUE_BASED_HIERARCHY && newValueBasedHierarchy != null)) {
            ...
            if (newValueBasedHierarchy != null)
                msgs = ((InternalEObject) newValueBasedHierarchy).eInverseAdd(this,
                        OlapPackage.VALUE_BASED_HIERARCHY__DIMENSION_DEPLOYMENT, ValueBasedHierarchy.class, msgs);
            msgs = basicSetValueBasedHierarchy(newValueBasedHierarchy, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.DIMENSION_DEPLOYMENT__VALUE_BASED_HIERARCHY,
                    newValueBasedHierarchy, newValueBasedHierarchy));
    }
    ...
    public EList<StructureMap> getStructureMap() {
        if (structureMap == null) {
            structureMap = new EObjectContainmentWithInverseEList<StructureMap>(StructureMap.class, this,
                    OlapPackage.DIMENSION_DEPLOYMENT__STRUCTURE_MAP, OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT);
        }
        return structureMap;
    }
        ...
        if (listOfValues != null && listOfValues.eIsProxy()) {
            ...
            if (listOfValues != oldListOfValues) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OlapPackage.DIMENSION_DEPLOYMENT__LIST_OF_VALUES,
    ...
    public NotificationChain basicSetListOfValues(StructureMap newListOfValues, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    OlapPackage.DIMENSION_DEPLOYMENT__LIST_OF_VALUES, oldListOfValues, newListOfValues);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setListOfValues(StructureMap newListOfValues) {
        if (newListOfValues != listOfValues) {
            ...
            if (listOfValues != null)
                msgs = ((InternalEObject) listOfValues).eInverseRemove(this, OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_LV,
                        StructureMap.class, msgs);
            if (newListOfValues != null)
                msgs = ((InternalEObject) newListOfValues).eInverseAdd(this, OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_LV,
                        StructureMap.class, msgs);
            msgs = basicSetListOfValues(newListOfValues, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.DIMENSION_DEPLOYMENT__LIST_OF_VALUES,
                    newListOfValues, newListOfValues));
    }
    ...
    public StructureMap getImmediateParent() {
        if (immediateParent != null && immediateParent.eIsProxy()) {
            ...
            if (immediateParent != oldImmediateParent) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OlapPackage.DIMENSION_DEPLOYMENT__IMMEDIATE_PARENT,
                            oldImmediateParent, immediateParent));
            }
        }
    ...
    public NotificationChain basicSetImmediateParent(StructureMap newImmediateParent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    OlapPackage.DIMENSION_DEPLOYMENT__IMMEDIATE_PARENT, oldImmediateParent, newImmediateParent);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setImmediateParent(StructureMap newImmediateParent) {
        if (newImmediateParent != immediateParent) {
            ...
            if (immediateParent != null)
                msgs = ((InternalEObject) immediateParent).eInverseRemove(this,
                        OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_IP, StructureMap.class, msgs);
            if (newImmediateParent != null)
                msgs = ((InternalEObject) newImmediateParent).eInverseAdd(this,
                        OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_IP, StructureMap.class, msgs);
            msgs = basicSetImmediateParent(newImmediateParent, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.DIMENSION_DEPLOYMENT__IMMEDIATE_PARENT,
                    newImmediateParent, newImmediateParent));
    }
    ...
    public DeploymentGroup getDeploymentGroup() {
        if (deploymentGroup != null && deploymentGroup.eIsProxy()) {
            ...
            if (deploymentGroup != oldDeploymentGroup) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OlapPackage.DIMENSION_DEPLOYMENT__DEPLOYMENT_GROUP,
                            oldDeploymentGroup, deploymentGroup));
            }
        }
    ...
    public NotificationChain basicSetDeploymentGroup(DeploymentGroup newDeploymentGroup, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    OlapPackage.DIMENSION_DEPLOYMENT__DEPLOYMENT_GROUP, oldDeploymentGroup, newDeploymentGroup);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDeploymentGroup(DeploymentGroup newDeploymentGroup) {
        if (newDeploymentGroup != deploymentGroup) {
            ...
            if (deploymentGroup != null)
                msgs = ((InternalEObject) deploymentGroup).eInverseRemove(this,
                        OlapPackage.DEPLOYMENT_GROUP__DIMENSION_DEPLOYMENT, DeploymentGroup.class, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.DIMENSION_DEPLOYMENT__DEPLOYMENT_GROUP,
                    newDeploymentGroup, newDeploymentGroup));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case OlapPackage.DIMENSION_DEPLOYMENT__HIERARCHY_LEVEL_ASSOCIATION:
            return eInternalContainer().eInverseRemove(this, OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__DIMENSION_DEPLOYMENT,
                    HierarchyLevelAssociation.class, msgs);
        case OlapPackage.DIMENSION_DEPLOYMENT__VALUE_BASED_HIERARCHY:
            return eInternalContainer().eInverseRemove(this, OlapPackage.VALUE_BASED_HIERARCHY__DIMENSION_DEPLOYMENT,
                    ValueBasedHierarchy.class, msgs);
        }
