...
public class CubeRegionImpl extends ClassImpl implements CubeRegion {
    ...
    /**
     * The cached value of the '{@link #getMemberSelectionGroup()
     * <em>Member Selection Group</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getCubeDeployment()
     * <em>Cube Deployment</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    public void setIsReadOnly(boolean newIsReadOnly) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.CUBE_REGION__IS_READ_ONLY, oldIsReadOnly,
                    isReadOnly));
    }
    ...
    public void setIsFullyRealized(boolean newIsFullyRealized) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.CUBE_REGION__IS_FULLY_REALIZED, oldIsFullyRealized,
                    isFullyRealized));
    }
     ...
     */
    public Cube getCube() {
        if (eContainerFeatureID() != OlapPackage.CUBE_REGION__CUBE)
            return null;
    ...
    public EList<MemberSelectionGroup> getMemberSelectionGroup() {
        if (memberSelectionGroup == null) {
            memberSelectionGroup = new EObjectContainmentWithInverseEList<MemberSelectionGroup>(MemberSelectionGroup.class, this,
                    OlapPackage.CUBE_REGION__MEMBER_SELECTION_GROUP, OlapPackage.MEMBER_SELECTION_GROUP__CUBE_REGION);
        }
    ...
    public EList<CubeDeployment> getCubeDeployment() {
        if (cubeDeployment == null) {
            cubeDeployment = new EObjectContainmentWithInverseEList<CubeDeployment>(CubeDeployment.class, this,
                    OlapPackage.CUBE_REGION__CUBE_DEPLOYMENT, OlapPackage.CUBE_DEPLOYMENT__CUBE_REGION);
        }
