...
public class MemberSelectionGroupImpl extends ClassImpl implements MemberSelectionGroup {
    ...
    public EList<MemberSelection> getMemberSelection() {
        if (memberSelection == null) {
            memberSelection = new EObjectWithInverseResolvingEList.ManyInverse<MemberSelection>(MemberSelection.class, this,
                    OlapPackage.MEMBER_SELECTION_GROUP__MEMBER_SELECTION, OlapPackage.MEMBER_SELECTION__MEMBER_SELECTION_GROUP);
        }
    ...
    public CubeRegion getCubeRegion() {
        if (eContainerFeatureID() != OlapPackage.MEMBER_SELECTION_GROUP__CUBE_REGION)
            return null;
    ...
    public void setCubeRegion(CubeRegion newCubeRegion) {
        if (newCubeRegion != eInternalContainer()
                || (eContainerFeatureID() != OlapPackage.MEMBER_SELECTION_GROUP__CUBE_REGION && newCubeRegion != null)) {
            ...
            if (newCubeRegion != null)
                msgs = ((InternalEObject) newCubeRegion).eInverseAdd(this, OlapPackage.CUBE_REGION__MEMBER_SELECTION_GROUP,
                        CubeRegion.class, msgs);
            msgs = basicSetCubeRegion(newCubeRegion, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.MEMBER_SELECTION_GROUP__CUBE_REGION, newCubeRegion,
                    newCubeRegion));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case OlapPackage.MEMBER_SELECTION_GROUP__CUBE_REGION:
            return eInternalContainer().eInverseRemove(this, OlapPackage.CUBE_REGION__MEMBER_SELECTION_GROUP, CubeRegion.class,
                    msgs);
        }
