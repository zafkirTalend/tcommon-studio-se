...
public class StructureMapImpl extends TransformationMapImpl implements StructureMap {
    ...
    public DimensionDeployment getDimensionDeployment() {
        if (eContainerFeatureID() != OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT)
            return null;
    ...
    public void setDimensionDeployment(DimensionDeployment newDimensionDeployment) {
        if (newDimensionDeployment != eInternalContainer()
                || (eContainerFeatureID() != OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT && newDimensionDeployment != null)) {
            ...
            if (newDimensionDeployment != null)
                msgs = ((InternalEObject) newDimensionDeployment).eInverseAdd(this,
                        OlapPackage.DIMENSION_DEPLOYMENT__STRUCTURE_MAP, DimensionDeployment.class, msgs);
            msgs = basicSetDimensionDeployment(newDimensionDeployment, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT,
        ...
        if (dimensionDeploymentLV != null && dimensionDeploymentLV.eIsProxy()) {
            ...
            if (dimensionDeploymentLV != oldDimensionDeploymentLV) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_LV,
                            oldDimensionDeploymentLV, dimensionDeploymentLV));
            }
        }
    ...
    public NotificationChain basicSetDimensionDeploymentLV(DimensionDeployment newDimensionDeploymentLV, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_LV, oldDimensionDeploymentLV, newDimensionDeploymentLV);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDimensionDeploymentLV(DimensionDeployment newDimensionDeploymentLV) {
        if (newDimensionDeploymentLV != dimensionDeploymentLV) {
            ...
            if (dimensionDeploymentLV != null)
                msgs = ((InternalEObject) dimensionDeploymentLV).eInverseRemove(this,
                        OlapPackage.DIMENSION_DEPLOYMENT__LIST_OF_VALUES, DimensionDeployment.class, msgs);
            if (newDimensionDeploymentLV != null)
                msgs = ((InternalEObject) newDimensionDeploymentLV).eInverseAdd(this,
                        OlapPackage.DIMENSION_DEPLOYMENT__LIST_OF_VALUES, DimensionDeployment.class, msgs);
            msgs = basicSetDimensionDeploymentLV(newDimensionDeploymentLV, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_LV,
                    newDimensionDeploymentLV, newDimensionDeploymentLV));
    }
    ...
    public DimensionDeployment getDimensionDeploymentIP() {
        if (dimensionDeploymentIP != null && dimensionDeploymentIP.eIsProxy()) {
            ...
            if (dimensionDeploymentIP != oldDimensionDeploymentIP) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_IP,
                            oldDimensionDeploymentIP, dimensionDeploymentIP));
            }
        }
    ...
    public NotificationChain basicSetDimensionDeploymentIP(DimensionDeployment newDimensionDeploymentIP, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_IP, oldDimensionDeploymentIP, newDimensionDeploymentIP);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDimensionDeploymentIP(DimensionDeployment newDimensionDeploymentIP) {
        if (newDimensionDeploymentIP != dimensionDeploymentIP) {
            ...
            if (dimensionDeploymentIP != null)
                msgs = ((InternalEObject) dimensionDeploymentIP).eInverseRemove(this,
                        OlapPackage.DIMENSION_DEPLOYMENT__IMMEDIATE_PARENT, DimensionDeployment.class, msgs);
            if (newDimensionDeploymentIP != null)
                msgs = ((InternalEObject) newDimensionDeploymentIP).eInverseAdd(this,
                        OlapPackage.DIMENSION_DEPLOYMENT__IMMEDIATE_PARENT, DimensionDeployment.class, msgs);
            msgs = basicSetDimensionDeploymentIP(newDimensionDeploymentIP, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_IP,
                    newDimensionDeploymentIP, newDimensionDeploymentIP));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT:
            return eInternalContainer().eInverseRemove(this, OlapPackage.DIMENSION_DEPLOYMENT__STRUCTURE_MAP,
                    DimensionDeployment.class, msgs);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_LV:
            if (resolve)
                return getDimensionDeploymentLV();
            return basicGetDimensionDeploymentLV();
        case OlapPackage.STRUCTURE_MAP__DIMENSION_DEPLOYMENT_IP:
            if (resolve)
                return getDimensionDeploymentIP();
