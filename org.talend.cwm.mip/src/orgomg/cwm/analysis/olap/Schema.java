...
public interface Schema extends orgomg.cwm.objectmodel.core.Package {
     ...
     * list. The list contents are of type {@link orgomg.cwm.analysis.olap.Cube}
     * . It is bidirectional and its opposite is '
     * {@link orgomg.cwm.analysis.olap.Cube#getSchema <em>Schema</em>}'. <!--
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The
     * Cubes owned by a Schema. <!-- end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.analysis.olap.Dimension}. It is bidirectional and its
     * opposite is '{@link orgomg.cwm.analysis.olap.Dimension#getSchema
     * <em>Schema</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> The Dimension owned by a Schema. <!-- end-model-doc
     * -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Deployment Group</b></em>' containment
     * reference list. The list contents are of type
     * {@link orgomg.cwm.analysis.olap.DeploymentGroup}. It is bidirectional and
     * its opposite is '
     * {@link orgomg.cwm.analysis.olap.DeploymentGroup#getSchema
     * <em>Schema</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> The DeploymentGroups owned by a Schema. <!--
     * end-model-doc -->
     * 
     * @return the value of the '<em>Deployment Group</em>' containment
     *         reference list.
