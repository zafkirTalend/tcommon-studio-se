...
public class TransformationSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case TransformationPackage.TRANSFORMATION: {
            ...
            if (result == null)
                result = caseNamespace(transformation);
            if (result == null)
                result = caseModelElement(transformation);
            if (result == null)
                result = caseElement(transformation);
            if (result == null)
        ...
        case TransformationPackage.DATA_OBJECT_SET: {
            ...
            if (result == null)
                result = caseModelElement(dataObjectSet);
            if (result == null)
                result = caseElement(dataObjectSet);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.TRANSFORMATION_TASK: {
            ...
            if (result == null)
                result = caseComponent(transformationTask);
            if (result == null)
                result = caseClassifier(transformationTask);
            if (result == null)
                result = caseNamespace(transformationTask);
            if (result == null)
                result = caseModelElement(transformationTask);
            if (result == null)
                result = caseElement(transformationTask);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.TRANSFORMATION_STEP: {
            ...
            if (result == null)
                result = caseModelElement(transformationStep);
            if (result == null)
                result = caseElement(transformationStep);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.TRANSFORMATION_ACTIVITY: {
            ...
            if (result == null)
                result = caseSubsystem(transformationActivity);
            if (result == null)
                result = caseClassifier(transformationActivity);
            if (result == null)
                result = casePackage(transformationActivity);
            if (result == null)
                result = caseNamespace(transformationActivity);
            if (result == null)
                result = caseModelElement(transformationActivity);
            if (result == null)
                result = caseElement(transformationActivity);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.PRECEDENCE_CONSTRAINT: {
            ...
            if (result == null)
                result = caseConstraint(precedenceConstraint);
            if (result == null)
                result = caseModelElement(precedenceConstraint);
            if (result == null)
                result = caseElement(precedenceConstraint);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.TRANSFORMATION_USE: {
            ...
            if (result == null)
                result = caseDependency(transformationUse);
            if (result == null)
                result = caseModelElement(transformationUse);
            if (result == null)
                result = caseElement(transformationUse);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.TRANSFORMATION_MAP: {
            ...
            if (result == null)
                result = caseTransformation(transformationMap);
            if (result == null)
                result = caseNamespace(transformationMap);
            if (result == null)
                result = caseModelElement(transformationMap);
            if (result == null)
                result = caseElement(transformationMap);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.TRANSFORMATION_TREE: {
            ...
            if (result == null)
                result = caseTransformation(transformationTree);
            if (result == null)
                result = caseNamespace(transformationTree);
            if (result == null)
                result = caseModelElement(transformationTree);
            if (result == null)
                result = caseElement(transformationTree);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.CLASSIFIER_MAP: {
            ...
            if (result == null)
                result = caseNamespace(classifierMap);
            if (result == null)
                result = caseModelElement(classifierMap);
            if (result == null)
                result = caseElement(classifierMap);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.FEATURE_MAP: {
            ...
            if (result == null)
                result = caseModelElement(featureMap);
            if (result == null)
                result = caseElement(featureMap);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.STEP_PRECEDENCE: {
            ...
            if (result == null)
                result = caseDependency(stepPrecedence);
            if (result == null)
                result = caseModelElement(stepPrecedence);
            if (result == null)
                result = caseElement(stepPrecedence);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case TransformationPackage.CLASSIFIER_FEATURE_MAP: {
            ...
            if (result == null)
                result = caseModelElement(classifierFeatureMap);
            if (result == null)
                result = caseElement(classifierFeatureMap);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
