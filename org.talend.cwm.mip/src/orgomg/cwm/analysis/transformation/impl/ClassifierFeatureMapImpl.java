...
public class ClassifierFeatureMapImpl extends ModelElementImpl implements ClassifierFeatureMap {
    ...
    public NotificationChain basicSetFunction(ProcedureExpression newFunction, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    TransformationPackage.CLASSIFIER_FEATURE_MAP__FUNCTION, oldFunction, newFunction);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newFunction != function) {
            ...
            if (function != null)
                msgs = ((InternalEObject) function).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - TransformationPackage.CLASSIFIER_FEATURE_MAP__FUNCTION, null, msgs);
            if (newFunction != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationPackage.CLASSIFIER_FEATURE_MAP__FUNCTION,
    ...
    public void setFunctionDescription(String newFunctionDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    TransformationPackage.CLASSIFIER_FEATURE_MAP__FUNCTION_DESCRIPTION, oldFunctionDescription,
                    functionDescription));
    }
    ...
    public void setClassifierToFeature(boolean newClassifierToFeature) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    TransformationPackage.CLASSIFIER_FEATURE_MAP__CLASSIFIER_TO_FEATURE, oldClassifierToFeature,
                    classifierToFeature));
    }
    ...
    public ClassifierMap getClassifierMap() {
        if (eContainerFeatureID() != TransformationPackage.CLASSIFIER_FEATURE_MAP__CLASSIFIER_MAP)
            return null;
    ...
    public NotificationChain basicSetClassifierMap(ClassifierMap newClassifierMap, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newClassifierMap,
                TransformationPackage.CLASSIFIER_FEATURE_MAP__CLASSIFIER_MAP, msgs);
        return msgs;
    }
    ...
    public void setClassifierMap(ClassifierMap newClassifierMap) {
        if (newClassifierMap != eInternalContainer()
                || (eContainerFeatureID() != TransformationPackage.CLASSIFIER_FEATURE_MAP__CLASSIFIER_MAP && newClassifierMap != null)) {
            ...
            if (newClassifierMap != null)
                msgs = ((InternalEObject) newClassifierMap).eInverseAdd(this, TransformationPackage.CLASSIFIER_MAP__CF_MAP,
                        ClassifierMap.class, msgs);
            msgs = basicSetClassifierMap(newClassifierMap, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationPackage.CLASSIFIER_FEATURE_MAP__CLASSIFIER_MAP,
    ...
    public EList<Classifier> getClassifier() {
        if (classifier == null) {
            classifier = new EObjectWithInverseResolvingEList.ManyInverse<Classifier>(Classifier.class, this,
                    TransformationPackage.CLASSIFIER_FEATURE_MAP__CLASSIFIER, CorePackage.CLASSIFIER__CF_MAP);
        }
        return classifier;
    }
    ...
    public EList<Feature> getFeature() {
        if (feature == null) {
            feature = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(Feature.class, this,
                    TransformationPackage.CLASSIFIER_FEATURE_MAP__FEATURE, CorePackage.FEATURE__CF_MAP);
        }
        return feature;
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case TransformationPackage.CLASSIFIER_FEATURE_MAP__CLASSIFIER_MAP:
            return eInternalContainer().eInverseRemove(this, TransformationPackage.CLASSIFIER_MAP__CF_MAP, ClassifierMap.class,
                    msgs);
        }
