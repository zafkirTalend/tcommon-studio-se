...
public class DataObjectSetImpl extends ModelElementImpl implements DataObjectSet {
    ...
    public EList<Transformation> getSourceTransformation() {
        if (sourceTransformation == null) {
            sourceTransformation = new EObjectWithInverseResolvingEList.ManyInverse<Transformation>(Transformation.class, this,
                    TransformationPackage.DATA_OBJECT_SET__SOURCE_TRANSFORMATION, TransformationPackage.TRANSFORMATION__SOURCE);
        }
    ...
    public EList<Transformation> getTargetTransformation() {
        if (targetTransformation == null) {
            targetTransformation = new EObjectWithInverseResolvingEList.ManyInverse<Transformation>(Transformation.class, this,
                    TransformationPackage.DATA_OBJECT_SET__TARGET_TRANSFORMATION, TransformationPackage.TRANSFORMATION__TARGET);
        }
    ...
    public EList<ModelElement> getElement() {
        if (element == null) {
            element = new EObjectWithInverseResolvingEList.ManyInverse<ModelElement>(ModelElement.class, this,
                    TransformationPackage.DATA_OBJECT_SET__ELEMENT, CorePackage.MODEL_ELEMENT__SET);
        }
        return element;
    }
