...
public class TransformationStepImpl extends ModelElementImpl implements TransformationStep {
        ...
        if (task != null && task.eIsProxy()) {
            ...
            if (task != oldTask) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, TransformationPackage.TRANSFORMATION_STEP__TASK,
                            oldTask, task));
            }
        }
        return task;
    ...
    public NotificationChain basicSetTask(TransformationTask newTask, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    TransformationPackage.TRANSFORMATION_STEP__TASK, oldTask, newTask);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setTask(TransformationTask newTask) {
        if (newTask != task) {
            ...
            if (task != null)
                msgs = ((InternalEObject) task).eInverseRemove(this, TransformationPackage.TRANSFORMATION_TASK__STEP,
                        TransformationTask.class, msgs);
            if (newTask != null)
                msgs = ((InternalEObject) newTask).eInverseAdd(this, TransformationPackage.TRANSFORMATION_TASK__STEP,
                        TransformationTask.class, msgs);
            msgs = basicSetTask(newTask, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationPackage.TRANSFORMATION_STEP__TASK, newTask,
                    newTask));
    }
    ...
    public EList<WarehouseStep> getWarehouseStep() {
        if (warehouseStep == null) {
            warehouseStep = new EObjectWithInverseResolvingEList<WarehouseStep>(WarehouseStep.class, this,
                    TransformationPackage.TRANSFORMATION_STEP__WAREHOUSE_STEP,
                    WarehouseprocessPackage.WAREHOUSE_STEP__TRANSFORMATION_STEP);
        }
    ...
    public EList<StepExecution> getExecution() {
        if (execution == null) {
            execution = new EObjectWithInverseResolvingEList<StepExecution>(StepExecution.class, this,
                    TransformationPackage.TRANSFORMATION_STEP__EXECUTION,
                    WarehouseoperationPackage.STEP_EXECUTION__TRANSFORMATION_STEP);
        }
        return execution;
    }
