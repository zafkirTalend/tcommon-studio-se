...
public class TransformationImpl extends NamespaceImpl implements Transformation {
    ...
    public NotificationChain basicSetFunction(ProcedureExpression newFunction, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    TransformationPackage.TRANSFORMATION__FUNCTION, oldFunction, newFunction);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newFunction != function) {
            ...
            if (function != null)
                msgs = ((InternalEObject) function).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - TransformationPackage.TRANSFORMATION__FUNCTION, null, msgs);
            if (newFunction != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationPackage.TRANSFORMATION__FUNCTION, newFunction,
                    newFunction));
    }
    ...
    public void setFunctionDescription(String newFunctionDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationPackage.TRANSFORMATION__FUNCTION_DESCRIPTION,
    ...
    public void setIsPrimary(boolean newIsPrimary) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationPackage.TRANSFORMATION__IS_PRIMARY, oldIsPrimary,
                    isPrimary));
    }
    ...
    public EList<DataObjectSet> getSource() {
        if (source == null) {
            source = new EObjectWithInverseResolvingEList.ManyInverse<DataObjectSet>(DataObjectSet.class, this,
                    TransformationPackage.TRANSFORMATION__SOURCE, TransformationPackage.DATA_OBJECT_SET__SOURCE_TRANSFORMATION);
        }
        return source;
    }
    ...
    public EList<DataObjectSet> getTarget() {
        if (target == null) {
            target = new EObjectWithInverseResolvingEList.ManyInverse<DataObjectSet>(DataObjectSet.class, this,
                    TransformationPackage.TRANSFORMATION__TARGET, TransformationPackage.DATA_OBJECT_SET__TARGET_TRANSFORMATION);
        }
        return target;
    }
    ...
    public EList<TransformationTask> getTask() {
        if (task == null) {
            task = new EObjectWithInverseResolvingEList.ManyInverse<TransformationTask>(TransformationTask.class, this,
                    TransformationPackage.TRANSFORMATION__TASK, TransformationPackage.TRANSFORMATION_TASK__TRANSFORMATION);
        }
        return task;
    }
