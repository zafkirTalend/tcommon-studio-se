...
public interface TransformationActivity extends Subsystem {
     ...
     * the TransformationActivity was created. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Warehouse Activity</b></em>' reference
     * list. The list contents are of type
     * {@link orgomg.cwm.management.warehouseprocess.WarehouseActivity}. It is
     * bidirectional and its opposite is '
     * {@link orgomg.cwm.management.warehouseprocess.WarehouseActivity#getTransformationActivity
     * <em>Transformation Activity</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> Identifies the set of
     * WarehouseActivities that run the TransformationActivity. <!--
     * end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.management.warehouseoperation.ActivityExecution}. It is
     * bidirectional and its opposite is '
     * {@link orgomg.cwm.management.warehouseoperation.ActivityExecution#getTransformationActivity
     * <em>Transformation Activity</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> Identifies an ActivityExecution
     * recording details of a specific execution of a TransformationActivity.
     * <!-- end-model-doc -->
     * 
