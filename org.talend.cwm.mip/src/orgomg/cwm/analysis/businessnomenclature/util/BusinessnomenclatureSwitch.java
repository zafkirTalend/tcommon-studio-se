...
public class BusinessnomenclatureSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case BusinessnomenclaturePackage.VOCABULARY_ELEMENT: {
            ...
            if (result == null)
                result = caseModelElement(vocabularyElement);
            if (result == null)
                result = caseElement(vocabularyElement);
            if (result == null)
        ...
        case BusinessnomenclaturePackage.NOMENCLATURE: {
            ...
            if (result == null)
                result = casePackage(nomenclature);
            if (result == null)
                result = caseNamespace(nomenclature);
            if (result == null)
                result = caseModelElement(nomenclature);
            if (result == null)
                result = caseElement(nomenclature);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case BusinessnomenclaturePackage.TAXONOMY: {
            ...
            if (result == null)
                result = caseNomenclature(taxonomy);
            if (result == null)
                result = casePackage(taxonomy);
            if (result == null)
                result = caseNamespace(taxonomy);
            if (result == null)
                result = caseModelElement(taxonomy);
            if (result == null)
                result = caseElement(taxonomy);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case BusinessnomenclaturePackage.GLOSSARY: {
            ...
            if (result == null)
                result = caseNomenclature(glossary);
            if (result == null)
                result = casePackage(glossary);
            if (result == null)
                result = caseNamespace(glossary);
            if (result == null)
                result = caseModelElement(glossary);
            if (result == null)
                result = caseElement(glossary);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case BusinessnomenclaturePackage.BUSINESS_DOMAIN: {
            ...
            if (result == null)
                result = casePackage(businessDomain);
            if (result == null)
                result = caseNamespace(businessDomain);
            if (result == null)
                result = caseModelElement(businessDomain);
            if (result == null)
                result = caseElement(businessDomain);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case BusinessnomenclaturePackage.CONCEPT: {
            ...
            if (result == null)
                result = caseVocabularyElement(concept);
            if (result == null)
        ...
        case BusinessnomenclaturePackage.TERM: {
            ...
            if (result == null)
                result = caseVocabularyElement(term);
            if (result == null)
                result = caseModelElement(term);
            if (result == null)
