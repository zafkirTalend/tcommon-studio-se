 ...
 * <em><b>Step Execution</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class StepExecutionImpl extends TransformationExecutionImpl implements StepExecution {
            ...
            if (transformationStep != oldTransformationStep) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            WarehouseoperationPackage.STEP_EXECUTION__TRANSFORMATION_STEP, oldTransformationStep,
                            transformationStep));
            }
        }
    ...
    public NotificationChain basicSetTransformationStep(TransformationStep newTransformationStep, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    WarehouseoperationPackage.STEP_EXECUTION__TRANSFORMATION_STEP, oldTransformationStep, newTransformationStep);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setTransformationStep(TransformationStep newTransformationStep) {
        if (newTransformationStep != transformationStep) {
            ...
            if (transformationStep != null)
                msgs = ((InternalEObject) transformationStep).eInverseRemove(this,
                        TransformationPackage.TRANSFORMATION_STEP__EXECUTION, TransformationStep.class, msgs);
            if (newTransformationStep != null)
                msgs = ((InternalEObject) newTransformationStep).eInverseAdd(this,
                        TransformationPackage.TRANSFORMATION_STEP__EXECUTION, TransformationStep.class, msgs);
            msgs = basicSetTransformationStep(newTransformationStep, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WarehouseoperationPackage.STEP_EXECUTION__TRANSFORMATION_STEP,
                    newTransformationStep, newTransformationStep));
    }
    ...
    public ActivityExecution getActivityExecution() {
        if (eContainerFeatureID() != WarehouseoperationPackage.STEP_EXECUTION__ACTIVITY_EXECUTION)
            return null;
    ...
    public NotificationChain basicSetActivityExecution(ActivityExecution newActivityExecution, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newActivityExecution,
                WarehouseoperationPackage.STEP_EXECUTION__ACTIVITY_EXECUTION, msgs);
        return msgs;
    }
    ...
    public void setActivityExecution(ActivityExecution newActivityExecution) {
        if (newActivityExecution != eInternalContainer()
                || (eContainerFeatureID() != WarehouseoperationPackage.STEP_EXECUTION__ACTIVITY_EXECUTION && newActivityExecution != null)) {
            ...
            if (newActivityExecution != null)
                msgs = ((InternalEObject) newActivityExecution).eInverseAdd(this,
                        WarehouseoperationPackage.ACTIVITY_EXECUTION__STEP_EXECUTION, ActivityExecution.class, msgs);
            msgs = basicSetActivityExecution(newActivityExecution, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WarehouseoperationPackage.STEP_EXECUTION__ACTIVITY_EXECUTION,
                    newActivityExecution, newActivityExecution));
    }
    ...
    public CallAction getCallAction() {
        if (callAction != null && callAction.eIsProxy()) {
            ...
            if (callAction != oldCallAction) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            WarehouseoperationPackage.STEP_EXECUTION__CALL_ACTION, oldCallAction, callAction));
            }
        }
        return callAction;
    }
    ...
    public NotificationChain basicSetCallAction(CallAction newCallAction, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    WarehouseoperationPackage.STEP_EXECUTION__CALL_ACTION, oldCallAction, newCallAction);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setCallAction(CallAction newCallAction) {
        if (newCallAction != callAction) {
            NotificationChain msgs = null;
            if (callAction != null)
                msgs = ((InternalEObject) callAction).eInverseRemove(this, BehavioralPackage.CALL_ACTION__STEP_EXECUTION,
                        CallAction.class, msgs);
            if (newCallAction != null)
                msgs = ((InternalEObject) newCallAction).eInverseAdd(this, BehavioralPackage.CALL_ACTION__STEP_EXECUTION,
                        CallAction.class, msgs);
            msgs = basicSetCallAction(newCallAction, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WarehouseoperationPackage.STEP_EXECUTION__CALL_ACTION,
                    newCallAction, newCallAction));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case WarehouseoperationPackage.STEP_EXECUTION__ACTIVITY_EXECUTION:
            return eInternalContainer().eInverseRemove(this, WarehouseoperationPackage.ACTIVITY_EXECUTION__STEP_EXECUTION,
                    ActivityExecution.class, msgs);
        }
