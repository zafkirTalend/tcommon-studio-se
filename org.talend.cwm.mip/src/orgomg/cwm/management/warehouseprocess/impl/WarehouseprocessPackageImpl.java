...
public class WarehouseprocessPackageImpl extends EPackageImpl implements WarehouseprocessPackage {
    ...
    public static WarehouseprocessPackage init() {
        if (isInited)
            return (WarehouseprocessPackage) EPackage.Registry.INSTANCE.getEPackage(WarehouseprocessPackage.eNS_URI);

        // Obtain or create and register package
        WarehouseprocessPackageImpl theWarehouseprocessPackage = (WarehouseprocessPackageImpl) (EPackage.Registry.INSTANCE
                .get(eNS_URI) instanceof WarehouseprocessPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new WarehouseprocessPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEClass(warehouseProcessEClass, WarehouseProcess.class, "WarehouseProcess", IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getWarehouseProcess_StaticDefinition(), theCorePackage.getBoolean(), "staticDefinition", null, 0, 1,
                WarehouseProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getWarehouseProcess_IsSequential(), theCorePackage.getBoolean(), "isSequential", null, 0, 1,
                WarehouseProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getWarehouseProcess_WarehouseEvent(), theEventsPackage.getWarehouseEvent(),
                theEventsPackage.getWarehouseEvent_WarehouseProcess(), "warehouseEvent", null, 0, -1, WarehouseProcess.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getWarehouseProcess_InternalEvent(), theEventsPackage.getInternalEvent(),
                theEventsPackage.getInternalEvent_TriggeringWP(), "internalEvent", null, 0, -1, WarehouseProcess.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(warehouseStepEClass, WarehouseStep.class, "WarehouseStep", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getWarehouseStep_TransformationStep(), theTransformationPackage.getTransformationStep(),
                theTransformationPackage.getTransformationStep_WarehouseStep(), "transformationStep", null, 1, 1,
                WarehouseStep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getWarehouseStep_WarehouseActivity(), this.getWarehouseActivity(),
                this.getWarehouseActivity_WarehouseStep(), "warehouseActivity", null, 1, 1, WarehouseStep.class, IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);

        initEClass(processPackageEClass, ProcessPackage.class, "ProcessPackage", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(warehouseActivityEClass, WarehouseActivity.class, "WarehouseActivity", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getWarehouseActivity_WarehouseStep(), this.getWarehouseStep(), this.getWarehouseStep_WarehouseActivity(),
                "warehouseStep", null, 0, -1, WarehouseActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        ...
        initEReference(getWarehouseActivity_TransformationActivity(), theTransformationPackage.getTransformationActivity(),
                theTransformationPackage.getTransformationActivity_WarehouseActivity(), "transformationActivity", null, 1, 1,
                WarehouseActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
