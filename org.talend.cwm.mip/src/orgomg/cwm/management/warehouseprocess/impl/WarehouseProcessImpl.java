...
public abstract class WarehouseProcessImpl extends ModelElementImpl implements WarehouseProcess {
    ...
    /**
     * The cached value of the '{@link #getWarehouseEvent()
     * <em>Warehouse Event</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    public void setStaticDefinition(boolean newStaticDefinition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WarehouseprocessPackage.WAREHOUSE_PROCESS__STATIC_DEFINITION,
                    oldStaticDefinition, staticDefinition));
    }
    ...
    public void setIsSequential(boolean newIsSequential) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WarehouseprocessPackage.WAREHOUSE_PROCESS__IS_SEQUENTIAL,
    ...
    public EList<WarehouseEvent> getWarehouseEvent() {
        if (warehouseEvent == null) {
            warehouseEvent = new EObjectContainmentWithInverseEList<WarehouseEvent>(WarehouseEvent.class, this,
                    WarehouseprocessPackage.WAREHOUSE_PROCESS__WAREHOUSE_EVENT, EventsPackage.WAREHOUSE_EVENT__WAREHOUSE_PROCESS);
        }
    ...
    public EList<InternalEvent> getInternalEvent() {
        if (internalEvent == null) {
            internalEvent = new EObjectWithInverseResolvingEList.ManyInverse<InternalEvent>(InternalEvent.class, this,
                    WarehouseprocessPackage.WAREHOUSE_PROCESS__INTERNAL_EVENT, EventsPackage.INTERNAL_EVENT__TRIGGERING_WP);
        }
