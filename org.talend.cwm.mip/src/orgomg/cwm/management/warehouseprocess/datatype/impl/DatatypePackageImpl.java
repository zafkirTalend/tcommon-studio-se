...
public class DatatypePackageImpl extends EPackageImpl implements DatatypePackage {
     ...
     * 
     * <p>
     * This method is used to initialize {@link DatatypePackage#eINSTANCE} when
    ...
    public static DatatypePackage init() {
        ...
        DatatypePackageImpl theDatatypePackage = (DatatypePackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DatatypePackageImpl ? EPackage.Registry.INSTANCE
                .get(eNS_URI) : new DatatypePackageImpl());
