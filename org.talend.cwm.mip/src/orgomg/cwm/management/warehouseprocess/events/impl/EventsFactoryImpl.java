...
public class EventsFactoryImpl extends EFactoryImpl implements EventsFactory {
    ...
    public static EventsFactory init() {
        try {
            EventsFactory theEventsFactory = (EventsFactory) EPackage.Registry.INSTANCE
                    .getEFactory("http:///orgomg/cwm/management/warehouseprocess/events.ecore");
    ...
    public EObject create(EClass eClass) {
        ...
        case EventsPackage.POINT_IN_TIME_EVENT:
            return createPointInTimeEvent();
        case EventsPackage.CUSTOM_CALENDAR_EVENT:
            return createCustomCalendarEvent();
        ...
        case EventsPackage.RETRY_EVENT:
            return createRetryEvent();
        case EventsPackage.RECURRING_POINT_IN_TIME_EVENT:
            return createRecurringPointInTimeEvent();
        default:
