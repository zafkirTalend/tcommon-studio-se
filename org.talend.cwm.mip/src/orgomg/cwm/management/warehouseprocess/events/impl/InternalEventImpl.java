...
public class InternalEventImpl extends WarehouseEventImpl implements InternalEvent {
    ...
    public EList<WarehouseProcess> getTriggeringWP() {
        if (triggeringWP == null) {
            triggeringWP = new EObjectWithInverseResolvingEList.ManyInverse<WarehouseProcess>(WarehouseProcess.class, this,
                    EventsPackage.INTERNAL_EVENT__TRIGGERING_WP, WarehouseprocessPackage.WAREHOUSE_PROCESS__INTERNAL_EVENT);
        }
        return triggeringWP;
    }
    ...
    public NotificationChain basicSetCondition(BooleanExpression newCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EventsPackage.INTERNAL_EVENT__CONDITION, oldCondition, newCondition);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newCondition != condition) {
            ...
            if (condition != null)
                msgs = ((InternalEObject) condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - EventsPackage.INTERNAL_EVENT__CONDITION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.INTERNAL_EVENT__CONDITION, newCondition,
                    newCondition));
    }
