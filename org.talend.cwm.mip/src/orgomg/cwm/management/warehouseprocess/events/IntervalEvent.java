...
public interface IntervalEvent extends ScheduleEvent {
     ...
     * Indicates the length of time (in seconds) to wait after a run of the
     * WarehouseProcess before triggering the next one.
     * 
     * <!-- end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.management.warehouseprocess.events.IntervalEvent#getDuration
