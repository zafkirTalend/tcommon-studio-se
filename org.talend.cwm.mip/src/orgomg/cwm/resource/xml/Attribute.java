...
public interface Attribute extends orgomg.cwm.objectmodel.core.Attribute {
    ...
    /**
     * Returns the value of the '<em><b>Default Kind</b></em>' attribute. The
     * literals are from the enumeration
     * {@link orgomg.cwm.resource.xml.AttributeDefault}. <!-- begin-user-doc -->
     * <!-- end-user-doc --> <!-- begin-model-doc --> Identifies the kind of
     * attribute default. <!-- end-model-doc -->
     * 
