 ...
 * <em><b>Content Type</b></em>', and utility methods for working with them.
 * <!-- end-user-doc --> <!-- begin-model-doc --> empty, any, mixed, element
 * <!-- end-model-doc -->
 * 
...
public enum ContentType implements Enumerator {
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Xml element</b></em>' literal object isn't
     ...
     * @generated
     */
    private static final ContentType[] VALUES_ARRAY = new ContentType[] { XML_EMPTY, XML_ANY, XML_MIXED, XML_ELEMENT, };
    ...
    public static ContentType get(int value) {
        switch (value) {
        case XML_EMPTY_VALUE:
            return XML_EMPTY;
        case XML_ANY_VALUE:
            return XML_ANY;
        case XML_MIXED_VALUE:
            return XML_MIXED;
