...
public class ElementContentImpl extends ContentImpl implements ElementContent {
    ...
    public EList<ElementContent> getOwnerContent() {
        if (ownerContent == null) {
            ownerContent = new EObjectWithInverseResolvingEList.ManyInverse<ElementContent>(ElementContent.class, this,
                    XmlPackage.ELEMENT_CONTENT__OWNER_CONTENT, XmlPackage.ELEMENT_CONTENT__OWNED_CONTENT);
        }
        return ownerContent;
    }
    ...
    public EList<ElementContent> getOwnedContent() {
        if (ownedContent == null) {
            ownedContent = new EObjectWithInverseResolvingEList.ManyInverse<ElementContent>(ElementContent.class, this,
                    XmlPackage.ELEMENT_CONTENT__OWNED_CONTENT, XmlPackage.ELEMENT_CONTENT__OWNER_CONTENT);
        }
        return ownedContent;
    }
