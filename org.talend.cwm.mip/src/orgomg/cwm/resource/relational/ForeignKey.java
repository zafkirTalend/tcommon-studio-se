...
public interface ForeignKey extends KeyRelationship {
    ...
    /**
     * Returns the value of the '<em><b>Delete Rule</b></em>' attribute. The
     * literals are from the enumeration
     * {@link orgomg.cwm.resource.relational.enumerations.ReferentialRuleType}.
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> An
     * enumerated type. Indicates the disposition of the data records containing
     * the foreign key value when the record of the matching primary key is
     * deleted. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Update Rule</b></em>' attribute. The
     * literals are from the enumeration
     * {@link orgomg.cwm.resource.relational.enumerations.ReferentialRuleType}.
     ...
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * Indicates if the validity of the ForeignKey is to be tested at each
     * statement or at the end of a transaction. <!-- end-model-doc -->
     * 
