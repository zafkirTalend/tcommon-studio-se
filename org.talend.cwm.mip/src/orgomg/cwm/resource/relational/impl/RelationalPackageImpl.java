...
public class RelationalPackageImpl extends EPackageImpl implements RelationalPackage {
     ...
     * 
     * <p>
     * This method is used to initialize {@link RelationalPackage#eINSTANCE}
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getCatalog_DefaultCharacterSetName(), theCorePackage.getString(), "defaultCharacterSetName", null, 0, 1,
                Catalog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getCatalog_DefaultCollationName(), theCorePackage.getString(), "defaultCollationName", null, 0, 1,
                Catalog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        ...
        initEClass(namedColumnSetEClass, NamedColumnSet.class, "NamedColumnSet", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getNamedColumnSet_UsingTrigger(), this.getTrigger(), this.getTrigger_UsedColumnSet(), "usingTrigger",
                null, 0, -1, NamedColumnSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getNamedColumnSet_Type(), this.getSQLStructuredType(), this.getSQLStructuredType_ColumnSet(), "type",
                null, 0, 1, NamedColumnSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getNamedColumnSet_OptionScopeColumn(), this.getColumn(), this.getColumn_OptionScopeColumnSet(),
                "optionScopeColumn", null, 0, -1, NamedColumnSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(tableEClass, Table.class, "Table", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTable_IsTemporary(), theCorePackage.getBoolean(), "isTemporary", null, 0, 1, Table.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTable_TemporaryScope(), theCorePackage.getString(), "temporaryScope", null, 0, 1, Table.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTable_IsSystem(), theCorePackage.getBoolean(), "isSystem", null, 0, 1, Table.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTable_Trigger(), this.getTrigger(), this.getTrigger_Table(), "trigger", null, 0, -1, Table.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(viewEClass, View.class, "View", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getView_IsReadOnly(), theCorePackage.getBoolean(), "isReadOnly", null, 0, 1, View.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getView_CheckOption(), theCorePackage.getBoolean(), "checkOption", null, 0, 1, View.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getView_QueryExpression(), theDatatypesPackage.getQueryExpression(), null, "queryExpression", null, 0, 1,
                View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(queryColumnSetEClass, QueryColumnSet.class, "QueryColumnSet", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getQueryColumnSet_Query(), theDatatypesPackage.getQueryExpression(), null, "query", null, 0, 1,
                QueryColumnSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(sqlDataTypeEClass, SQLDataType.class, "SQLDataType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSQLDataType_TypeNumber(), theCorePackage.getInteger(), "typeNumber", null, 0, 1, SQLDataType.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(sqlDistinctTypeEClass, SQLDistinctType.class, "SQLDistinctType", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSQLDistinctType_Length(), theCorePackage.getInteger(), "length", null, 0, 1, SQLDistinctType.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSQLDistinctType_Precision(), theCorePackage.getInteger(), "precision", null, 0, 1,
                SQLDistinctType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSQLDistinctType_Scale(), theCorePackage.getInteger(), "scale", null, 0, 1, SQLDistinctType.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSQLDistinctType_SqlSimpleType(), this.getSQLSimpleType(), this.getSQLSimpleType_SqlDistinctType(),
                "sqlSimpleType", null, 1, 1, SQLDistinctType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(sqlSimpleTypeEClass, SQLSimpleType.class, "SQLSimpleType", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSQLSimpleType_CharacterMaximumLength(), theCorePackage.getInteger(), "characterMaximumLength", null, 0,
                1, SQLSimpleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSQLSimpleType_CharacterOctetLength(), theCorePackage.getInteger(), "characterOctetLength", null, 0, 1,
                SQLSimpleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getSQLSimpleType_NumericPrecision(), theCorePackage.getInteger(), "numericPrecision", null, 0, 1,
                SQLSimpleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getSQLSimpleType_NumericPrecisionRadix(), theCorePackage.getInteger(), "numericPrecisionRadix", null, 0,
                1, SQLSimpleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSQLSimpleType_NumericScale(), theCorePackage.getInteger(), "numericScale", null, 0, 1,
                SQLSimpleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getSQLSimpleType_DateTimePrecision(), theCorePackage.getInteger(), "dateTimePrecision", null, 0, 1,
                SQLSimpleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getSQLSimpleType_SqlDistinctType(), this.getSQLDistinctType(), this.getSQLDistinctType_SqlSimpleType(),
                "sqlDistinctType", null, 0, -1, SQLSimpleType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(sqlStructuredTypeEClass, SQLStructuredType.class, "SQLStructuredType", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSQLStructuredType_ColumnSet(), this.getNamedColumnSet(), this.getNamedColumnSet_Type(), "columnSet",
                null, 0, -1, SQLStructuredType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSQLStructuredType_ReferencingColumn(), this.getColumn(), this.getColumn_ReferencedTableType(),
                "referencingColumn", null, 0, -1, SQLStructuredType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(columnEClass, Column.class, "Column", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getColumn_Precision(), theCorePackage.getInteger(), "precision", null, 0, 1, Column.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getColumn_Scale(), theCorePackage.getInteger(), "scale", null, 0, 1, Column.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getColumn_IsNullable(), theEnumerationsPackage.getNullableType(), "isNullable", null, 0, 1, Column.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getColumn_Length(), theCorePackage.getInteger(), "length", null, 0, 1, Column.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getColumn_CollationName(), theCorePackage.getString(), "collationName", null, 0, 1, Column.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getColumn_CharacterSetName(), theCorePackage.getString(), "characterSetName", null, 0, 1, Column.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getColumn_ReferencedTableType(), this.getSQLStructuredType(),
                this.getSQLStructuredType_ReferencingColumn(), "referencedTableType", null, 0, 1, Column.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getColumn_OptionScopeColumnSet(), this.getNamedColumnSet(), this.getNamedColumnSet_OptionScopeColumn(),
                "optionScopeColumnSet", null, 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(procedureEClass, Procedure.class, "Procedure", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getProcedure_Type(), theEnumerationsPackage.getProcedureType(), "type", null, 0, 1, Procedure.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(triggerEClass, Trigger.class, "Trigger", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTrigger_EventManipulation(), theEnumerationsPackage.getEventManipulationType(), "eventManipulation",
                null, 0, 1, Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getTrigger_ActionCondition(), theCorePackage.getBooleanExpression(), null, "actionCondition", null, 0, 1,
                Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTrigger_ActionStatement(), theCorePackage.getProcedureExpression(), null, "actionStatement", null, 0,
                1, Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTrigger_ActionOrientation(), theEnumerationsPackage.getActionOrientationType(), "actionOrientation",
                null, 0, 1, Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTrigger_ConditionTiming(), theEnumerationsPackage.getConditionTimingType(), "conditionTiming", null, 0,
                1, Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getTrigger_ConditionReferenceNewTable(), theCorePackage.getString(), "conditionReferenceNewTable", null,
                0, 1, Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getTrigger_ConditionReferenceOldTable(), theCorePackage.getString(), "conditionReferenceOldTable", null,
                0, 1, Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getTrigger_UsedColumnSet(), this.getNamedColumnSet(), this.getNamedColumnSet_UsingTrigger(),
                "usedColumnSet", null, 0, -1, Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTrigger_Table(), this.getTable(), this.getTable_Trigger(), "table", null, 1, 1, Trigger.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(sqlIndexEClass, SQLIndex.class, "SQLIndex", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSQLIndex_FilterCondition(), theCorePackage.getString(), "filterCondition", null, 0, 1, SQLIndex.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSQLIndex_IsNullable(), theCorePackage.getBoolean(), "isNullable", null, 0, 1, SQLIndex.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSQLIndex_AutoUpdate(), theCorePackage.getBoolean(), "autoUpdate", null, 0, 1, SQLIndex.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(uniqueConstraintEClass, UniqueConstraint.class, "UniqueConstraint", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getUniqueConstraint_Deferrability(), theEnumerationsPackage.getDeferrabilityType(), "deferrability", null,
                0, 1, UniqueConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(foreignKeyEClass, ForeignKey.class, "ForeignKey", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getForeignKey_DeleteRule(), theEnumerationsPackage.getReferentialRuleType(), "deleteRule", null, 0, 1,
                ForeignKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getForeignKey_UpdateRule(), theEnumerationsPackage.getReferentialRuleType(), "updateRule", null, 0, 1,
                ForeignKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getForeignKey_Deferrability(), theEnumerationsPackage.getDeferrabilityType(), "deferrability", null, 0, 1,
                ForeignKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);

        initEClass(sqlIndexColumnEClass, SQLIndexColumn.class, "SQLIndexColumn", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        ...
        initEClass(checkConstraintEClass, CheckConstraint.class, "CheckConstraint", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getCheckConstraint_Deferrability(), theEnumerationsPackage.getDeferrabilityType(), "deferrability", null,
                0, 1, CheckConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(rowSetEClass, RowSet.class, "RowSet", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(sqlParameterEClass, SQLParameter.class, "SQLParameter", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
