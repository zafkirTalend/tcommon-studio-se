...
public interface Table extends NamedColumnSet {
     ...
     * However, RDBMS products have implemented variations on this theme. It is
     * recommended that the product manufacturers provide specific temporary
     ...
     * [C-1]. The scope indicates when the data of this table are available.
     * "SESSION", "APPLICATION" are examples of possible values. Look at the
     * Scope attribute for Global Temporary tables in the SQL standards for more
     * details. <!-- end-model-doc -->
     * 
     ...
     * the system catalog). <!-- end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.resource.relational.Table#isIsSystem
     * <em>Is System</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @param value
     *            the new value of the '<em>Is System</em>' attribute.
     * @see #isIsSystem()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Trigger</b></em>' reference list. The
     * list contents are of type {@link orgomg.cwm.resource.relational.Trigger}.
     * It is bidirectional and its opposite is '
     * {@link orgomg.cwm.resource.relational.Trigger#getTable <em>Table</em>}'.
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
