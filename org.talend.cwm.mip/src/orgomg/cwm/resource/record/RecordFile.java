...
public interface RecordFile extends orgomg.cwm.objectmodel.core.Package {
     ...
     * field names applicable to subsequent records. <!-- end-model-doc -->
     * 
     ...
     * stream-oriented file. A common examples include the usage of
     * carriage-return characters and carriage-return/line-feed character pairs
     * as new-line characters in ASCII text files. <!-- end-model-doc -->
     * 
     ...
     * number of records to ignore at the beginning of a file. The specific
    ...
    /**
     * Returns the value of the '<em><b>Record</b></em>' reference list. The
     * list contents are of type {@link orgomg.cwm.resource.record.RecordDef}.
     * It is bidirectional and its opposite is '
     * {@link orgomg.cwm.resource.record.RecordDef#getFile <em>File</em>}'. <!--
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * Identifies the set of records stored in the file. The ordering may
     * indicate the physical ordering of records with different layouts. <!--
     * end-model-doc -->
     * 
