...
public class SchemaImpl extends PackageImpl implements Schema {
    ...
    /**
     * The cached value of the '{@link #getDimensionedObject()
     * <em>Dimensioned Object</em>}' containment reference list. <!--
    ...
    public EList<DimensionedObject> getDimensionedObject() {
        if (dimensionedObject == null) {
            dimensionedObject = new EObjectContainmentWithInverseEList<DimensionedObject>(DimensionedObject.class, this,
                    MultidimensionalPackage.SCHEMA__DIMENSIONED_OBJECT, MultidimensionalPackage.DIMENSIONED_OBJECT__SCHEMA);
        }
    ...
    public EList<Dimension> getDimension() {
        if (dimension == null) {
            dimension = new EObjectContainmentWithInverseEList<Dimension>(Dimension.class, this,
                    MultidimensionalPackage.SCHEMA__DIMENSION, MultidimensionalPackage.DIMENSION__SCHEMA);
        }
        return dimension;
    }
