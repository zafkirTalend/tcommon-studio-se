...
public class MemberSetImpl extends ExtentImpl implements MemberSet {
    ...
    public Dimension getDimension() {
        if (eContainerFeatureID() != MultidimensionalPackage.MEMBER_SET__DIMENSION)
            return null;
    ...
    public void setDimension(Dimension newDimension) {
        if (newDimension != eInternalContainer()
                || (eContainerFeatureID() != MultidimensionalPackage.MEMBER_SET__DIMENSION && newDimension != null)) {
            ...
            if (newDimension != null)
                msgs = ((InternalEObject) newDimension).eInverseAdd(this, MultidimensionalPackage.DIMENSION__MEMBER_SET,
                        Dimension.class, msgs);
            msgs = basicSetDimension(newDimension, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MultidimensionalPackage.MEMBER_SET__DIMENSION, newDimension,
                    newDimension));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case MultidimensionalPackage.MEMBER_SET__DIMENSION:
            return eInternalContainer()
                    .eInverseRemove(this, MultidimensionalPackage.DIMENSION__MEMBER_SET, Dimension.class, msgs);
        }
