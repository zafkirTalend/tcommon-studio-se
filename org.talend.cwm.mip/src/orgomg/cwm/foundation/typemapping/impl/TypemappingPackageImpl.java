...
public class TypemappingPackageImpl extends EPackageImpl implements TypemappingPackage {
     ...
     * 
     * <p>
     * This method is used to initialize {@link TypemappingPackage#eINSTANCE}
    ...
    public static TypemappingPackage init() {
        ...
        TypemappingPackageImpl theTypemappingPackage = (TypemappingPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TypemappingPackageImpl ? EPackage.Registry.INSTANCE
                .get(eNS_URI) : new TypemappingPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getTypeMapping_IsBestMatch(), theCorePackage.getBoolean(), "isBestMatch", null, 0, 1, TypeMapping.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTypeMapping_IsLossy(), theCorePackage.getBoolean(), "isLossy", null, 0, 1, TypeMapping.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTypeMapping_SourceType(), theCorePackage.getClassifier(), theCorePackage.getClassifier_MappingFrom(),
                "sourceType", null, 1, 1, TypeMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTypeMapping_TargetType(), theCorePackage.getClassifier(), theCorePackage.getClassifier_MappingTo(),
                "targetType", null, 1, 1, TypeMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(typeSystemEClass, TypeSystem.class, "TypeSystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getTypeSystem_SupportingSystem(), theSoftwaredeploymentPackage.getSoftwareSystem(),
                theSoftwaredeploymentPackage.getSoftwareSystem_Typespace(), "supportingSystem", null, 0, -1, TypeSystem.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTypeSystem_Version(), theCorePackage.getString(), "version", null, 0, 1, TypeSystem.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
