...
public class DatatypesPackageImpl extends EPackageImpl implements DatatypesPackage {
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getEnumeration_IsOrdered(), theCorePackage.getBoolean(), "isOrdered", null, 0, 1, Enumeration.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getEnumeration_Literal(), this.getEnumerationLiteral(), this.getEnumerationLiteral_Enumeration(),
                "literal", null, 1, -1, Enumeration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(enumerationLiteralEClass, EnumerationLiteral.class, "EnumerationLiteral", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getEnumerationLiteral_Value(), theCorePackage.getExpression(), null, "value", null, 0, 1,
                EnumerationLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getEnumerationLiteral_Enumeration(), this.getEnumeration(), this.getEnumeration_Literal(), "enumeration",
                null, 1, 1, EnumerationLiteral.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(queryExpressionEClass, QueryExpression.class, "QueryExpression", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getQueryExpression_ReportGroup(), theInformationreportingPackage.getReportGroup(),
                theInformationreportingPackage.getReportGroup_ReportQuery(), "reportGroup", null, 0, 1, QueryExpression.class,
        ...
        initEReference(getTypeAlias_Type(), theCorePackage.getClassifier(), theCorePackage.getClassifier_Alias(), "type", null,
                1, 1, TypeAlias.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(unionEClass, Union.class, "Union", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getUnion_Discriminator(), theCorePackage.getStructuralFeature(),
                theCorePackage.getStructuralFeature_DiscriminatedUnion(), "discriminator", null, 0, 1, Union.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(unionMemberEClass, UnionMember.class, "UnionMember", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getUnionMember_MemberCase(), theCorePackage.getExpression(), null, "memberCase", null, 0, 1,
                UnionMember.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getUnionMember_IsDefault(), theCorePackage.getBoolean(), "isDefault", null, 0, 1, UnionMember.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
