...
public class UnionMemberImpl extends AttributeImpl implements UnionMember {
    ...
    public NotificationChain basicSetMemberCase(Expression newMemberCase, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    DatatypesPackage.UNION_MEMBER__MEMBER_CASE, oldMemberCase, newMemberCase);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setMemberCase(Expression newMemberCase) {
        if (newMemberCase != memberCase) {
            ...
            if (memberCase != null)
                msgs = ((InternalEObject) memberCase).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - DatatypesPackage.UNION_MEMBER__MEMBER_CASE, null, msgs);
            if (newMemberCase != null)
                msgs = ((InternalEObject) newMemberCase).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - DatatypesPackage.UNION_MEMBER__MEMBER_CASE, null, msgs);
            msgs = basicSetMemberCase(newMemberCase, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.UNION_MEMBER__MEMBER_CASE, newMemberCase,
                    newMemberCase));
    }
    ...
    public void setIsDefault(boolean newIsDefault) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.UNION_MEMBER__IS_DEFAULT, oldIsDefault,
                    isDefault));
    }
