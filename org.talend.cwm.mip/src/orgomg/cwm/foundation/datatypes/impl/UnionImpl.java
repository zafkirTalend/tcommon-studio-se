...
public class UnionImpl extends ClassifierImpl implements Union {
        ...
        if (discriminator != null && discriminator.eIsProxy()) {
            ...
            if (discriminator != oldDiscriminator) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, DatatypesPackage.UNION__DISCRIMINATOR,
    ...
    public NotificationChain basicSetDiscriminator(StructuralFeature newDiscriminator, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DatatypesPackage.UNION__DISCRIMINATOR,
    ...
    public void setDiscriminator(StructuralFeature newDiscriminator) {
        if (newDiscriminator != discriminator) {
            ...
            if (discriminator != null)
                msgs = ((InternalEObject) discriminator).eInverseRemove(this,
                        CorePackage.STRUCTURAL_FEATURE__DISCRIMINATED_UNION, StructuralFeature.class, msgs);
            if (newDiscriminator != null)
                msgs = ((InternalEObject) newDiscriminator).eInverseAdd(this,
                        CorePackage.STRUCTURAL_FEATURE__DISCRIMINATED_UNION, StructuralFeature.class, msgs);
            msgs = basicSetDiscriminator(newDiscriminator, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.UNION__DISCRIMINATOR, newDiscriminator,
                    newDiscriminator));
    }
