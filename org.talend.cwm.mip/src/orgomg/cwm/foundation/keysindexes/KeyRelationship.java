...
public interface KeyRelationship extends ModelElement {
     ...
     * --> <!-- begin-model-doc --> Identifies the StructuralFeature instances
     * that make up the unique key. The ordered constraint is used to represent
     * the sequence of StructuralFeature instances that make up the UniqueKey
     * instance?s key. In the relational model case, these StructuralFeature
     * instances identify the columns that make up a table?s primary key. <!--
     * end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Unique Key</b></em>' reference. It is
     * bidirectional and its opposite is '
     * {@link orgomg.cwm.foundation.keysindexes.UniqueKey#getKeyRelationship
     * <em>Key Relationship</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
     * --> <!-- begin-model-doc --> Identifies the UniqueKey instance that
     * serves as the "primary key" for this KeyRelationship instance. <!--
     * end-model-doc -->
     * 
