...
public interface UniqueKey extends ModelElement {
     ...
     * {@link orgomg.cwm.objectmodel.core.StructuralFeature#getUniqueKey
     * <em>Unique Key</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Identifies the StructuralFeature instances that make
     * up the unique key. The ordered constraint is used to represent the
     * sequence of StructuralFeature instances that make up the UniqueKey
     * instance?s key.
     * 
     * <!-- end-model-doc -->
     * 
     ...
     * bidirectional and its opposite is '
     * {@link orgomg.cwm.foundation.keysindexes.KeyRelationship#getUniqueKey
     * <em>Unique Key</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Identifies the KeyRelationship instances that
     * reference this UniqueKey instance. In the relational case, this reference
     * identifies the foreign keys that reference this primary key. <!--
     * end-model-doc -->
     * 
