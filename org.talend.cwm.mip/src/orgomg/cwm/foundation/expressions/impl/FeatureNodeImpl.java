...
public class FeatureNodeImpl extends ExpressionNodeImpl implements FeatureNode {
        ...
        if (feature != null && feature.eIsProxy()) {
            ...
            if (feature != oldFeature) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExpressionsPackage.FEATURE_NODE__FEATURE,
                            oldFeature, feature));
            }
        }
        return feature;
    ...
    public NotificationChain basicSetFeature(Feature newFeature, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ExpressionsPackage.FEATURE_NODE__FEATURE, oldFeature, newFeature);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setFeature(Feature newFeature) {
        if (newFeature != feature) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.FEATURE_NODE__FEATURE, newFeature,
                    newFeature));
    }
    ...
    public EList<ExpressionNode> getArgument() {
        if (argument == null) {
            argument = new EObjectContainmentWithInverseEList<ExpressionNode>(ExpressionNode.class, this,
                    ExpressionsPackage.FEATURE_NODE__ARGUMENT, ExpressionsPackage.EXPRESSION_NODE__FEATURE_NODE);
        }
        return argument;
    }
