...
public class ExpressionNodeImpl extends ElementImpl implements ExpressionNode {
    ...
    public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ExpressionsPackage.EXPRESSION_NODE__EXPRESSION, oldExpression, newExpression);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newExpression != expression) {
            ...
            if (expression != null)
                msgs = ((InternalEObject) expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - ExpressionsPackage.EXPRESSION_NODE__EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EXPRESSION_NODE__EXPRESSION, newExpression,
                    newExpression));
    }
    ...
    public Classifier getType() {
        if (type != null && type.eIsProxy()) {
            ...
            if (type != oldType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExpressionsPackage.EXPRESSION_NODE__TYPE, oldType,
                            type));
            }
        }
        return type;
    ...
    public NotificationChain basicSetType(Classifier newType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ExpressionsPackage.EXPRESSION_NODE__TYPE, oldType, newType);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setType(Classifier newType) {
        if (newType != type) {
            NotificationChain msgs = null;
            if (type != null)
                msgs = ((InternalEObject) type).eInverseRemove(this, CorePackage.CLASSIFIER__EXPRESSION_NODE, Classifier.class,
                        msgs);
            if (newType != null)
                msgs = ((InternalEObject) newType).eInverseAdd(this, CorePackage.CLASSIFIER__EXPRESSION_NODE, Classifier.class,
                        msgs);
    ...
    public FeatureNode getFeatureNode() {
        if (eContainerFeatureID() != ExpressionsPackage.EXPRESSION_NODE__FEATURE_NODE)
            return null;
    ...
    public void setFeatureNode(FeatureNode newFeatureNode) {
        if (newFeatureNode != eInternalContainer()
                || (eContainerFeatureID() != ExpressionsPackage.EXPRESSION_NODE__FEATURE_NODE && newFeatureNode != null)) {
            ...
            if (newFeatureNode != null)
                msgs = ((InternalEObject) newFeatureNode).eInverseAdd(this, ExpressionsPackage.FEATURE_NODE__ARGUMENT,
                        FeatureNode.class, msgs);
            msgs = basicSetFeatureNode(newFeatureNode, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EXPRESSION_NODE__FEATURE_NODE,
