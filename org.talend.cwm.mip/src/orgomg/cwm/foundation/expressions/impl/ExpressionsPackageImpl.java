...
public class ExpressionsPackageImpl extends EPackageImpl implements ExpressionsPackage {
    ...
    public void initializePackageContents() {
        ...
        initEReference(getExpressionNode_Expression(), theCorePackage.getExpression(), null, "expression", null, 0, 1,
                ExpressionNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getExpressionNode_Type(), theCorePackage.getClassifier(), theCorePackage.getClassifier_ExpressionNode(),
                "type", null, 0, 1, ExpressionNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getExpressionNode_FeatureNode(), this.getFeatureNode(), this.getFeatureNode_Argument(), "featureNode",
                null, 0, 1, ExpressionNode.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(constantNodeEClass, ConstantNode.class, "ConstantNode", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getConstantNode_Value(), theCorePackage.getAny(), "value", null, 0, 1, ConstantNode.class, !IS_TRANSIENT,
        ...
        initEReference(getElementNode_ModelElement(), theCorePackage.getModelElement(),
                theCorePackage.getModelElement_ElementNode(), "modelElement", null, 1, 1, ElementNode.class, !IS_TRANSIENT,
        ...
        initEReference(getFeatureNode_Feature(), theCorePackage.getFeature(), theCorePackage.getFeature_FeatureNode(), "feature",
                null, 1, 1, FeatureNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getFeatureNode_Argument(), this.getExpressionNode(), this.getExpressionNode_FeatureNode(), "argument",
                null, 0, -1, FeatureNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
