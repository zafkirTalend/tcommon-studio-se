...
public interface PackageUsage extends Dependency {
     ...
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> If this
     * attribute is present, it identifies the name by which the Package is
     * known to the client. <!-- end-model-doc -->
     * 
