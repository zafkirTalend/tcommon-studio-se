...
public class SoftwaredeploymentSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case SoftwaredeploymentPackage.SITE: {
            ...
            if (result == null)
                result = caseLocation(site);
            if (result == null)
                result = caseModelElement(site);
            if (result == null)
                result = caseElement(site);
            if (result == null)
        ...
        case SoftwaredeploymentPackage.MACHINE: {
            ...
            if (result == null)
                result = caseNamespace(machine);
            if (result == null)
                result = caseModelElement(machine);
            if (result == null)
                result = caseElement(machine);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SoftwaredeploymentPackage.SOFTWARE_SYSTEM: {
            ...
            if (result == null)
                result = caseSubsystem(softwareSystem);
            if (result == null)
                result = caseClassifier(softwareSystem);
            if (result == null)
                result = casePackage(softwareSystem);
            if (result == null)
                result = caseNamespace(softwareSystem);
            if (result == null)
                result = caseModelElement(softwareSystem);
            if (result == null)
                result = caseElement(softwareSystem);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SoftwaredeploymentPackage.DEPLOYED_COMPONENT: {
            ...
            if (result == null)
                result = casePackage(deployedComponent);
            if (result == null)
                result = caseNamespace(deployedComponent);
            if (result == null)
                result = caseModelElement(deployedComponent);
            if (result == null)
                result = caseElement(deployedComponent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SoftwaredeploymentPackage.DEPLOYED_SOFTWARE_SYSTEM: {
            ...
            if (result == null)
                result = casePackage(deployedSoftwareSystem);
            if (result == null)
                result = caseNamespace(deployedSoftwareSystem);
            if (result == null)
                result = caseModelElement(deployedSoftwareSystem);
            if (result == null)
                result = caseElement(deployedSoftwareSystem);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SoftwaredeploymentPackage.DATA_MANAGER: {
            ...
            if (result == null)
                result = caseDeployedComponent(dataManager);
            if (result == null)
                result = casePackage(dataManager);
            if (result == null)
                result = caseNamespace(dataManager);
            if (result == null)
                result = caseModelElement(dataManager);
            if (result == null)
                result = caseElement(dataManager);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SoftwaredeploymentPackage.DATA_PROVIDER: {
            ...
            if (result == null)
                result = caseDataManager(dataProvider);
            if (result == null)
                result = caseDeployedComponent(dataProvider);
            if (result == null)
                result = casePackage(dataProvider);
            if (result == null)
                result = caseNamespace(dataProvider);
            if (result == null)
                result = caseModelElement(dataProvider);
            if (result == null)
                result = caseElement(dataProvider);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case SoftwaredeploymentPackage.PROVIDER_CONNECTION: {
            ...
            if (result == null)
                result = caseModelElement(providerConnection);
            if (result == null)
                result = caseElement(providerConnection);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        ...
        case SoftwaredeploymentPackage.PACKAGE_USAGE: {
            ...
            if (result == null)
                result = caseDependency(packageUsage);
            if (result == null)
                result = caseModelElement(packageUsage);
            if (result == null)
                result = caseElement(packageUsage);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
