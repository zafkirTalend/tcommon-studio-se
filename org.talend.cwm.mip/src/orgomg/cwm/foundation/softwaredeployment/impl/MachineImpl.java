...
public class MachineImpl extends NamespaceImpl implements Machine {
    ...
    /**
     * The cached value of the '{@link #getDeployedComponent()
     * <em>Deployed Component</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    public void setIpAddress(String newIpAddress) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.MACHINE__IP_ADDRESS, oldIpAddress,
                    ipAddress));
    }
    ...
    public void setHostName(String newHostName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.MACHINE__HOST_NAME, oldHostName,
                    hostName));
    }
    ...
    public void setMachineID(String newMachineID) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.MACHINE__MACHINE_ID, oldMachineID,
                    machineID));
    }
    ...
    public EList<DeployedComponent> getDeployedComponent() {
        if (deployedComponent == null) {
            deployedComponent = new EObjectContainmentWithInverseEList<DeployedComponent>(DeployedComponent.class, this,
                    SoftwaredeploymentPackage.MACHINE__DEPLOYED_COMPONENT, SoftwaredeploymentPackage.DEPLOYED_COMPONENT__MACHINE);
        }
    ...
    public Site getSite() {
        if (site != null && site.eIsProxy()) {
            ...
            if (site != oldSite) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SoftwaredeploymentPackage.MACHINE__SITE, oldSite,
                            site));
            }
        }
        return site;
    ...
    public NotificationChain basicSetSite(Site newSite, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SoftwaredeploymentPackage.MACHINE__SITE, oldSite, newSite);
            if (msgs == null)
                msgs = notification;
            else
