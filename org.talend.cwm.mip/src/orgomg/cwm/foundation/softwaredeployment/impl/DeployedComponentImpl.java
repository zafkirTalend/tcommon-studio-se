...
public class DeployedComponentImpl extends PackageImpl implements DeployedComponent {
    ...
    public void setPathname(String newPathname) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.DEPLOYED_COMPONENT__PATHNAME,
    ...
    public Machine getMachine() {
        if (eContainerFeatureID() != SoftwaredeploymentPackage.DEPLOYED_COMPONENT__MACHINE)
            return null;
    ...
    public void setMachine(Machine newMachine) {
        if (newMachine != eInternalContainer()
                || (eContainerFeatureID() != SoftwaredeploymentPackage.DEPLOYED_COMPONENT__MACHINE && newMachine != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.DEPLOYED_COMPONENT__MACHINE,
    ...
    public EList<DeployedSoftwareSystem> getDeployedSoftwareSystem() {
        if (deployedSoftwareSystem == null) {
            deployedSoftwareSystem = new EObjectWithInverseResolvingEList.ManyInverse<DeployedSoftwareSystem>(
                    DeployedSoftwareSystem.class, this, SoftwaredeploymentPackage.DEPLOYED_COMPONENT__DEPLOYED_SOFTWARE_SYSTEM,
            ...
            if (component != oldComponent) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            SoftwaredeploymentPackage.DEPLOYED_COMPONENT__COMPONENT, oldComponent, component));
            }
        }
        return component;
    }
    ...
    public NotificationChain basicSetComponent(Component newComponent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SoftwaredeploymentPackage.DEPLOYED_COMPONENT__COMPONENT, oldComponent, newComponent);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setComponent(Component newComponent) {
        if (newComponent != component) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.DEPLOYED_COMPONENT__COMPONENT,
