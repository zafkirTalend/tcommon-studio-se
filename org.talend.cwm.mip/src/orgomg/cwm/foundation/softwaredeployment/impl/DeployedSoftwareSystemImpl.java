...
public class DeployedSoftwareSystemImpl extends PackageImpl implements DeployedSoftwareSystem {
            ...
            if (softwareSystem != oldSoftwareSystem) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            SoftwaredeploymentPackage.DEPLOYED_SOFTWARE_SYSTEM__SOFTWARE_SYSTEM, oldSoftwareSystem,
                            softwareSystem));
            }
        }
    ...
    public NotificationChain basicSetSoftwareSystem(SoftwareSystem newSoftwareSystem, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SoftwaredeploymentPackage.DEPLOYED_SOFTWARE_SYSTEM__SOFTWARE_SYSTEM, oldSoftwareSystem, newSoftwareSystem);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setSoftwareSystem(SoftwareSystem newSoftwareSystem) {
        if (newSoftwareSystem != softwareSystem) {
            ...
            if (softwareSystem != null)
                msgs = ((InternalEObject) softwareSystem).eInverseRemove(this,
                        SoftwaredeploymentPackage.SOFTWARE_SYSTEM__DEPLOYMENT, SoftwareSystem.class, msgs);
            if (newSoftwareSystem != null)
                msgs = ((InternalEObject) newSoftwareSystem).eInverseAdd(this,
                        SoftwaredeploymentPackage.SOFTWARE_SYSTEM__DEPLOYMENT, SoftwareSystem.class, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SoftwaredeploymentPackage.DEPLOYED_SOFTWARE_SYSTEM__SOFTWARE_SYSTEM, newSoftwareSystem, newSoftwareSystem));
    }
    ...
    public EList<DeployedComponent> getDeployedComponent() {
        if (deployedComponent == null) {
            deployedComponent = new EObjectWithInverseResolvingEList.ManyInverse<DeployedComponent>(DeployedComponent.class,
                    this, SoftwaredeploymentPackage.DEPLOYED_SOFTWARE_SYSTEM__DEPLOYED_COMPONENT,
                    SoftwaredeploymentPackage.DEPLOYED_COMPONENT__DEPLOYED_SOFTWARE_SYSTEM);
        }
