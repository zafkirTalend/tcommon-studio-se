 ...
 * <em><b>Software System</b></em>'. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
...
public interface SoftwareSystem extends Subsystem {
     ...
     * Identifies the type of the software product. One of the following
     * predefined values should be used if appropriate:
     * 
     * OS, DBMS, MDDB, FileSystem, ODBC, JDBC or Application. <!-- end-model-doc
     * -->
     * 
     ...
     * used in conjunction with the type attribute to provide additional
     * information about the type of the software product.
     * 
     * For some of the predefined types, suggested subtype values are listed
     * below:
     * 
     * For an Operating System product (type OS): AIX, Linux, MVS, NT, Solaris,
     * SunOS, VMS or Windows. For a Database Management System product (type
     * DBMS): DB2, DMS II, IMS, Informix, Oracle, SQLServer or Sybase. For a
     ...
     * {@link orgomg.cwm.foundation.softwaredeployment.SoftwareSystem#getSubtype
     ...
     * supplier of the software product. <!-- end-model-doc -->
     * 
    ...
    /**
     * Sets the value of the '
     * {@link orgomg.cwm.foundation.softwaredeployment.SoftwareSystem#getSupplier
     * <em>Supplier</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @param value
     *            the new value of the '<em>Supplier</em>' attribute.
     * @see #getSupplier()
     * @generated
     */
     ...
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The
     * version identification for the software product. <!-- end-model-doc -->
     * 
    ...
    /**
     * Sets the value of the '
     * {@link orgomg.cwm.foundation.softwaredeployment.SoftwareSystem#getVersion
    ...
    /**
     * Returns the value of the '<em><b>Typespace</b></em>' reference list. The
     * list contents are of type
     * {@link orgomg.cwm.foundation.typemapping.TypeSystem}. It is bidirectional
     * and its opposite is '
     * {@link orgomg.cwm.foundation.typemapping.TypeSystem#getSupportingSystem
     * <em>Supporting System</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
     * --> <!-- begin-model-doc --> Identifies a TypeSystem containing datatypes
     * supported by the SoftwareSystem. <!-- end-model-doc -->
     * 
