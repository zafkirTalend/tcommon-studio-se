 ...
 * <em><b>Responsible Party</b></em>'. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
...
public interface ResponsibleParty extends Namespace {
     ...
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Textual
     * identification or description of the ResponsibleParty in a
     * usage-dependent format. <!-- end-model-doc -->
     * 
     ...
     * --> <!-- begin-model-doc --> Identifies the model elements for which this
     * ResponsibleParty instance has some interest or responsibility. <!--
     * end-model-doc -->
     * 
