...
public interface Email extends ModelElement {
     ...
     * textual representation of an email address. <!-- end-model-doc -->
     * 
     ...
     * Interesting values might include location information such as "home" or
     * "work", or perhaps an indication of the type of email system for which
     * the eMailAddress is formatted, such as "SMTP" or "X.400". <!--
     * end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.foundation.businessinformation.Contact#getEmail
     * <em>Email</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Identifies the Email instances associated with this
     * Contact instance. The ordered constraint may be used to identify the
     * order in which Email instances should be contacted. <!-- end-model-doc
     * -->
     * 
