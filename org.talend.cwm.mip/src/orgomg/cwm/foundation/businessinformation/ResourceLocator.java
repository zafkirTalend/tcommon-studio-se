...
public interface ResourceLocator extends ModelElement {
     ...
     * its intended use in a particular environment. <!-- end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.foundation.businessinformation.Contact#getUrl
     * <em>Url</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Identifies the Contact instances for which a
     * ResourceLocator instance is relevant. <!-- end-model-doc -->
     * 
