...
public class MetadataConnectionUtils {
    ...
    public static void setMDMConnectionParameter(MDMConnection conn, IMetadataConnection metadataConnection) {
        ...
        // metadataConnection.setDriverClass(ConnectionContextHelper.getOriginalValue(contextType,
        // conn.getDriverClass()));
        // host
        conn.setServer(metadataConnection.getServerName());
        // metadataConnection.setServerName(ConnectionContextHelper.getOriginalValue(contextType,
        // conn.getServerName()));
        // port
        ...
        // schema
        // String uischema = metadataConnection.getUiSchema() == null ? metadataConnection.getSchema() :
        // metadataConnection
        // .getUiSchema();
