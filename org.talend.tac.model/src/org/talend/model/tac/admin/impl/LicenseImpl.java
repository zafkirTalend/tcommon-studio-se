 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.admin.impl.LicenseImpl#getLicense <em>License</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.LicenseImpl#getCustomerName <em>Customer Name</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.LicenseImpl#getParams <em>Params</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.LicenseImpl#getToken <em>Token</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.LicenseImpl#getDateTokenCheck <em>Date Token Check</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LicenseImpl extends EObjectImpl implements License {
    ...
    protected EClass eStaticClass() {
        return AdminPackage.Literals.LICENSE;
    }
    ...
    public void setLicense(byte[] newLicense) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.LICENSE__LICENSE, oldLicense, license));
    }
    ...
    public void setCustomerName(String newCustomerName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.LICENSE__CUSTOMER_NAME, oldCustomerName,
                    customerName));
    }
    ...
    public void setParams(String newParams) {
        ...
        params = newParams;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.LICENSE__PARAMS, oldParams, params));
    }
    ...
    public void setToken(String newToken) {
        ...
        token = newToken;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.LICENSE__TOKEN, oldToken, token));
    }
    ...
    public void setDateTokenCheck(String newDateTokenCheck) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.LICENSE__DATE_TOKEN_CHECK, oldDateTokenCheck,
                    dateTokenCheck));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case AdminPackage.LICENSE__LICENSE:
            return getLicense();
        case AdminPackage.LICENSE__CUSTOMER_NAME:
            return getCustomerName();
        case AdminPackage.LICENSE__PARAMS:
            return getParams();
        case AdminPackage.LICENSE__TOKEN:
            return getToken();
        case AdminPackage.LICENSE__DATE_TOKEN_CHECK:
