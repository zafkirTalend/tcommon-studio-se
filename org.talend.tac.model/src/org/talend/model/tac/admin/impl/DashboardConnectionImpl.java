 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getDialect <em>Dialect</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getHost <em>Host</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getPort <em>Port</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getDatabase <em>Database</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getLogTable <em>Log Table</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getStatTable <em>Stat Table</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getFlowMeterTable <em>Flow Meter Table</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getAdditionnalsParams <em>Additionnals Params</em>}</li>
 *   <li>{@link org.talend.model.tac.admin.impl.DashboardConnectionImpl#getDatasource <em>Datasource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DashboardConnectionImpl extends EObjectImpl implements DashboardConnection {
    ...
    protected EClass eStaticClass() {
        return AdminPackage.Literals.DASHBOARD_CONNECTION;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__ID, oldId, id));
    }
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__LABEL, oldLabel, label));
    }
    ...
    public void setDialect(String newDialect) {
        ...
        dialect = newDialect;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__DIALECT, oldDialect, dialect));
    }
    ...
    public void setHost(String newHost) {
        ...
        host = newHost;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__HOST, oldHost, host));
    }
    ...
    public void setPort(String newPort) {
        ...
        port = newPort;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__PORT, oldPort, port));
    }
    ...
    public void setDatabase(String newDatabase) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__DATABASE, oldDatabase,
                    database));
    }
    ...
    public void setUsername(String newUsername) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__USERNAME, oldUsername,
                    username));
    }
    ...
    public void setPassword(String newPassword) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__PASSWORD, oldPassword,
                    password));
    }
    ...
    public void setLogTable(String newLogTable) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__LOG_TABLE, oldLogTable,
                    logTable));
    }
    ...
    public void setStatTable(String newStatTable) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__STAT_TABLE, oldStatTable,
                    statTable));
    }
    ...
    public void setFlowMeterTable(String newFlowMeterTable) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__FLOW_METER_TABLE,
                    oldFlowMeterTable, flowMeterTable));
    }
    ...
    public void setAdditionnalsParams(String newAdditionnalsParams) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__ADDITIONNALS_PARAMS,
                    oldAdditionnalsParams, additionnalsParams));
    }
    ...
    public void setDatasource(String newDatasource) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AdminPackage.DASHBOARD_CONNECTION__DATASOURCE, oldDatasource,
                    datasource));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case AdminPackage.DASHBOARD_CONNECTION__ID:
            return new Integer(getId());
        case AdminPackage.DASHBOARD_CONNECTION__LABEL:
            return getLabel();
        case AdminPackage.DASHBOARD_CONNECTION__DIALECT:
            return getDialect();
        case AdminPackage.DASHBOARD_CONNECTION__HOST:
            return getHost();
        case AdminPackage.DASHBOARD_CONNECTION__PORT:
            return getPort();
        case AdminPackage.DASHBOARD_CONNECTION__DATABASE:
            return getDatabase();
        case AdminPackage.DASHBOARD_CONNECTION__USERNAME:
            return getUsername();
        case AdminPackage.DASHBOARD_CONNECTION__PASSWORD:
            return getPassword();
        case AdminPackage.DASHBOARD_CONNECTION__LOG_TABLE:
            return getLogTable();
        case AdminPackage.DASHBOARD_CONNECTION__STAT_TABLE:
            return getStatTable();
        case AdminPackage.DASHBOARD_CONNECTION__FLOW_METER_TABLE:
            return getFlowMeterTable();
        case AdminPackage.DASHBOARD_CONNECTION__ADDITIONNALS_PARAMS:
            return getAdditionnalsParams();
        case AdminPackage.DASHBOARD_CONNECTION__DATASOURCE:
    ...
    public boolean eIsSet(int featureID) {
        ...
        case AdminPackage.DASHBOARD_CONNECTION__ADDITIONNALS_PARAMS:
            return ADDITIONNALS_PARAMS_EDEFAULT == null ? additionnalsParams != null : !ADDITIONNALS_PARAMS_EDEFAULT
                    .equals(additionnalsParams);
        case AdminPackage.DASHBOARD_CONNECTION__DATASOURCE:
