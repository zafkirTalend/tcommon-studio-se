 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getHost <em>Host</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getPort <em>Port</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getFileTransfertPort <em>File Transfert Port</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#isActive <em>Active</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getMonitoringPort <em>Monitoring Port</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getTimeoutUnknownState <em>Timeout Unknown State</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getJmxUrl <em>Jmx Url</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getWebConsoleUrl <em>Web Console Url</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#isTalendRuntime <em>Talend Runtime</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getMgmtServerPort <em>Mgmt Server Port</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getMgmtRegPort <em>Mgmt Reg Port</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getAdminConsolePort <em>Admin Console Port</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#isUseSSL <em>Use SSL</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionServerImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExecutionServerImpl extends EObjectImpl implements ExecutionServer {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.EXECUTION_SERVER;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__ID, oldId, id));
    }
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__LABEL, oldLabel, label));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__DESCRIPTION, oldDescription,
                    description));
    }
    ...
    public void setHost(String newHost) {
        ...
        host = newHost;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__HOST, oldHost, host));
    }
    ...
    public void setPort(int newPort) {
        ...
        port = newPort;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__PORT, oldPort, port));
    }
    ...
    public void setFileTransfertPort(int newFileTransfertPort) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__FILE_TRANSFERT_PORT,
                    oldFileTransfertPort, fileTransfertPort));
    }
    ...
    public void setActive(boolean newActive) {
        ...
        active = newActive;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__ACTIVE, oldActive, active));
    }
    ...
    public void setMonitoringPort(int newMonitoringPort) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__MONITORING_PORT,
                    oldMonitoringPort, monitoringPort));
    }
    ...
    public void setTimeoutUnknownState(int newTimeoutUnknownState) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__TIMEOUT_UNKNOWN_STATE,
                    oldTimeoutUnknownState, timeoutUnknownState));
    }
    ...
    public void setUsername(String newUsername) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__USERNAME, oldUsername,
                    username));
    }
    ...
    public void setPassword(String newPassword) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__PASSWORD, oldPassword,
                    password));
    }
    ...
    public void setJmxUrl(String newJmxUrl) {
        ...
        jmxUrl = newJmxUrl;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__JMX_URL, oldJmxUrl, jmxUrl));
    }
    ...
    public void setWebConsoleUrl(String newWebConsoleUrl) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__WEB_CONSOLE_URL,
                    oldWebConsoleUrl, webConsoleUrl));
    }
    ...
    public void setTalendRuntime(boolean newTalendRuntime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__TALEND_RUNTIME,
                    oldTalendRuntime, talendRuntime));
    }
    ...
    public void setMgmtServerPort(int newMgmtServerPort) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__MGMT_SERVER_PORT,
                    oldMgmtServerPort, mgmtServerPort));
    }
    ...
    public void setMgmtRegPort(int newMgmtRegPort) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__MGMT_REG_PORT,
                    oldMgmtRegPort, mgmtRegPort));
    }
    ...
    public void setAdminConsolePort(int newAdminConsolePort) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__ADMIN_CONSOLE_PORT,
                    oldAdminConsolePort, adminConsolePort));
    }
    ...
    public void setUseSSL(boolean newUseSSL) {
        ...
        useSSL = newUseSSL;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__USE_SSL, oldUseSSL, useSSL));
    }
    ...
    public void setInstance(String newInstance) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_SERVER__INSTANCE, oldInstance,
                    instance));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.EXECUTION_SERVER__ID:
            return new Integer(getId());
        case ConductorPackage.EXECUTION_SERVER__LABEL:
            return getLabel();
        case ConductorPackage.EXECUTION_SERVER__DESCRIPTION:
            return getDescription();
        case ConductorPackage.EXECUTION_SERVER__HOST:
            return getHost();
        case ConductorPackage.EXECUTION_SERVER__PORT:
            return new Integer(getPort());
        case ConductorPackage.EXECUTION_SERVER__FILE_TRANSFERT_PORT:
            return new Integer(getFileTransfertPort());
        case ConductorPackage.EXECUTION_SERVER__ACTIVE:
            return isActive() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.EXECUTION_SERVER__MONITORING_PORT:
            return new Integer(getMonitoringPort());
        case ConductorPackage.EXECUTION_SERVER__TIMEOUT_UNKNOWN_STATE:
            return new Integer(getTimeoutUnknownState());
        case ConductorPackage.EXECUTION_SERVER__USERNAME:
            return getUsername();
        case ConductorPackage.EXECUTION_SERVER__PASSWORD:
            return getPassword();
        case ConductorPackage.EXECUTION_SERVER__JMX_URL:
            return getJmxUrl();
        case ConductorPackage.EXECUTION_SERVER__WEB_CONSOLE_URL:
            return getWebConsoleUrl();
        case ConductorPackage.EXECUTION_SERVER__TALEND_RUNTIME:
            return isTalendRuntime() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.EXECUTION_SERVER__MGMT_SERVER_PORT:
            return new Integer(getMgmtServerPort());
        case ConductorPackage.EXECUTION_SERVER__MGMT_REG_PORT:
            return new Integer(getMgmtRegPort());
        case ConductorPackage.EXECUTION_SERVER__ADMIN_CONSOLE_PORT:
            return new Integer(getAdminConsolePort());
        case ConductorPackage.EXECUTION_SERVER__USE_SSL:
            return isUseSSL() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.EXECUTION_SERVER__INSTANCE:
            return getInstance();
        }
