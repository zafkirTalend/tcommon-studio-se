 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#isActive <em>Active</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#getFileTrigger <em>File Trigger</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#getFolderPath <em>Folder Path</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#getFileMask <em>File Mask</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#getContextParameterBaseName <em>Context Parameter Base Name</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#getCheckFileServer <em>Check File Server</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#isExist <em>Exist</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#isCreated <em>Created</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerMaskImpl#isModified <em>Modified</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileTriggerMaskImpl extends EObjectImpl implements FileTriggerMask {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.FILE_TRIGGER_MASK;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__ID, oldId, id));
    }
    ...
    public void setActive(boolean newActive) {
        ...
        active = newActive;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__ACTIVE, oldActive, active));
    }
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__LABEL, oldLabel, label));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__DESCRIPTION,
    ...
    public FileTrigger getFileTrigger() {
        if (fileTrigger != null && fileTrigger.eIsProxy()) {
            ...
            if (fileTrigger != oldFileTrigger) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConductorPackage.FILE_TRIGGER_MASK__FILE_TRIGGER,
                            oldFileTrigger, fileTrigger));
            }
        }
        return fileTrigger;
    }
    ...
    public void setFileTrigger(FileTrigger newFileTrigger) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__FILE_TRIGGER,
                    oldFileTrigger, fileTrigger));
    }
    ...
    public void setFolderPath(String newFolderPath) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__FOLDER_PATH, oldFolderPath,
                    folderPath));
    }
    ...
    public void setFileMask(String newFileMask) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__FILE_MASK, oldFileMask,
                    fileMask));
    }
    ...
    public void setContextParameterBaseName(String newContextParameterBaseName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.FILE_TRIGGER_MASK__CONTEXT_PARAMETER_BASE_NAME, oldContextParameterBaseName,
                    contextParameterBaseName));
    }
            ...
            if (checkFileServer != oldCheckFileServer) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ConductorPackage.FILE_TRIGGER_MASK__CHECK_FILE_SERVER, oldCheckFileServer, checkFileServer));
            }
        }
    ...
    public void setCheckFileServer(ExecutionServer newCheckFileServer) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__CHECK_FILE_SERVER,
                    oldCheckFileServer, checkFileServer));
    }
    ...
    public void setExist(boolean newExist) {
        ...
        exist = newExist;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__EXIST, oldExist, exist));
    }
    ...
    public void setCreated(boolean newCreated) {
        ...
        created = newCreated;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__CREATED, oldCreated,
                    created));
    }
    ...
    public void setModified(boolean newModified) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.FILE_TRIGGER_MASK__MODIFIED, oldModified,
                    modified));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.FILE_TRIGGER_MASK__ID:
            return new Integer(getId());
        case ConductorPackage.FILE_TRIGGER_MASK__ACTIVE:
            return isActive() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.FILE_TRIGGER_MASK__LABEL:
            return getLabel();
        case ConductorPackage.FILE_TRIGGER_MASK__DESCRIPTION:
            return getDescription();
        case ConductorPackage.FILE_TRIGGER_MASK__FILE_TRIGGER:
            if (resolve)
                return getFileTrigger();
            return basicGetFileTrigger();
        case ConductorPackage.FILE_TRIGGER_MASK__FOLDER_PATH:
            return getFolderPath();
        case ConductorPackage.FILE_TRIGGER_MASK__FILE_MASK:
            return getFileMask();
        case ConductorPackage.FILE_TRIGGER_MASK__CONTEXT_PARAMETER_BASE_NAME:
            return getContextParameterBaseName();
        case ConductorPackage.FILE_TRIGGER_MASK__CHECK_FILE_SERVER:
            if (resolve)
                return getCheckFileServer();
            return basicGetCheckFileServer();
        case ConductorPackage.FILE_TRIGGER_MASK__EXIST:
            return isExist() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.FILE_TRIGGER_MASK__CREATED:
            return isCreated() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.FILE_TRIGGER_MASK__MODIFIED:
    ...
    public boolean eIsSet(int featureID) {
        ...
        case ConductorPackage.FILE_TRIGGER_MASK__CONTEXT_PARAMETER_BASE_NAME:
            return CONTEXT_PARAMETER_BASE_NAME_EDEFAULT == null ? contextParameterBaseName != null
                    : !CONTEXT_PARAMETER_BASE_NAME_EDEFAULT.equals(contextParameterBaseName);
        case ConductorPackage.FILE_TRIGGER_MASK__CHECK_FILE_SERVER:
