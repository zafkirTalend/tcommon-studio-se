 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartJobPrmImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartJobPrmImpl#getExecutionPlanPart <em>Execution Plan Part</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartJobPrmImpl#isOverride <em>Override</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartJobPrmImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartJobPrmImpl#getCustomValue <em>Custom Value</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartJobPrmImpl#getPartCustomValue <em>Part Custom Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExecutionPlanPartJobPrmImpl extends EObjectImpl implements ExecutionPlanPartJobPrm {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.EXECUTION_PLAN_PART_JOB_PRM;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__ID, oldId, id));
    }
            ...
            if (executionPlanPart != oldExecutionPlanPart) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__EXECUTION_PLAN_PART, oldExecutionPlanPart,
                            executionPlanPart));
            }
        }
    ...
    public void setExecutionPlanPart(ExecutionPlanPart newExecutionPlanPart) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__EXECUTION_PLAN_PART, oldExecutionPlanPart, executionPlanPart));
    }
    ...
    public void setOverride(boolean newOverride) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__OVERRIDE,
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__NAME, oldName,
                    name));
    }
    ...
    public void setCustomValue(String newCustomValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__CUSTOM_VALUE,
                    oldCustomValue, customValue));
    }
    ...
    public void setPartCustomValue(String newPartCustomValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__PART_CUSTOM_VALUE, oldPartCustomValue, partCustomValue));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__ID:
            return new Integer(getId());
        case ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__EXECUTION_PLAN_PART:
            if (resolve)
                return getExecutionPlanPart();
            return basicGetExecutionPlanPart();
        case ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__OVERRIDE:
            return isOverride() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__NAME:
            return getName();
        case ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__CUSTOM_VALUE:
            return getCustomValue();
        case ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__PART_CUSTOM_VALUE:
    ...
    public boolean eIsSet(int featureID) {
        ...
        case ConductorPackage.EXECUTION_PLAN_PART_JOB_PRM__PART_CUSTOM_VALUE:
            return PART_CUSTOM_VALUE_EDEFAULT == null ? partCustomValue != null : !PART_CUSTOM_VALUE_EDEFAULT
                    .equals(partCustomValue);
        }
