 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartCmdPrmImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartCmdPrmImpl#getExecutionPlanPart <em>Execution Plan Part</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartCmdPrmImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartCmdPrmImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExecutionPlanPartCmdPrmImpl extends EObjectImpl implements ExecutionPlanPartCmdPrm {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.EXECUTION_PLAN_PART_CMD_PRM;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART_CMD_PRM__ID, oldId, id));
    }
            ...
            if (executionPlanPart != oldExecutionPlanPart) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ConductorPackage.EXECUTION_PLAN_PART_CMD_PRM__EXECUTION_PLAN_PART, oldExecutionPlanPart,
                            executionPlanPart));
            }
        }
    ...
    public void setExecutionPlanPart(ExecutionPlanPart newExecutionPlanPart) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.EXECUTION_PLAN_PART_CMD_PRM__EXECUTION_PLAN_PART, oldExecutionPlanPart, executionPlanPart));
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART_CMD_PRM__NAME, oldName,
                    name));
    }
    ...
    public void setValue(String newValue) {
        ...
        value = newValue;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART_CMD_PRM__VALUE, oldValue,
                    value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.EXECUTION_PLAN_PART_CMD_PRM__ID:
            return new Integer(getId());
        case ConductorPackage.EXECUTION_PLAN_PART_CMD_PRM__EXECUTION_PLAN_PART:
            if (resolve)
                return getExecutionPlanPart();
            return basicGetExecutionPlanPart();
        case ConductorPackage.EXECUTION_PLAN_PART_CMD_PRM__NAME:
            return getName();
        case ConductorPackage.EXECUTION_PLAN_PART_CMD_PRM__VALUE:
            return getValue();
        }
