 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#getTriggers <em>Triggers</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#getIdQuartzJob <em>Id Quartz Job</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#getErrorStatus <em>Error Status</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#isConcurrentExecution <em>Concurrent Execution</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#isProcessingState <em>Processing State</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#getRequestId <em>Request Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#getExecPlanParts <em>Exec Plan Parts</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#getExecPlanPrms <em>Exec Plan Prms</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExecutionPlanImpl extends EObjectImpl implements ExecutionPlan {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.EXECUTION_PLAN;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN__ID, oldId, id));
    }
    ...
    public EList getTriggers() {
        if (triggers == null) {
            triggers = new EObjectContainmentWithInverseEList(TalendTrigger.class, this,
                    ConductorPackage.EXECUTION_PLAN__TRIGGERS, ConductorPackage.TALEND_TRIGGER__EXECUTION_TRIGGERABLE);
        }
        return triggers;
    }
    ...
    public void setIdQuartzJob(int newIdQuartzJob) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN__ID_QUARTZ_JOB, oldIdQuartzJob,
                    idQuartzJob));
    }
    ...
    public void setStatus(String newStatus) {
        ...
        status = newStatus;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN__STATUS, oldStatus, status));
    }
    ...
    public void setErrorStatus(String newErrorStatus) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN__ERROR_STATUS, oldErrorStatus,
                    errorStatus));
    }
    ...
    public void setConcurrentExecution(boolean newConcurrentExecution) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN__CONCURRENT_EXECUTION,
    ...
    public void setProcessingState(boolean newProcessingState) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN__PROCESSING_STATE,
    ...
    public void setRequestId(String newRequestId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN__REQUEST_ID, oldRequestId,
                    requestId));
    }
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN__LABEL, oldLabel, label));
    }
    ...
    public EList getExecPlanParts() {
        if (execPlanParts == null) {
            execPlanParts = new EObjectContainmentEList(ExecutionPlanPart.class, this,
                    ConductorPackage.EXECUTION_PLAN__EXEC_PLAN_PARTS);
        }
    ...
    public EList getExecPlanPrms() {
        if (execPlanPrms == null) {
            execPlanPrms = new EObjectContainmentEList(ExecutionPlanPrm.class, this,
                    ConductorPackage.EXECUTION_PLAN__EXEC_PLAN_PRMS);
        }
        return execPlanPrms;
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN__DESCRIPTION, oldDescription,
                    description));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case ConductorPackage.EXECUTION_PLAN__TRIGGERS:
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case ConductorPackage.EXECUTION_PLAN__EXEC_PLAN_PARTS:
            return ((InternalEList) getExecPlanParts()).basicRemove(otherEnd, msgs);
        case ConductorPackage.EXECUTION_PLAN__EXEC_PLAN_PRMS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.EXECUTION_PLAN__ID:
            return new Integer(getId());
        case ConductorPackage.EXECUTION_PLAN__TRIGGERS:
            return getTriggers();
        case ConductorPackage.EXECUTION_PLAN__ID_QUARTZ_JOB:
            return new Integer(getIdQuartzJob());
        case ConductorPackage.EXECUTION_PLAN__STATUS:
            return getStatus();
        case ConductorPackage.EXECUTION_PLAN__ERROR_STATUS:
            return getErrorStatus();
        case ConductorPackage.EXECUTION_PLAN__CONCURRENT_EXECUTION:
            return isConcurrentExecution() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.EXECUTION_PLAN__PROCESSING_STATE:
            return isProcessingState() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.EXECUTION_PLAN__REQUEST_ID:
            return getRequestId();
        case ConductorPackage.EXECUTION_PLAN__LABEL:
            return getLabel();
        case ConductorPackage.EXECUTION_PLAN__EXEC_PLAN_PARTS:
            return getExecPlanParts();
        case ConductorPackage.EXECUTION_PLAN__EXEC_PLAN_PRMS:
            return getExecPlanPrms();
        case ConductorPackage.EXECUTION_PLAN__DESCRIPTION:
