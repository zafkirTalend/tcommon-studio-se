 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#isActive <em>Active</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getTriggerType <em>Trigger Type</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getExecutionTriggerable <em>Execution Triggerable</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getEndTime <em>End Time</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getPreviousFireTime <em>Previous Fire Time</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getFinalFireTime <em>Final Fire Time</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getIdQuartzTrigger <em>Id Quartz Trigger</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#getResumePauseUpdated <em>Resume Pause Updated</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TalendTriggerImpl#isPreviouslyPaused <em>Previously Paused</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TalendTriggerImpl extends EObjectImpl implements TalendTrigger {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.TALEND_TRIGGER;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__ID, oldId, id));
    }
    ...
    public void setActive(boolean newActive) {
        ...
        active = newActive;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__ACTIVE, oldActive, active));
    }
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__LABEL, oldLabel, label));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__DESCRIPTION, oldDescription,
                    description));
    }
    ...
    public void setTriggerType(String newTriggerType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__TRIGGER_TYPE, oldTriggerType,
                    triggerType));
    }
    ...
    public ExecutionTriggerable getExecutionTriggerable() {
        if (eContainerFeatureID() != ConductorPackage.TALEND_TRIGGER__EXECUTION_TRIGGERABLE)
            return null;
    ...
    public NotificationChain basicSetExecutionTriggerable(ExecutionTriggerable newExecutionTriggerable, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newExecutionTriggerable,
                ConductorPackage.TALEND_TRIGGER__EXECUTION_TRIGGERABLE, msgs);
        return msgs;
    }
    ...
    public void setExecutionTriggerable(ExecutionTriggerable newExecutionTriggerable) {
        if (newExecutionTriggerable != eInternalContainer()
                || (eContainerFeatureID() != ConductorPackage.TALEND_TRIGGER__EXECUTION_TRIGGERABLE && newExecutionTriggerable != null)) {
            ...
            if (newExecutionTriggerable != null)
                msgs = ((InternalEObject) newExecutionTriggerable).eInverseAdd(this,
                        ConductorPackage.EXECUTION_TRIGGERABLE__TRIGGERS, ExecutionTriggerable.class, msgs);
            msgs = basicSetExecutionTriggerable(newExecutionTriggerable, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__EXECUTION_TRIGGERABLE,
                    newExecutionTriggerable, newExecutionTriggerable));
    }
    ...
    public void setStartTime(Date newStartTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__START_TIME, oldStartTime,
                    startTime));
    }
    ...
    public void setEndTime(Date newEndTime) {
        ...
        endTime = newEndTime;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__END_TIME, oldEndTime, endTime));
    }
    ...
    public void setPreviousFireTime(Date newPreviousFireTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__PREVIOUS_FIRE_TIME,
                    oldPreviousFireTime, previousFireTime));
    }
    ...
    public void setFinalFireTime(Date newFinalFireTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__FINAL_FIRE_TIME,
                    oldFinalFireTime, finalFireTime));
    }
    ...
    public void setIdQuartzTrigger(int newIdQuartzTrigger) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__ID_QUARTZ_TRIGGER,
    ...
    public void setResumePauseUpdated(Date newResumePauseUpdated) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__RESUME_PAUSE_UPDATED,
                    oldResumePauseUpdated, resumePauseUpdated));
    }
    ...
    public void setPreviouslyPaused(boolean newPreviouslyPaused) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TALEND_TRIGGER__PREVIOUSLY_PAUSED,
                    oldPreviouslyPaused, previouslyPaused));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case ConductorPackage.TALEND_TRIGGER__EXECUTION_TRIGGERABLE:
            if (eInternalContainer() != null)
                msgs = eBasicRemoveFromContainer(msgs);
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case ConductorPackage.TALEND_TRIGGER__EXECUTION_TRIGGERABLE:
            return eInternalContainer().eInverseRemove(this, ConductorPackage.EXECUTION_TRIGGERABLE__TRIGGERS,
                    ExecutionTriggerable.class, msgs);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.TALEND_TRIGGER__ID:
            return new Integer(getId());
        case ConductorPackage.TALEND_TRIGGER__ACTIVE:
            return isActive() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.TALEND_TRIGGER__LABEL:
            return getLabel();
        case ConductorPackage.TALEND_TRIGGER__DESCRIPTION:
            return getDescription();
        case ConductorPackage.TALEND_TRIGGER__TRIGGER_TYPE:
            return getTriggerType();
        case ConductorPackage.TALEND_TRIGGER__EXECUTION_TRIGGERABLE:
            return getExecutionTriggerable();
        case ConductorPackage.TALEND_TRIGGER__START_TIME:
            return getStartTime();
        case ConductorPackage.TALEND_TRIGGER__END_TIME:
            return getEndTime();
        case ConductorPackage.TALEND_TRIGGER__PREVIOUS_FIRE_TIME:
            return getPreviousFireTime();
        case ConductorPackage.TALEND_TRIGGER__FINAL_FIRE_TIME:
            return getFinalFireTime();
        case ConductorPackage.TALEND_TRIGGER__ID_QUARTZ_TRIGGER:
            return new Integer(getIdQuartzTrigger());
        case ConductorPackage.TALEND_TRIGGER__RESUME_PAUSE_UPDATED:
            return getResumePauseUpdated();
        case ConductorPackage.TALEND_TRIGGER__PREVIOUSLY_PAUSED:
    ...
    public boolean eIsSet(int featureID) {
        ...
        case ConductorPackage.TALEND_TRIGGER__PREVIOUS_FIRE_TIME:
            return PREVIOUS_FIRE_TIME_EDEFAULT == null ? previousFireTime != null : !PREVIOUS_FIRE_TIME_EDEFAULT
                    .equals(previousFireTime);
        case ConductorPackage.TALEND_TRIGGER__FINAL_FIRE_TIME:
        ...
        case ConductorPackage.TALEND_TRIGGER__RESUME_PAUSE_UPDATED:
            return RESUME_PAUSE_UPDATED_EDEFAULT == null ? resumePauseUpdated != null : !RESUME_PAUSE_UPDATED_EDEFAULT
                    .equals(resumePauseUpdated);
        case ConductorPackage.TALEND_TRIGGER__PREVIOUSLY_PAUSED:
