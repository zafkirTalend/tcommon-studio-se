 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getTask <em>Task</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getExecutionPlan <em>Execution Plan</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getJvmPrms <em>Jvm Prms</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getContextPrms <em>Context Prms</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getRequestId <em>Request Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#isUseParallel <em>Use Parallel</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.ExecutionPlanPartImpl#getMaxThreads <em>Max Threads</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExecutionPlanPartImpl extends EObjectImpl implements ExecutionPlanPart {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.EXECUTION_PLAN_PART;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__ID, oldId, id));
    }
    ...
    public ExecutionTask getTask() {
        if (task != null && task.eIsProxy()) {
            ...
            if (task != oldTask) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConductorPackage.EXECUTION_PLAN_PART__TASK,
                            oldTask, task));
            }
        }
        return task;
    ...
    public void setTask(ExecutionTask newTask) {
        ...
        task = newTask;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__TASK, oldTask, task));
    }
            ...
            if (executionPlan != oldExecutionPlan) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            ConductorPackage.EXECUTION_PLAN_PART__EXECUTION_PLAN, oldExecutionPlan, executionPlan));
            }
        }
    ...
    public void setExecutionPlan(ExecutionPlan newExecutionPlan) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__EXECUTION_PLAN,
    ...
    public ExecutionPlanPart getParent() {
        if (parent != null && parent.eIsProxy()) {
            ...
            if (parent != oldParent) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConductorPackage.EXECUTION_PLAN_PART__PARENT,
                            oldParent, parent));
            }
        }
        return parent;
    ...
    public void setParent(ExecutionPlanPart newParent) {
        ...
        parent = newParent;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__PARENT, oldParent, parent));
    }
    ...
    public void setType(String newType) {
        ...
        type = newType;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__TYPE, oldType, type));
    }
    ...
    public EList getJvmPrms() {
        if (jvmPrms == null) {
            jvmPrms = new EObjectContainmentEList(ExecutionPlanPartCmdPrm.class, this,
                    ConductorPackage.EXECUTION_PLAN_PART__JVM_PRMS);
        }
        return jvmPrms;
    }
    ...
    public EList getContextPrms() {
        if (contextPrms == null) {
            contextPrms = new EObjectContainmentEList(ExecutionPlanPartJobPrm.class, this,
                    ConductorPackage.EXECUTION_PLAN_PART__CONTEXT_PRMS);
        }
        return contextPrms;
    }
    ...
    public void setStatus(String newStatus) {
        ...
        status = newStatus;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__STATUS, oldStatus, status));
    }
    ...
    public void setStartDate(Date newStartDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__START_DATE, oldStartDate,
                    startDate));
    }
    ...
    public void setEndDate(Date newEndDate) {
        ...
        endDate = newEndDate;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__END_DATE, oldEndDate,
                    endDate));
    }
    ...
    public void setRequestId(String newRequestId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__REQUEST_ID, oldRequestId,
                    requestId));
    }
    ...
    public void setUseParallel(boolean newUseParallel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__USE_PARALLEL,
                    oldUseParallel, useParallel));
    }
    ...
    public void setMaxThreads(Integer newMaxThreads) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.EXECUTION_PLAN_PART__MAX_THREADS,
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case ConductorPackage.EXECUTION_PLAN_PART__JVM_PRMS:
            return ((InternalEList) getJvmPrms()).basicRemove(otherEnd, msgs);
        case ConductorPackage.EXECUTION_PLAN_PART__CONTEXT_PRMS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.EXECUTION_PLAN_PART__ID:
            return new Integer(getId());
        case ConductorPackage.EXECUTION_PLAN_PART__TASK:
            if (resolve)
                return getTask();
            return basicGetTask();
        case ConductorPackage.EXECUTION_PLAN_PART__EXECUTION_PLAN:
            if (resolve)
                return getExecutionPlan();
            return basicGetExecutionPlan();
        case ConductorPackage.EXECUTION_PLAN_PART__PARENT:
            if (resolve)
                return getParent();
            return basicGetParent();
        case ConductorPackage.EXECUTION_PLAN_PART__TYPE:
            return getType();
        case ConductorPackage.EXECUTION_PLAN_PART__JVM_PRMS:
            return getJvmPrms();
        case ConductorPackage.EXECUTION_PLAN_PART__CONTEXT_PRMS:
            return getContextPrms();
        case ConductorPackage.EXECUTION_PLAN_PART__STATUS:
            return getStatus();
        case ConductorPackage.EXECUTION_PLAN_PART__START_DATE:
            return getStartDate();
        case ConductorPackage.EXECUTION_PLAN_PART__END_DATE:
            return getEndDate();
        case ConductorPackage.EXECUTION_PLAN_PART__REQUEST_ID:
            return getRequestId();
        case ConductorPackage.EXECUTION_PLAN_PART__USE_PARALLEL:
            return isUseParallel() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.EXECUTION_PLAN_PART__MAX_THREADS:
