 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.FileTriggerImpl#getFileTriggerMasks <em>File Trigger Masks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileTriggerImpl extends SimpleTalendTriggerImpl implements FileTrigger {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.FILE_TRIGGER;
    }
    ...
    public EList getFileTriggerMasks() {
        if (fileTriggerMasks == null) {
            fileTriggerMasks = new EObjectContainmentEList(FileTriggerMask.class, this,
                    ConductorPackage.FILE_TRIGGER__FILE_TRIGGER_MASKS);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case ConductorPackage.FILE_TRIGGER__FILE_TRIGGER_MASKS:
