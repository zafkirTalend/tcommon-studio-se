 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.CronTalendTriggerImpl#getCronExpression <em>Cron Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CronTalendTriggerImpl extends TalendTriggerImpl implements CronTalendTrigger {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.CRON_TALEND_TRIGGER;
    }
    ...
    public void setCronExpression(String newCronExpression) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.CRON_TALEND_TRIGGER__CRON_EXPRESSION,
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.CRON_TALEND_TRIGGER__CRON_EXPRESSION:
