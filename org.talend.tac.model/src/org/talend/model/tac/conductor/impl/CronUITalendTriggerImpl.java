 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.CronUITalendTriggerImpl#getListDaysOfWeek <em>List Days Of Week</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.CronUITalendTriggerImpl#getListDaysOfMonth <em>List Days Of Month</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.CronUITalendTriggerImpl#getListMonths <em>List Months</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.CronUITalendTriggerImpl#getListYears <em>List Years</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.CronUITalendTriggerImpl#getListHours <em>List Hours</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.CronUITalendTriggerImpl#getListMinutes <em>List Minutes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CronUITalendTriggerImpl extends TalendTriggerImpl implements CronUITalendTrigger {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.CRON_UI_TALEND_TRIGGER;
    }
    ...
    public void setListDaysOfWeek(String newListDaysOfWeek) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_DAYS_OF_WEEK,
                    oldListDaysOfWeek, listDaysOfWeek));
    }
    ...
    public void setListDaysOfMonth(String newListDaysOfMonth) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_DAYS_OF_MONTH,
                    oldListDaysOfMonth, listDaysOfMonth));
    }
    ...
    public void setListMonths(String newListMonths) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_MONTHS,
                    oldListMonths, listMonths));
    }
    ...
    public void setListYears(String newListYears) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_YEARS,
                    oldListYears, listYears));
    }
    ...
    public void setListHours(String newListHours) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_HOURS,
                    oldListHours, listHours));
    }
    ...
    public void setListMinutes(String newListMinutes) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_MINUTES,
                    oldListMinutes, listMinutes));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_DAYS_OF_WEEK:
            return getListDaysOfWeek();
        case ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_DAYS_OF_MONTH:
            return getListDaysOfMonth();
        case ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_MONTHS:
            return getListMonths();
        case ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_YEARS:
            return getListYears();
        case ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_HOURS:
            return getListHours();
        case ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_MINUTES:
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_DAYS_OF_WEEK:
            return LIST_DAYS_OF_WEEK_EDEFAULT == null ? listDaysOfWeek != null : !LIST_DAYS_OF_WEEK_EDEFAULT
                    .equals(listDaysOfWeek);
        case ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_DAYS_OF_MONTH:
            return LIST_DAYS_OF_MONTH_EDEFAULT == null ? listDaysOfMonth != null : !LIST_DAYS_OF_MONTH_EDEFAULT
                    .equals(listDaysOfMonth);
        case ConductorPackage.CRON_UI_TALEND_TRIGGER__LIST_MONTHS:
