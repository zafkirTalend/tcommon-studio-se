...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Task Execution History</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getBasicStatus <em>Basic Status</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getDetailedStatus <em>Detailed Status</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTaskLabel <em>Task Label</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTaskDescription <em>Task Description</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getProjectName <em>Project Name</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTalendJobName <em>Talend Job Name</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTalendJobId <em>Talend Job Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTalendJobVersion <em>Talend Job Version</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getContextName <em>Context Name</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getVirtualServerName <em>Virtual Server Name</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getExecutionServerName <em>Execution Server Name</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getExecutionServerHost <em>Execution Server Host</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getExecutionServerCmdPort <em>Execution Server Cmd Port</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getExecutionServerFilePort <em>Execution Server File Port</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getExecutionServerMonitoringPort <em>Execution Server Monitoring Port</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#isApplyContextToChildren <em>Apply Context To Children</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTriggeredBy <em>Triggered By</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTriggerType <em>Trigger Type</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTriggerName <em>Trigger Name</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTriggerDescription <em>Trigger Description</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTaskErrorStackTrace <em>Task Error Stack Trace</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getIdQuartzJob <em>Id Quartz Job</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getIdQuartzTrigger <em>Id Quartz Trigger</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getLastJobGenerationDate <em>Last Job Generation Date</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getJobArchiveFilename <em>Job Archive Filename</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getFileTriggerFileMask <em>File Trigger File Mask</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getFileTriggerFileName <em>File Trigger File Name</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getFileTriggerFolderPath <em>File Trigger Folder Path</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getFileTriggerTriggeredFilePath <em>File Trigger Triggered File Path</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getExpectedTriggeringDate <em>Expected Triggering Date</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTaskStartDate <em>Task Start Date</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getTaskEndDate <em>Task End Date</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getServerJobStartDate <em>Server Job Start Date</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getServerJobEndDate <em>Server Job End Date</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getIdRemoteJob <em>Id Remote Job</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getIdRemoteJobExecution <em>Id Remote Job Execution</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getRequestId <em>Request Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#isResumingMode <em>Resuming Mode</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getContextValues <em>Context Values</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getJvmValues <em>Jvm Values</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getParentTaskExecId <em>Parent Task Exec Id</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.TaskExecutionHistoryImpl#getParentPlanExecId <em>Parent Plan Exec Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaskExecutionHistoryImpl extends EObjectImpl implements TaskExecutionHistory {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.TASK_EXECUTION_HISTORY;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__ID, oldId, id));
    }
    ...
    public void setBasicStatus(String newBasicStatus) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__BASIC_STATUS,
    ...
    public void setDetailedStatus(String newDetailedStatus) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__DETAILED_STATUS,
    ...
    public void setTaskLabel(String newTaskLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TASK_LABEL,
    ...
    public void setTaskDescription(String newTaskDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TASK_DESCRIPTION,
    ...
    public void setProjectName(String newProjectName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__PROJECT_NAME,
    ...
    public void setTalendJobName(String newTalendJobName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TALEND_JOB_NAME,
    ...
    public void setTalendJobId(String newTalendJobId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TALEND_JOB_ID,
    ...
    public void setTalendJobVersion(String newTalendJobVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TALEND_JOB_VERSION,
    ...
    public void setContextName(String newContextName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__CONTEXT_NAME,
    ...
    public void setVirtualServerName(String newVirtualServerName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__VIRTUAL_SERVER_NAME,
    ...
    public void setExecutionServerName(String newExecutionServerName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_NAME,
                    oldExecutionServerName, executionServerName));
    }
    ...
    public void setExecutionServerHost(String newExecutionServerHost) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_HOST,
                    oldExecutionServerHost, executionServerHost));
    }
    ...
    public void setExecutionServerCmdPort(int newExecutionServerCmdPort) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_CMD_PORT, oldExecutionServerCmdPort,
                    executionServerCmdPort));
    }
    ...
    public void setExecutionServerFilePort(int newExecutionServerFilePort) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_FILE_PORT, oldExecutionServerFilePort,
                    executionServerFilePort));
    }
    ...
    public void setExecutionServerMonitoringPort(int newExecutionServerMonitoringPort) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_MONITORING_PORT, oldExecutionServerMonitoringPort,
                    executionServerMonitoringPort));
    }
    ...
    public void setApplyContextToChildren(boolean newApplyContextToChildren) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__APPLY_CONTEXT_TO_CHILDREN, oldApplyContextToChildren,
    ...
    public void setTriggeredBy(String newTriggeredBy) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TRIGGERED_BY,
    ...
    public void setTriggerType(String newTriggerType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TRIGGER_TYPE,
    ...
    public void setTriggerName(String newTriggerName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TRIGGER_NAME,
    ...
    public void setTriggerDescription(String newTriggerDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TRIGGER_DESCRIPTION,
    ...
    public void setTaskErrorStackTrace(String newTaskErrorStackTrace) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__TASK_ERROR_STACK_TRACE, oldTaskErrorStackTrace, taskErrorStackTrace));
    }
    ...
    public void setIdQuartzJob(int newIdQuartzJob) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__ID_QUARTZ_JOB,
    ...
    public void setIdQuartzTrigger(Integer newIdQuartzTrigger) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__ID_QUARTZ_TRIGGER,
    ...
    public void setLastJobGenerationDate(Date newLastJobGenerationDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__LAST_JOB_GENERATION_DATE, oldLastJobGenerationDate,
    ...
    public void setJobArchiveFilename(String newJobArchiveFilename) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__JOB_ARCHIVE_FILENAME,
    ...
    public void setFileTriggerFileMask(String newFileTriggerFileMask) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__FILE_TRIGGER_FILE_MASK, oldFileTriggerFileMask, fileTriggerFileMask));
    }
    ...
    public void setFileTriggerFileName(String newFileTriggerFileName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__FILE_TRIGGER_FILE_NAME, oldFileTriggerFileName, fileTriggerFileName));
    }
    ...
    public void setFileTriggerFolderPath(String newFileTriggerFolderPath) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__FILE_TRIGGER_FOLDER_PATH, oldFileTriggerFolderPath,
    ...
    public void setFileTriggerTriggeredFilePath(String newFileTriggerTriggeredFilePath) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__FILE_TRIGGER_TRIGGERED_FILE_PATH, oldFileTriggerTriggeredFilePath,
    ...
    public void setExpectedTriggeringDate(Date newExpectedTriggeringDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__EXPECTED_TRIGGERING_DATE, oldExpectedTriggeringDate,
    ...
    public void setTaskStartDate(Date newTaskStartDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TASK_START_DATE,
    ...
    public void setTaskEndDate(Date newTaskEndDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__TASK_END_DATE,
    ...
    public void setServerJobStartDate(Date newServerJobStartDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__SERVER_JOB_START_DATE,
                    oldServerJobStartDate, serverJobStartDate));
    }
    ...
    public void setServerJobEndDate(Date newServerJobEndDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__SERVER_JOB_END_DATE,
    ...
    public void setIdRemoteJob(String newIdRemoteJob) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__ID_REMOTE_JOB,
    ...
    public void setIdRemoteJobExecution(String newIdRemoteJobExecution) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ConductorPackage.TASK_EXECUTION_HISTORY__ID_REMOTE_JOB_EXECUTION, oldIdRemoteJobExecution,
    ...
    public void setRequestId(String newRequestId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__REQUEST_ID,
    ...
    public void setResumingMode(boolean newResumingMode) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__RESUMING_MODE,
    ...
    public void setContextValues(String newContextValues) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__CONTEXT_VALUES,
    ...
    public void setJvmValues(String newJvmValues) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__JVM_VALUES,
    ...
    public void setParentTaskExecId(int newParentTaskExecId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__PARENT_TASK_EXEC_ID,
                    oldParentTaskExecId, parentTaskExecId));
    }
    ...
    public void setParentPlanExecId(int newParentPlanExecId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.TASK_EXECUTION_HISTORY__PARENT_PLAN_EXEC_ID,
                    oldParentPlanExecId, parentPlanExecId));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.TASK_EXECUTION_HISTORY__ID:
            return new Integer(getId());
        case ConductorPackage.TASK_EXECUTION_HISTORY__BASIC_STATUS:
            return getBasicStatus();
        case ConductorPackage.TASK_EXECUTION_HISTORY__DETAILED_STATUS:
            return getDetailedStatus();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TASK_LABEL:
            return getTaskLabel();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TASK_DESCRIPTION:
            return getTaskDescription();
        case ConductorPackage.TASK_EXECUTION_HISTORY__PROJECT_NAME:
            return getProjectName();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TALEND_JOB_NAME:
            return getTalendJobName();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TALEND_JOB_ID:
            return getTalendJobId();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TALEND_JOB_VERSION:
            return getTalendJobVersion();
        case ConductorPackage.TASK_EXECUTION_HISTORY__CONTEXT_NAME:
            return getContextName();
        case ConductorPackage.TASK_EXECUTION_HISTORY__VIRTUAL_SERVER_NAME:
            return getVirtualServerName();
        case ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_NAME:
            return getExecutionServerName();
        case ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_HOST:
            return getExecutionServerHost();
        case ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_CMD_PORT:
            return new Integer(getExecutionServerCmdPort());
        case ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_FILE_PORT:
            return new Integer(getExecutionServerFilePort());
        case ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_MONITORING_PORT:
            return new Integer(getExecutionServerMonitoringPort());
        case ConductorPackage.TASK_EXECUTION_HISTORY__APPLY_CONTEXT_TO_CHILDREN:
            return isApplyContextToChildren() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.TASK_EXECUTION_HISTORY__TRIGGERED_BY:
            return getTriggeredBy();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TRIGGER_TYPE:
            return getTriggerType();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TRIGGER_NAME:
            return getTriggerName();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TRIGGER_DESCRIPTION:
            return getTriggerDescription();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TASK_ERROR_STACK_TRACE:
            return getTaskErrorStackTrace();
        case ConductorPackage.TASK_EXECUTION_HISTORY__ID_QUARTZ_JOB:
            return new Integer(getIdQuartzJob());
        case ConductorPackage.TASK_EXECUTION_HISTORY__ID_QUARTZ_TRIGGER:
            return getIdQuartzTrigger();
        case ConductorPackage.TASK_EXECUTION_HISTORY__LAST_JOB_GENERATION_DATE:
            return getLastJobGenerationDate();
        case ConductorPackage.TASK_EXECUTION_HISTORY__JOB_ARCHIVE_FILENAME:
            return getJobArchiveFilename();
        case ConductorPackage.TASK_EXECUTION_HISTORY__FILE_TRIGGER_FILE_MASK:
            return getFileTriggerFileMask();
        case ConductorPackage.TASK_EXECUTION_HISTORY__FILE_TRIGGER_FILE_NAME:
            return getFileTriggerFileName();
        case ConductorPackage.TASK_EXECUTION_HISTORY__FILE_TRIGGER_FOLDER_PATH:
            return getFileTriggerFolderPath();
        case ConductorPackage.TASK_EXECUTION_HISTORY__FILE_TRIGGER_TRIGGERED_FILE_PATH:
            return getFileTriggerTriggeredFilePath();
        case ConductorPackage.TASK_EXECUTION_HISTORY__EXPECTED_TRIGGERING_DATE:
            return getExpectedTriggeringDate();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TASK_START_DATE:
            return getTaskStartDate();
        case ConductorPackage.TASK_EXECUTION_HISTORY__TASK_END_DATE:
            return getTaskEndDate();
        case ConductorPackage.TASK_EXECUTION_HISTORY__SERVER_JOB_START_DATE:
            return getServerJobStartDate();
        case ConductorPackage.TASK_EXECUTION_HISTORY__SERVER_JOB_END_DATE:
            return getServerJobEndDate();
        case ConductorPackage.TASK_EXECUTION_HISTORY__ID_REMOTE_JOB:
            return getIdRemoteJob();
        case ConductorPackage.TASK_EXECUTION_HISTORY__ID_REMOTE_JOB_EXECUTION:
            return getIdRemoteJobExecution();
        case ConductorPackage.TASK_EXECUTION_HISTORY__REQUEST_ID:
            return getRequestId();
        case ConductorPackage.TASK_EXECUTION_HISTORY__RESUMING_MODE:
            return isResumingMode() ? Boolean.TRUE : Boolean.FALSE;
        case ConductorPackage.TASK_EXECUTION_HISTORY__CONTEXT_VALUES:
            return getContextValues();
        case ConductorPackage.TASK_EXECUTION_HISTORY__JVM_VALUES:
            return getJvmValues();
        case ConductorPackage.TASK_EXECUTION_HISTORY__PARENT_TASK_EXEC_ID:
            return new Integer(getParentTaskExecId());
        case ConductorPackage.TASK_EXECUTION_HISTORY__PARENT_PLAN_EXEC_ID:
    ...
    public boolean eIsSet(int featureID) {
        ...
        case ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_HOST:
            return EXECUTION_SERVER_HOST_EDEFAULT == null ? executionServerHost != null : !EXECUTION_SERVER_HOST_EDEFAULT
                    .equals(executionServerHost);
        case ConductorPackage.TASK_EXECUTION_HISTORY__EXECUTION_SERVER_CMD_PORT:
