 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.conductor.impl.SimpleTalendTriggerImpl#getRepeatCount <em>Repeat Count</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.SimpleTalendTriggerImpl#getRepeatInterval <em>Repeat Interval</em>}</li>
 *   <li>{@link org.talend.model.tac.conductor.impl.SimpleTalendTriggerImpl#getTimesTriggered <em>Times Triggered</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleTalendTriggerImpl extends TalendTriggerImpl implements SimpleTalendTrigger {
    ...
    protected EClass eStaticClass() {
        return ConductorPackage.Literals.SIMPLE_TALEND_TRIGGER;
    }
    ...
    public void setRepeatCount(Integer newRepeatCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.SIMPLE_TALEND_TRIGGER__REPEAT_COUNT,
    ...
    public void setRepeatInterval(long newRepeatInterval) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.SIMPLE_TALEND_TRIGGER__REPEAT_INTERVAL,
    ...
    public void setTimesTriggered(int newTimesTriggered) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConductorPackage.SIMPLE_TALEND_TRIGGER__TIMES_TRIGGERED,
                    oldTimesTriggered, timesTriggered));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ConductorPackage.SIMPLE_TALEND_TRIGGER__REPEAT_COUNT:
            return getRepeatCount();
        case ConductorPackage.SIMPLE_TALEND_TRIGGER__REPEAT_INTERVAL:
            return new Long(getRepeatInterval());
        case ConductorPackage.SIMPLE_TALEND_TRIGGER__TIMES_TRIGGERED:
