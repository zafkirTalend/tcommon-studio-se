 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getNameSpace <em>Name Space</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getCreation <em>Creation</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getModification <em>Modification</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getPort <em>Port</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getUsedType <em>Used Type</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getParamStyle <em>Param Style</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getOperations <em>Operations</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaServiceImpl#getStatus <em>Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SoaServiceImpl extends EObjectImpl implements SoaService {
    ...
    protected EClass eStaticClass() {
        return SoaPackage.Literals.SOA_SERVICE;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__ID, oldId, id));
    }
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__LABEL, oldLabel, label));
    }
    ...
    public void setNameSpace(String newNameSpace) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__NAME_SPACE, oldNameSpace, nameSpace));
    }
    ...
    public void setContact(String newContact) {
        ...
        contact = newContact;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__CONTACT, oldContact, contact));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__DESCRIPTION, oldDescription,
                    description));
    }
    ...
    public void setCreation(Date newCreation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__CREATION, oldCreation, creation));
    }
    ...
    public void setModification(Date newModification) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__MODIFICATION, oldModification,
                    modification));
    }
    ...
    public void setPort(int newPort) {
        ...
        port = newPort;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__PORT, oldPort, port));
    }
    ...
    public void setType(String newType) {
        ...
        type = newType;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__TYPE, oldType, type));
    }
    ...
    public void setStyle(String newStyle) {
        ...
        style = newStyle;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__STYLE, oldStyle, style));
    }
    ...
    public void setUsedType(String newUsedType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__USED_TYPE, oldUsedType, usedType));
    }
    ...
    public void setParamStyle(String newParamStyle) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__PARAM_STYLE, oldParamStyle, paramStyle));
    }
    ...
    public EList getOperations() {
        if (operations == null) {
            operations = new EObjectContainmentWithInverseEList(SoaOperation.class, this, SoaPackage.SOA_SERVICE__OPERATIONS,
                    SoaPackage.SOA_OPERATION__SERVICE);
        }
        return operations;
    }
    ...
    public void setStatus(String newStatus) {
        ...
        status = newStatus;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_SERVICE__STATUS, oldStatus, status));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case SoaPackage.SOA_SERVICE__OPERATIONS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SoaPackage.SOA_SERVICE__ID:
            return new Integer(getId());
        case SoaPackage.SOA_SERVICE__LABEL:
            return getLabel();
        case SoaPackage.SOA_SERVICE__NAME_SPACE:
            return getNameSpace();
        case SoaPackage.SOA_SERVICE__CONTACT:
            return getContact();
        case SoaPackage.SOA_SERVICE__DESCRIPTION:
            return getDescription();
        case SoaPackage.SOA_SERVICE__CREATION:
            return getCreation();
        case SoaPackage.SOA_SERVICE__MODIFICATION:
            return getModification();
        case SoaPackage.SOA_SERVICE__PORT:
            return new Integer(getPort());
        case SoaPackage.SOA_SERVICE__TYPE:
            return getType();
        case SoaPackage.SOA_SERVICE__STYLE:
            return getStyle();
        case SoaPackage.SOA_SERVICE__USED_TYPE:
            return getUsedType();
        case SoaPackage.SOA_SERVICE__PARAM_STYLE:
            return getParamStyle();
        case SoaPackage.SOA_SERVICE__OPERATIONS:
            return getOperations();
        case SoaPackage.SOA_SERVICE__STATUS:
            return getStatus();
        }
