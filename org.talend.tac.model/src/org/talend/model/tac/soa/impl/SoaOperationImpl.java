 ...
 * <ul>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getProject <em>Project</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getContext <em>Context</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getJobVersion <em>Job Version</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getJobName <em>Job Name</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#isActive <em>Active</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getLastScriptGenerationDate <em>Last Script Generation Date</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getJobId <em>Job Id</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#isApplyContextToChildren <em>Apply Context To Children</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getInputParameters <em>Input Parameters</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getJvmParameters <em>Jvm Parameters</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getXms <em>Xms</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getXmx <em>Xmx</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getMinJobInstances <em>Min Job Instances</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getMaxJobInstances <em>Max Job Instances</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getIdleTTL_forAllInstances <em>Idle TTL for All Instances</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getIdleTTL_forAdditionalInstances <em>Idle TTL for Additional Instances</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getQueueMaxSize <em>Queue Max Size</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getRequestInQueueTTL <em>Request In Queue TTL</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getService <em>Service</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getReturnStyle <em>Return Style</em>}</li>
 *   <li>{@link org.talend.model.tac.soa.impl.SoaOperationImpl#getBranch <em>Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SoaOperationImpl extends EObjectImpl implements SoaOperation {
    ...
    protected EClass eStaticClass() {
        return SoaPackage.Literals.SOA_OPERATION;
    }
    ...
    public void setId(int newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__ID, oldId, id));
    }
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__LABEL, oldLabel, label));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__DESCRIPTION, oldDescription,
                    description));
    }
    ...
    public Project getProject() {
        if (project != null && project.eIsProxy()) {
            ...
            if (project != oldProject) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SoaPackage.SOA_OPERATION__PROJECT, oldProject,
                            project));
            }
        }
        return project;
    ...
    public void setProject(Project newProject) {
        ...
        project = newProject;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__PROJECT, oldProject, project));
    }
    ...
    public void setContext(String newContext) {
        ...
        context = newContext;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__CONTEXT, oldContext, context));
    }
    ...
    public void setJobVersion(String newJobVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__JOB_VERSION, oldJobVersion,
                    jobVersion));
    }
    ...
    public void setJobName(String newJobName) {
        ...
        jobName = newJobName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__JOB_NAME, oldJobName, jobName));
    }
    ...
    public void setActive(boolean newActive) {
        ...
        active = newActive;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__ACTIVE, oldActive, active));
    }
    ...
    public void setLastScriptGenerationDate(Date newLastScriptGenerationDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__LAST_SCRIPT_GENERATION_DATE,
    ...
    public void setJobId(String newJobId) {
        ...
        jobId = newJobId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__JOB_ID, oldJobId, jobId));
    }
    ...
    public void setApplyContextToChildren(boolean newApplyContextToChildren) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__APPLY_CONTEXT_TO_CHILDREN,
    ...
    public EList getInputParameters() {
        if (inputParameters == null) {
            inputParameters = new EObjectContainmentEList(SoaInputParameter.class, this,
                    SoaPackage.SOA_OPERATION__INPUT_PARAMETERS);
        }
    ...
    public void setJvmParameters(String newJvmParameters) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__JVM_PARAMETERS, oldJvmParameters,
                    jvmParameters));
    }
    ...
    public void setXms(int newXms) {
        ...
        xms = newXms;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__XMS, oldXms, xms));
    }
    ...
    public void setXmx(int newXmx) {
        ...
        xmx = newXmx;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__XMX, oldXmx, xmx));
    }
    ...
    public void setMinJobInstances(int newMinJobInstances) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__MIN_JOB_INSTANCES,
                    oldMinJobInstances, minJobInstances));
    }
    ...
    public void setMaxJobInstances(int newMaxJobInstances) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__MAX_JOB_INSTANCES,
                    oldMaxJobInstances, maxJobInstances));
    }
    ...
    public void setIdleTTL_forAllInstances(int newIdleTTL_forAllInstances) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__IDLE_TTL_FOR_ALL_INSTANCES,
                    oldIdleTTL_forAllInstances, idleTTL_forAllInstances));
    }
    ...
    public void setIdleTTL_forAdditionalInstances(int newIdleTTL_forAdditionalInstances) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__IDLE_TTL_FOR_ADDITIONAL_INSTANCES,
                    oldIdleTTL_forAdditionalInstances, idleTTL_forAdditionalInstances));
    }
    ...
    public void setQueueMaxSize(int newQueueMaxSize) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__QUEUE_MAX_SIZE, oldQueueMaxSize,
                    queueMaxSize));
    }
    ...
    public void setRequestInQueueTTL(int newRequestInQueueTTL) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__REQUEST_IN_QUEUE_TTL,
                    oldRequestInQueueTTL, requestInQueueTTL));
    }
    ...
    public SoaService getService() {
        if (eContainerFeatureID() != SoaPackage.SOA_OPERATION__SERVICE)
            return null;
    ...
    public NotificationChain basicSetService(SoaService newService, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newService, SoaPackage.SOA_OPERATION__SERVICE, msgs);
        return msgs;
    }
    ...
    public void setService(SoaService newService) {
        if (newService != eInternalContainer()
                || (eContainerFeatureID() != SoaPackage.SOA_OPERATION__SERVICE && newService != null)) {
            ...
            if (newService != null)
                msgs = ((InternalEObject) newService).eInverseAdd(this, SoaPackage.SOA_SERVICE__OPERATIONS, SoaService.class,
                        msgs);
            msgs = basicSetService(newService, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__SERVICE, newService, newService));
    }
    ...
    public void setReturnStyle(String newReturnStyle) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__RETURN_STYLE, oldReturnStyle,
                    returnStyle));
    }
    ...
    public void setBranch(String newBranch) {
        ...
        branch = newBranch;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoaPackage.SOA_OPERATION__BRANCH, oldBranch, branch));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case SoaPackage.SOA_OPERATION__SERVICE:
            if (eInternalContainer() != null)
                msgs = eBasicRemoveFromContainer(msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case SoaPackage.SOA_OPERATION__INPUT_PARAMETERS:
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case SoaPackage.SOA_OPERATION__SERVICE:
            return eInternalContainer().eInverseRemove(this, SoaPackage.SOA_SERVICE__OPERATIONS, SoaService.class, msgs);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SoaPackage.SOA_OPERATION__ID:
            return new Integer(getId());
        case SoaPackage.SOA_OPERATION__LABEL:
            return getLabel();
        case SoaPackage.SOA_OPERATION__DESCRIPTION:
            return getDescription();
        case SoaPackage.SOA_OPERATION__PROJECT:
            if (resolve)
                return getProject();
            return basicGetProject();
        case SoaPackage.SOA_OPERATION__CONTEXT:
            return getContext();
        case SoaPackage.SOA_OPERATION__JOB_VERSION:
            return getJobVersion();
        case SoaPackage.SOA_OPERATION__JOB_NAME:
            return getJobName();
        case SoaPackage.SOA_OPERATION__ACTIVE:
            return isActive() ? Boolean.TRUE : Boolean.FALSE;
        case SoaPackage.SOA_OPERATION__LAST_SCRIPT_GENERATION_DATE:
            return getLastScriptGenerationDate();
        case SoaPackage.SOA_OPERATION__JOB_ID:
            return getJobId();
        case SoaPackage.SOA_OPERATION__APPLY_CONTEXT_TO_CHILDREN:
            return isApplyContextToChildren() ? Boolean.TRUE : Boolean.FALSE;
        case SoaPackage.SOA_OPERATION__INPUT_PARAMETERS:
            return getInputParameters();
        case SoaPackage.SOA_OPERATION__JVM_PARAMETERS:
            return getJvmParameters();
        case SoaPackage.SOA_OPERATION__XMS:
            return new Integer(getXms());
        case SoaPackage.SOA_OPERATION__XMX:
            return new Integer(getXmx());
        case SoaPackage.SOA_OPERATION__MIN_JOB_INSTANCES:
            return new Integer(getMinJobInstances());
        case SoaPackage.SOA_OPERATION__MAX_JOB_INSTANCES:
            return new Integer(getMaxJobInstances());
        case SoaPackage.SOA_OPERATION__IDLE_TTL_FOR_ALL_INSTANCES:
            return new Integer(getIdleTTL_forAllInstances());
        case SoaPackage.SOA_OPERATION__IDLE_TTL_FOR_ADDITIONAL_INSTANCES:
            return new Integer(getIdleTTL_forAdditionalInstances());
        case SoaPackage.SOA_OPERATION__QUEUE_MAX_SIZE:
            return new Integer(getQueueMaxSize());
        case SoaPackage.SOA_OPERATION__REQUEST_IN_QUEUE_TTL:
            return new Integer(getRequestInQueueTTL());
        case SoaPackage.SOA_OPERATION__SERVICE:
            return getService();
        case SoaPackage.SOA_OPERATION__RETURN_STYLE:
            return getReturnStyle();
        case SoaPackage.SOA_OPERATION__BRANCH:
            return getBranch();
        }
