...
public class SoaAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected SoaSwitch modelSwitch = new SoaSwitch() {
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.model.tac.soa.SoaOperation <em>Operation</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.model.tac.soa.SoaInputParameter <em>Input Parameter</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.model.tac.soa.SoaService <em>Service</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
