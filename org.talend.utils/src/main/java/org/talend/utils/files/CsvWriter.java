...
public class CsvWriter {
    ...
    public void setLineFieldLimited(int fieldsNumber) {
        userSettings.lineFieldLimited = fieldsNumber;
    }

    public int getLineFieldLimited() {
        return userSettings.lineFieldLimited;
    }
    ...
    public void write(String content, boolean preserveSpaces) throws IOException {
        ...
        if (!firstColumn && count % userSettings.lineFieldLimited != 0) {
        ...
        if (userSettings.lineFieldLimited != Integer.MAX_VALUE && count % userSettings.lineFieldLimited == 0) {
    ...
    /**
     * DOC zqin CsvWriter class global comment. Detailled comment
     */
    ...
    private class UserSettings {
        ...
        public UserSettings() {
            ...
            lineFieldLimited = Integer.MAX_VALUE;
        }
    }
