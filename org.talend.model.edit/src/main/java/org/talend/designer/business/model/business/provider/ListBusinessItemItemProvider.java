...
public class ListBusinessItemItemProvider extends BusinessItemShapeItemProvider implements IEditingDomainItemProvider,
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ListBusinessItem"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ?
            getString("_UI_ListBusinessItem_type") :
            getString("_UI_ListBusinessItem_type") + " " + label;
    }
