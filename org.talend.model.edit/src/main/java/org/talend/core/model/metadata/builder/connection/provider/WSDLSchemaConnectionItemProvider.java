...
public class WSDLSchemaConnectionItemProvider extends ConnectionItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addWSDLPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_WSDL_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_WSDLSchemaConnection_WSDL_feature", "_UI_WSDLSchemaConnection_type"),
                ConnectionPackage.Literals.WSDL_SCHEMA_CONNECTION__WSDL, true, false, false,
    ...
    protected void addNeedAuthPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_needAuth_feature"),
    ...
    protected void addMethodNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_methodName_feature"),
    ...
    protected void addParametersPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_parameters_feature"),
    ...
    protected void addUserNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_UserName_feature"),
    ...
    protected void addPasswordPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_Password_feature"),
    ...
    protected void addUseProxyPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_useProxy_feature"),
    ...
    protected void addProxyHostPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_proxyHost_feature"),
    ...
    protected void addProxyPortPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_proxyPort_feature"),
    ...
    protected void addProxyUserPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_proxyUser_feature"),
    ...
    protected void addProxyPasswordPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_proxyPassword_feature"),
    ...
    protected void addValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_Value_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_WSDLSchemaConnection_Value_feature", "_UI_WSDLSchemaConnection_type"),
                ConnectionPackage.Literals.WSDL_SCHEMA_CONNECTION__VALUE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addEndpointURIPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_EndpointURI_feature"),
    ...
    protected void addEncodingPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_Encoding_feature"),
    ...
    protected void addTimeOutPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_WSDLSchemaConnection_timeOut_feature"),
