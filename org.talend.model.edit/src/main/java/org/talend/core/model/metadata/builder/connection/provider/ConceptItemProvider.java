...
public class ConceptItemProvider extends TdTableItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addLoopExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Concept_LoopExpression_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Concept_LoopExpression_feature", "_UI_Concept_type"),
    ...
    protected void addLoopLimitPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Concept_LoopLimit_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Concept_LoopLimit_feature", "_UI_Concept_type"),
