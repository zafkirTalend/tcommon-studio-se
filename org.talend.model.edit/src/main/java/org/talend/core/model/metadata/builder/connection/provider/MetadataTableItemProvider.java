...
public class MetadataTableItemProvider extends AbstractMetadataObjectItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addIsAbstractPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_isAbstract_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_isAbstract_feature", "_UI_Classifier_type"),
    ...
    protected void addStructuralFeaturePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_structuralFeature_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_structuralFeature_feature", "_UI_Classifier_type"),
                CorePackage.Literals.CLASSIFIER__STRUCTURAL_FEATURE, true, false, true, null, null, null));
    }
    ...
    protected void addParameterPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_parameter_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_parameter_feature", "_UI_Classifier_type"),
    ...
    protected void addGeneralizationPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_generalization_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_generalization_feature", "_UI_Classifier_type"),
    ...
    protected void addSpecializationPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_specialization_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_specialization_feature", "_UI_Classifier_type"),
    ...
    protected void addInstancePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_instance_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_instance_feature", "_UI_Classifier_type"),
    ...
    protected void addAliasPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_alias_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_alias_feature", "_UI_Classifier_type"),
    ...
    protected void addExpressionNodePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_expressionNode_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_expressionNode_feature", "_UI_Classifier_type"),
    ...
    protected void addMappingFromPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_mappingFrom_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_mappingFrom_feature", "_UI_Classifier_type"),
    ...
    protected void addMappingToPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_mappingTo_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_mappingTo_feature", "_UI_Classifier_type"),
    ...
    protected void addClassifierMapPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_classifierMap_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_classifierMap_feature", "_UI_Classifier_type"),
    ...
    protected void addCfMapPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_cfMap_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_cfMap_feature", "_UI_Classifier_type"),
    ...
    protected void addDomainPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_domain_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_domain_feature", "_UI_Classifier_type"),
    ...
    protected void addSimpleDimensionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Classifier_simpleDimension_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Classifier_simpleDimension_feature", "_UI_Classifier_type"),
    ...
    protected void addIndexPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Class_index_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_Class_index_feature", "_UI_Class_type"),
    ...
    protected void addSourceNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_MetadataTable_sourceName_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_MetadataTable_sourceName_feature", "_UI_MetadataTable_type"),
                ConnectionPackage.Literals.METADATA_TABLE__SOURCE_NAME, true, false, false,
    ...
    protected void addTableTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_MetadataTable_tableType_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_MetadataTable_tableType_feature", "_UI_MetadataTable_type"),
    ...
    protected void addAttachedCDCPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_MetadataTable_attachedCDC_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_MetadataTable_attachedCDC_feature", "_UI_MetadataTable_type"),
                ConnectionPackage.Literals.METADATA_TABLE__ATTACHED_CDC, true, false, false,
    ...
    protected void addActivatedCDCPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_MetadataTable_activatedCDC_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_MetadataTable_activatedCDC_feature", "_UI_MetadataTable_type"),
                ConnectionPackage.Literals.METADATA_TABLE__ACTIVATED_CDC, true, false, false,
                ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, BehavioralFactory.eINSTANCE
                .createArgument()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, InstanceFactory.eINSTANCE
                .createSlot()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DatatypesFactory.eINSTANCE
                .createEnumeration()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, KeysindexesFactory.eINSTANCE
                .createUniqueKey()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, KeysindexesFactory.eINSTANCE
                .createKeyRelationship()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, KeysindexesFactory.eINSTANCE
                .createIndexedFeature()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, TypemappingFactory.eINSTANCE
                .createTypeMapping()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, RecordFactory.eINSTANCE
                .createField()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, OlapFactory.eINSTANCE
                .createContentMap()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, OlapFactory.eINSTANCE
                .createCubeDimensionAssociation()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, OlapFactory.eINSTANCE
                .createDimensionDeployment()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, OlapFactory.eINSTANCE
                .createHierarchyLevelAssociation()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, OlapFactory.eINSTANCE
                .createLevelBasedHierarchy()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, OlapFactory.eINSTANCE
                .createMemberSelectionGroup()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createApplicationInputSpecification()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createAttributeUsageRelation()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createMiningAttribute()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createMiningDataSpecification()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createMiningModel()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createMiningModelResult()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createNumericAttribute()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createSupervisedMiningModel()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createCategoricalAttribute()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createOrdinalAttribute()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createMiningSettings()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createClusteringSettings()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createStatisticsSettings()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createSupervisedMiningSettings()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createClassificationSettings()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createRegressionSettings()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DataminingFactory.eINSTANCE
                .createAssociationRulesSettings()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, EventsFactory.eINSTANCE
                .createPointInTimeEvent()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, EventsFactory.eINSTANCE
                .createRecurringPointInTimeEvent()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, ErFactory.eINSTANCE
                .createEntity()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, CoboldataFactory.eINSTANCE
                .createCOBOLFD()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DmsiiFactory.eINSTANCE
                .createDatabase()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DmsiiFactory.eINSTANCE
                .createPhysicalDataSetOverride()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DmsiiFactory.eINSTANCE
                .createPhysicalSetOverride()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DmsiiFactory.eINSTANCE
                .createPhysicalAccessOverride()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, DmsiiFactory.eINSTANCE
                .createDASDLProperty()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, ImsdatabaseFactory.eINSTANCE
                .createDBD()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, ImsdatabaseFactory.eINSTANCE
                .createSegmentComplex()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, ImsdatabaseFactory.eINSTANCE
                .createSegmentLogical()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, EssbaseFactory.eINSTANCE
                .createAlias()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, EssbaseFactory.eINSTANCE
                .createReplicatedPartition()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, EssbaseFactory.eINSTANCE
                .createTimeBalance()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, EssbaseFactory.eINSTANCE
                .createTransparentPartition()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, EssbaseFactory.eINSTANCE
                .createTwoPassCalculation()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, EssbaseFactory.eINSTANCE
                .createUDA()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, EssbaseFactory.eINSTANCE
                .createVarianceReporting()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, EssbaseFactory.eINSTANCE
                .createLinkedPartition()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, ExpressFactory.eINSTANCE
                .createDatabase()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, ExpressFactory.eINSTANCE
                .createSimpleDimension()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, ExpressFactory.eINSTANCE
                .createAliasDimension()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, ExpressFactory.eINSTANCE
                .createAggMap()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, ExpressFactory.eINSTANCE
                .createAggMapComponent()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.NAMESPACE__OWNED_ELEMENT, CwmmipFactory.eINSTANCE
                .createUnitOfInterchange()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, CoreFactory.eINSTANCE
                .createAttribute()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, BehavioralFactory.eINSTANCE
                .createMethod()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, BehavioralFactory.eINSTANCE
                .createOperation()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, RelationshipsFactory.eINSTANCE
                .createAssociationEnd()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, DatatypesFactory.eINSTANCE
                .createUnionMember()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, RecordFactory.eINSTANCE
                .createField()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, RecordFactory.eINSTANCE
                .createFixedOffsetField()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, MultidimensionalFactory.eINSTANCE
                .createDimensionedObject()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, OlapFactory.eINSTANCE
                .createMeasure()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, DataminingFactory.eINSTANCE
                .createMiningAttribute()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, ErFactory.eINSTANCE
                .createAttribute()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, ErFactory.eINSTANCE
                .createRelationshipEnd()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, CoboldataFactory.eINSTANCE
                .createCOBOLField()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, CoboldataFactory.eINSTANCE
                .createRenames()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, DmsiiFactory.eINSTANCE
                .createDatabase()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, ImsdatabaseFactory.eINSTANCE
                .createField()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, ImsdatabaseFactory.eINSTANCE
                .createSenField()));

        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, EssbaseFactory.eINSTANCE
                .createAlias()));
        ...
        newChildDescriptors.add(createChildParameter(CorePackage.Literals.CLASSIFIER__FEATURE, ExpressFactory.eINSTANCE
                .createVariable()));
