...
public class SubscriberTableItemProvider extends TdTableItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addSystemPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_SubscriberTable_system_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_SubscriberTable_system_feature", "_UI_SubscriberTable_type"),
                ConnectionPackage.Literals.SUBSCRIBER_TABLE__SYSTEM, true, false, false,
