 ...
 * @generated
 */
public class TdXMLDocumentItemProvider extends DocumentItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addXsdFilePathPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_TdXMLDocument_xsdFilePath_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_TdXMLDocument_xsdFilePath_feature", "_UI_TdXMLDocument_type"),
                XmlPackage.Literals.TD_XML_DOCUMENT__XSD_FILE_PATH, true, false, false,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_TdXMLDocument_type") : getString("_UI_TdXMLDocument_type")
                + " " + label;
    }
