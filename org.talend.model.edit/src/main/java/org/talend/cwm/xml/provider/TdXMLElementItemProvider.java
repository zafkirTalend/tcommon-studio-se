 ...
 * @generated
 */
public class TdXMLElementItemProvider extends ElementItemProvider implements IEditingDomainItemProvider,
    ...
    protected void addXsdElementDeclarationPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_TdXMLElement_xsdElementDeclaration_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_TdXMLElement_xsdElementDeclaration_feature",
                        "_UI_TdXMLElement_type"), XmlPackage.Literals.TD_XML_ELEMENT__XSD_ELEMENT_DECLARATION, true, false, true,
                null, null, null));
    }
    ...
    protected void addOwnedDocumentPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_TdXMLElement_ownedDocument_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_TdXMLElement_ownedDocument_feature", "_UI_TdXMLElement_type"),
                XmlPackage.Literals.TD_XML_ELEMENT__OWNED_DOCUMENT, true, false, true, null, null, null));
    }
    ...
    protected void addJavaTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                .getRootAdapterFactory(), getResourceLocator(), getString("_UI_TdXMLElement_javaType_feature"), getString(
                "_UI_PropertyDescriptor_description", "_UI_TdXMLElement_javaType_feature", "_UI_TdXMLElement_type"),
                XmlPackage.Literals.TD_XML_ELEMENT__JAVA_TYPE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_TdXMLElement_type") : getString("_UI_TdXMLElement_type")
                + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(XmlPackage.Literals.TD_XML_ELEMENT__XML_CONTENT, XmlFactory.eINSTANCE
                .createTdXMLContent()));
    }
