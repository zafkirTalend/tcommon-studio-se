...
public enum EDatabaseVersion4Drivers {
    ...
    HIVE(new DbVersion4Drivers(EDatabaseTypeName.HIVE, "STANDALONE", "STANDALONE", new String[] { "hive-jdbc-0.8.1-cdh4.0.0.jar",
            "hive-metastore-0.8.1-cdh4.0.0.jar", "hive-exec-0.8.1-cdh4.0.0.jar", "hive-service-0.8.1-cdh4.0.0.jar",
    ...
    HIVE_EMBEDDED(new DbVersion4Drivers(EDatabaseTypeName.HIVE, "EMBEDDED", "EMBEDDED", new String[] { "antlr-runtime-3.0.1.jar",
            ...
            "hadoop-common-2.0.0-cdh4.0.1.jar", "hadoop-core-2.0.0-mr1-cdh4.0.1.jar", "hive-builtins-0.8.1-cdh4.0.0.jar",
            "hive-exec-0.8.1-cdh4.0.0.jar", "hive-jdbc-0.8.1-cdh4.0.0.jar", "hive-metastore-0.8.1-cdh4.0.0.jar",
            "hive-service-0.8.1-cdh4.0.0.jar", "jdo2-api-2.3-ec.jar", "libfb303-0.7.0.jar", "libthrift-0.7.0.jar",
