...
public enum EDatabaseVersion4Drivers {
    ...
    HIVE(new DbVersion4Drivers(EDatabaseTypeName.HIVE, "STANDALONE", "STANDALONE", new String[] { "hive-jdbc-0.8.1.jar", "hive-metastore-0.8.1.jar",
            "hive-exec-0.8.1.jar", "hive-service-0.8.1.jar", "libfb303_new.jar", "hadoop-core-1.0.0.jar",
    ...
    HIVE_EMBEDDED(new DbVersion4Drivers(EDatabaseTypeName.HIVE, "EMBEDDED", "EMBEDDED", new String[] { "antlr-runtime-3.0.1.jar",
            "commons-configuration-1.6.jar", "commons-dbcp-1.4.jar", "commons-lang-2.4.jar", "commons-logging-1.1.1.jar",
            "commons-pool-1.5.4.jar", "datanucleus-connectionpool-2.0.3.jar", "datanucleus-core-2.0.3.jar",
            "datanucleus-enhancer-2.0.3.jar", "datanucleus-rdbms-2.0.3.jar", "derby-10.4.2.0.jar", "guava-11.0.2.jar",
            "hadoop-auth-2.0.0-cdh4.0.1.jar", "hadoop-common-2.0.0-cdh4.0.1.jar", "hadoop-core-2.0.0-mr1-cdh4.0.1.jar",
            "hive-builtins-0.8.1-cdh4.0.1.jar", "hive-exec-0.8.1-cdh4.0.1.jar", "hive-jdbc-0.8.1-cdh4.0.1.jar",
            "hive-metastore-0.8.1-cdh4.0.1.jar", "hive-service-0.8.1-cdh4.0.1.jar", "jdo2-api-2.3-ec.jar", "libfb303.jar",
