...
public class GroupByNothingProvider extends ContextProviderProxy {
    ...
    public String getColumnText(Object element, int columnIndex) {
        ...
        // .getContextParameter(((ContextParameterParent) element).getParameter().getName()).getName();
        // } else {
        // break;
        // }
        // } else {
        ...
        // .getContextParameter(((ContextParameterParent) element).getParameter().getName()).getSource();
        ...
        // .getContextParameter(((ContextParameterParent) element).getParameter().getName()).getType();
        ...
        // ((ContextParameterParent) element).getParameter().getName()) != null) {
        // return getContextManager().getDefaultContext()
        // .getContextParameter(((ContextParameterParent) element).getParameter().getName()).getComment();
        // } else {
        // break;
        // }
        // } else {
