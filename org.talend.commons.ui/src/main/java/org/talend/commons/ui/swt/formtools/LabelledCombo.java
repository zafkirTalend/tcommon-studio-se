...
public class LabelledCombo {
	 ...
	 * @return Combo
	 */
	public LabelledCombo(Composite parent, String labelStr, String tip,
			List<String> item) {
		String[] items = null;
		...
		createLabelledCombo(parent, labelStr, tip, items, 1, false,
				DEFAULT_COMBO_STYLE, DEFAULT_LABEL_STYLE);
	}

	public LabelledCombo(Composite parent, String labelStr, String tip,
			List<String> item, boolean isFill) {
		String[] items = null;
		if (item != null && !item.isEmpty()) {
			items = new String[item.size()];
			Iterator<String> iterate = item.iterator();
		...
		createLabelledCombo(parent, labelStr, tip, items, 1, isFill,
				DEFAULT_COMBO_STYLE, DEFAULT_LABEL_STYLE);
	}
	 ...
	 * @return Combo
	 */
	public LabelledCombo(final Composite parent, final String labelStr,
			final String tip, final String[] item, int horizontalSpan,
			boolean isFill) {
		createLabelledCombo(parent, labelStr, tip, item, horizontalSpan,
				isFill, DEFAULT_COMBO_STYLE, DEFAULT_LABEL_STYLE);
	}
	 ...
	 */
	public LabelledCombo(Composite parent, String labelStr, String tip,
			String[] item, int horizontalSpan) {
		createLabelledCombo(parent, labelStr, tip, item, horizontalSpan, false,
				DEFAULT_COMBO_STYLE, DEFAULT_LABEL_STYLE);
	}
	...
	public LabelledCombo(Composite parent, String labelStr, String tip,
			String[] item) {
		createLabelledCombo(parent, labelStr, tip, item, 1, false,
				DEFAULT_COMBO_STYLE, DEFAULT_LABEL_STYLE);
	}
	 ...
	 */
	public LabelledCombo(final Composite parent, final String labelStr,
			final String tip, final String[] item, final int horizontalSpan,
			final boolean isFill, final int comboStyle) {
		createLabelledCombo(parent, labelStr, tip, item, horizontalSpan,
				isFill, comboStyle, SWT.LEFT);
	}
	 ...
	 * @param labelStyle
	 */
	private void createLabelledCombo(final Composite parent,
			final String labelStr, final String tip, final String[] item,
			final int horizontalSpan, final boolean isFill,
			final int comboStyle, final int labelStyle) {
