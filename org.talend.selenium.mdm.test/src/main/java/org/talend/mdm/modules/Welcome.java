...
public class Welcome extends Base{
	...
	public void checkGetStartedWindow(){
		...
		logger.warn("check welcome page UI getting started window ok");
		...
		logger.warn("check welcome page UI getting started window.label ok.");
		...
		logger.warn("check welcome page UI getting started window.item.databrowser ok.");
		...
		logger.warn("check welcome page UI getting started window.item.journal ok.");
	}
	...
	public void checkProcessWindow(){
		...
		logger.warn("check welcome page UI processes window ok");
		...
		logger.warn("check welcome page UI processes window.title ok.");
	}
	...
	public void checkAlertsWindow(){
		...
		logger.warn("check welcome page UI alerts window.title ok.");
	}
	...
	public void checkTasksWindow(){
		...
		logger.warn("check welcome page UI tasks window.title ok.");
	}
	...
	public void checkSearchWindow(){
		...
		logger.warn("check welcome page UI search window.title ok.");
		...
		logger.warn("check welcome page UI search window.item.search.button ok.");
	}
