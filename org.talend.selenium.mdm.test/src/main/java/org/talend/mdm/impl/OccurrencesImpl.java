...
//		this.doubleClick(this.findElementDefineDriver(this.driver, By.xpath(locator.getString("xpath.occurrences.url.openeditpanel.img"))));
	   ...
	   this.sleepCertainTime(5000);
	    ...
	    this.seletDropDownList(By.xpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[19]//img[contains(@class,'x-form-trigger x-form-trigger-arrow')]"), enu2);
	    ...
	    Assert.assertEquals(this.getValueInput(By.xpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[23]//input[@name='Occurrences/father2']")), fater2Type);
		this.clickElementByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[23]/table/tbody/tr/td[1]//img");
		this.typeTextByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[23]//input[@name='Occurrences/father2/Name']", father2Name);
		this.typeTextByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[23]//input[@name='Occurrences/father2/Address']", father2Add);
	    
		Assert.assertEquals(this.getValueInput(By.xpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[24]//input[@name='Occurrences/father2']")), fater2Type);
		this.clickElementByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[24]/table/tbody/tr/td[1]//img");
		this.typeTextByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[24]//input[@name='Occurrences/father2/Name']", father2Name);
		this.typeTextByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[24]//input[@name='Occurrences/father2/Address']", father2Add);
		
		//fill son2 just create
		this.clickElementByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[26]/table/tbody/tr/td[1]//img");
		this.sleepCertainTime(3000);
		this.typeTextByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[26]//input[@name='Occurrences/son2/Name']", son2Name);
		this.typeTextByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[26]//input[@name='Occurrences/son2/Address']", son2Add);
		this.typeTextByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[26]//input[@name='Occurrences/son2/School']", son2School);
		 
		
		this.clickElementByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[27]/table/tbody/tr/td[1]//img");
		this.sleepCertainTime(3000);
		this.typeTextByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[27]//input[@name='Occurrences/son2/Name']", son2Name);
		this.typeTextByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[27]//input[@name='Occurrences/son2/Address']", son2Add);
		this.typeTextByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[27]//input[@name='Occurrences/son2/School']", son2School);
		...
		Assert.assertEquals(this.getValueInput(By.xpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[19]//input")), enu2);
			
		//verify father2 just created
		this.clickElementByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[24]/table/tbody/tr/td[1]//img");
		Assert.assertEquals(this.getValueInput(By.xpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[24]//input[@name='Occurrences/father2/Name']")), father2Name);
		Assert.assertEquals(this.getValueInput(By.xpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[24]//input[@name='Occurrences/father2/Address']")), father2Add);
		
		//verify son2 just created
		this.clickElementByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[27]/table/tbody/tr/td[1]//img");
		this.sleepCertainTime(3000);
		Assert.assertEquals(this.getValueInput(By.xpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[27]//input[@name='Occurrences/son2/Name']")), son2Name);
		Assert.assertEquals(this.getValueInput(By.xpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[27]//input[@name='Occurrences/son2/Address']")), son2Add);
		Assert.assertEquals(this.getValueInput(By.xpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[27]//input[@name='Occurrences/son2/School']")), son2School);
...
//		this.doubleClick(this.findElementDefineDriver(this.driver, By.xpath(locator.getString("xpath.occurrences.url.openeditpanel.img"))));
	...
	public void updateOccurrencesRecordImpl(String container,String modle,String entity,String id,Boolean booLean,Boolean booLean2,String string,String string2,int integer,int integer2,double dou,double dou2,String dataTime,String dataTime2,String urlName,String urlValue,String url2Name,String url2Value,String enu,String enu2,String faterType,String fatherName,String fatherAdd,String fater2Type,String father2Name,String father2Add,String sonName,String sonAdd,String sonSchool,String son2Name,String son2Add,String son2School){
	    ...
	    this.clickElementByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[19]//img[@id='Remove']");
	  ...
	  //remove an occurrence of father2
	    Assert.assertTrue(this.getElementsByXpath("//input[@name='Occurrences/father2']").size()==2);
	    this.clickElementByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[23]//input[@name='Occurrences/father2']//ancestor::tr[1]//img[contains(@id,'Remove')]");
	    Assert.assertTrue(this.waitfor(By.xpath("//span[contains(text(),'Do you really want to delete the selected record?')]"), WAIT_TIME_MIN).isDisplayed());	   
	    this.clickElementByXpath("//span[contains(text(),'Confirmation')]//ancestor::div[contains(@class,'x-window-plain x-window-dlg x-window x-component')]//button[contains(text(),'Yes')]");
	    this.sleepCertainTime(3000);
	    Assert.assertTrue(this.getElementsByXpath("//input[@name='Occurrences/father2']").size()==1);
	  ...
	  //remove an occurrence of son2
	    Assert.assertTrue(this.getElementsByXpath("//div[text()='son2']").size()==2);
	    this.clickElementByXpath("//div[contains(@id,'TreeDetail-tree')]/div[2]/div/div[25]//div[contains(text(),'son2')]//ancestor::tr[1]//img[contains(@id,'Remove')]");
	    Assert.assertTrue(this.waitfor(By.xpath("//span[contains(text(),'Do you really want to delete the selected record?')]"), WAIT_TIME_MIN).isDisplayed());	   
	    this.clickElementByXpath("//span[contains(text(),'Confirmation')]//ancestor::div[contains(@class,'x-window-plain x-window-dlg x-window x-component')]//button[contains(text(),'Yes')]");
	    this.sleepCertainTime(3000);
	    Assert.assertTrue(this.getElementsByXpath("//div[text()='son2']").size()==1);
