...
public class CreateSybaseConnectionTest extends TalendSwtbotForTdq {

	@Test
	public void createSybaseConnection() {
		...
		SWTBotTreeItem sybase = tree.expandNode("Metadata", "DB connections")
				.select(TalendMetadataTypeEnum.SYBASE.toString());
		Assert.assertNotNull(sybase);
