...
public class CatalogAnalysisCheatSheetTest extends TalendSwtbotForTdq{
	...
	@Test
	public void CatalogAnalysisCheatSheet(){
		...
		tree.expandNode("Talend - Cheat Sheets").getNode(0).expand().getNode(1).select();
		bot.button("OK").click();
