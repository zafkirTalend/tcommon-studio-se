...
public class TimeColumnCorrelationAnalysisCheatSheetTest extends TalendSwtbotForTdq{
	...
	@Test
	public void TimeColumnCorrelationAnalysisCheatSheet(){
		...
		tree.expandNode("Talend - Cheat Sheets").getNode(0).expand().getNode(10).select();
		bot.button("OK").click();
		...
		bot.textWithLabel("Name").setText(TalendAnalysisTypeEnum.TIME_CORRELATION.toString());
...
//		TalendSwtbotTdqCommon.deleteSource(bot, TalendItemTypeEnum.ANALYSIS, TalendAnalysisTypeEnum.TIME_CORRELATION.toString());
