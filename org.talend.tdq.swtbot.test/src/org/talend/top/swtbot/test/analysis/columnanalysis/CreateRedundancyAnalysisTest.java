...
public class CreateRedundancyAnalysisTest extends TalendSwtbotForTdq {
	...
	@Test
	public void createRedundancyAnalysis() {
		...
		SWTBotTreeItem analysisItem = tree.expandNode("Data Profiling")
				.getNode(0).expand()
				.select(TalendAnalysisTypeEnum.REDUNDANCY.toString() + " 0.1");
