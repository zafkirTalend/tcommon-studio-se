...
public class ChecksWithSetTwoThresholdsTest extends TalendSwtbotForTdq{
	...
	@Test
	public void checksWithSetTwoThresholds(){
	...
	bot.sleep(2000);
	bot.captureScreenshot(System.getProperty("tdq.analysis.result.screenshot.path")+ "dqrule_threshold.jpeg");		
