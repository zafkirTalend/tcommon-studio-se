...
public class CreateConnectionAnalysisTest extends TalendSwtbotForTdq {
	...
	@Test
	public void createConnectionAnalysis() {
		TalendSwtbotTdqCommon.createAnalysis(bot,
				TalendAnalysisTypeEnum.CONNECTION, TalendMetadataTypeEnum.MYSQL);
...
//				.select(TalendAnalysisTypeEnum.CONNECTION.toString());
