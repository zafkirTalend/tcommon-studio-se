...
public class CreateNumericalCorrelationAnalysisTest extends TalendSwtbotForTdq {
	...
	@Test
	public void createNumericalCorrelationAnalysis() {
		...
		SWTBotTreeItem analysisItem = tree
				...
				.getNode(0)
				.expand()
				.select(TalendAnalysisTypeEnum.NUMERICAL_CORRELATION.toString()
						+ " 0.1");
