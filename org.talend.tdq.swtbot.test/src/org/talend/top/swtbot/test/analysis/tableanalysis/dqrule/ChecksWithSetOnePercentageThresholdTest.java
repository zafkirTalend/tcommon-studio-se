package org.talend.top.swtbot.test.analysis.tableanalysis.dqrule;
...
public class ChecksWithSetOnePercentageThresholdTest extends TalendSwtbotForTdq{
	...
	@Test
	public void checksWithSetOnePercentageThreshold() {
		...
		bot.textWithLabel("Lower threshold(%)").setText("");
		bot.textWithLabel("Higher threshold(%)").setText("80");
		bot.button("Finish").click();
		try {
			bot.waitUntil(Conditions.shellCloses(shell));
		} catch (Exception e1) {
