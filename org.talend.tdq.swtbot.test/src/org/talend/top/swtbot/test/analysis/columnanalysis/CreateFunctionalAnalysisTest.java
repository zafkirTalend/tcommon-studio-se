...
public class CreateFunctionalAnalysisTest extends TalendSwtbotForTdq {
	...
	@Test
	public void createFunctionalAnalysis() {
...
//		bot.toolbarButtonWithTooltip("Refresh").click();
		...
		bot.editorByTitle(TalendAnalysisTypeEnum.FUNCTIONAL.toString()+" 0.1").close();
