...
public class ColumnAnlaysisAboutMssqlMicrosoftSqlServerDbconnectionATest extends TalendSwtbotForTdq{
	
	@Before
	public void beforeClass(){
		
		TalendSwtbotTdqCommon.createConnection(bot,
				TalendMetadataTypeEnum.MSSQLSERVER);
		
		bot.editorByTitle(TalendMetadataTypeEnum.MSSQLSERVER.toString() + " 0.1")
				.close();
	...
	@Test
	public void ColumnAnlaysisAboutMssqlMicrosoftSqlServerDbconnectionA(){
		
		String item = bot.tree().expandNode("Metadata","DB connections","MSSQLSERVER", "Talend","dbo","Tables (0)","yhbai","Columns (2)").getNodes().get(1);
		...
		tree.expandNode("Metadata","DB connections",TalendMetadataTypeEnum.MSSQLSERVER.toString(),"Talend").
