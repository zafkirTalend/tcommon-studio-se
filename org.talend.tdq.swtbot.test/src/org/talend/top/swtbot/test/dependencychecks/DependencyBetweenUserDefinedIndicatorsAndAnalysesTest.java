...
public class DependencyBetweenUserDefinedIndicatorsAndAnalysesTest extends TalendSwtbotForTdq{
	...
	public void beforeClass(){
		...
		bot.textWithLabel("SQL Template:").setText("SELECT COUNT(*) FROM <%=__TABLE_NAME__%> <%=__WHERE_CLAUSE__%>r");
	...
	@Test
	public void dependencyBetweenUserDefinedIndicatorsAndAnalyses(){
