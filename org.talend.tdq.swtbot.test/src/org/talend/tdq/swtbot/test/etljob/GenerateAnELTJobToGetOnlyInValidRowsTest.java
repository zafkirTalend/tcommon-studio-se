...
public class GenerateAnELTJobToGetOnlyInValidRowsTest extends TalendSwtbotForTdq{
	...
	@Test
	public void GenerateAnELTJobToGetOnlyInValidRows(){
...
//		ContextMenuHelper.clickContextMenu(table, "Generate Job");
		...
		bot.radio("generate an ELT job to get only invalid rows").click();
