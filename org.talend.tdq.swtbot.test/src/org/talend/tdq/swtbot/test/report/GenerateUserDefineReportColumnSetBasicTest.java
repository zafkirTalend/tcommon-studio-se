...
public class GenerateUserDefineReportColumnSetBasicTest extends TalendSwtbotForTdq{
	private final String REPORTLABEL = "REPORT_Userdefine_cs_b";
	@Before
    ...
    @Test
    public void GenerateUserDefineReportColumnSetBasic(){
		...
		TalendSwtbotTdqCommon.generateReport(bot, formBot, REPORTLABEL, "columnset", "b01_column_set_basic", TalendReportTemplate.User_defined, TalendAnalysisTypeEnum.COLUMNSET.toString());
    }
//    @After
