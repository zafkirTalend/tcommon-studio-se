...
public class GenerateUserDefineReportMatchBasicMysqlTest extends TalendSwtbotForTdq{
	
	private final String REPORTLABEL = "REPORT_Userdefine_match_b_mysql";
	...
	@Test
	public void GenerateUserDefineReportMatchBasicMysql(){
		...
		TalendSwtbotTdqCommon.generateReport(bot, formBot, REPORTLABEL,
				"match","b05_match_basic", TalendReportTemplate.User_defined, TalendAnalysisTypeEnum.REDUNDANCY.toString());
