...
public class GenerateUserDefineReportDOverviewEvolutionOracleTest extends TalendSwtbotForTdq{
	
	private final String REPORTLABEL = "REPORT_Userdefine_overview_e_hsql";
