...
public class GenerateUserDefineReportMatchEvolutionOracleTest extends TalendSwtbotForTdq{
	
	private final String REPORTLABEL = "REPORT_Userdefine_match_e_Oracle";
	...
	@Test
	public void GenerateUserDefineReportMatchEvolutionOracle(){
		...
		TalendSwtbotTdqCommon.generateReport(bot, formBot, REPORTLABEL,
				"match","3", TalendReportTemplate.User_defined, TalendAnalysisTypeEnum.REDUNDANCY.toString());
