...
public class GenerateUserDefineReportFunctionDependencyBasicTest extends TalendSwtbotForTdq{

	private final String REPORTLABEL = "REPORT_Userdefine_functionalDepend_b";
	...
	@Test
	public void GenerateUserDefineReportFunctionDependencyBasic(){
	...
	//	tree.expandNode("tbi", "Tables").select("customer");
		...
		TalendSwtbotTdqCommon.generateReport(bot, formBot, REPORTLABEL,
				"match","functionalDependencyBasic", TalendReportTemplate.User_defined,
