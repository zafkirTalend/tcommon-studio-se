...
public class BasicTypeReportForBusinessRuleAnalysisHSQLTest extends TalendSwtbotForTdq{
	
	private final String  REPORTLABEL = "report_basic_rule_HSQL";
	...
	@Test
	public void basicTypeReportForBusinessRuleAnalysisHSQL(){
