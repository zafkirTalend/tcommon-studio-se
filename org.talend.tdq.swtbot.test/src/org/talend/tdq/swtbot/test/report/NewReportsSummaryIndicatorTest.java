...
public class NewReportsSummaryIndicatorTest extends TalendSwtbotForTdq {

	private final String REPORTLABEL = "summary_indicator_basic_report";
	...
	@Test
	public void newReportsSummaryIndicator() {
		...
		tree = new SWTBotTree((Tree) bot.widget(WidgetOfType
				.widgetOfType(Tree.class)));
		tree.getTreeItem("Summary Statistics").click(1);
		bot.checkBox(21).click();
		bot.button("OK").click();
