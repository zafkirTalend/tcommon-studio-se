...
public class GenerateUserDefineReportColumnBasicTest extends TalendSwtbotForTdq{
	private final String REPORTLABEL = "REPORT_Userdefine_c_b";
    ...
    @Test
    public void GenerateUserDefineReportColumnBasic(){
		...
		TalendSwtbotTdqCommon.generateReport(bot, formBot, REPORTLABEL, "column", "b01_column_basic",TalendReportTemplate.User_defined,  TalendAnalysisTypeEnum.COLUMN.toString());
