...
public class ThresholdHighlightInReportFileTest extends TalendSwtbotForTdq{
	private final String REPORTLABEL = "REPORT_threshold_highlight";
	@Before
	...
	@Test
	public void thresholdHighlightInReportFile() {
		...
		bot.textWithLabel("Higher threshold").setText("9999999");
