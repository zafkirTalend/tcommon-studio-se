...
public class EvolutionTypeReportForRedundancyAnalysisOnORACLETest extends TalendSwtbotForTdq{
	
	private final String REPORTLABEL = "report_evolution_oracle";
	@Before
	...
	@Test
	public void evolutionTypeReportForRedundancyAnalysisOnORACLE() {
		String fname = TalendSwtbotTdqCommon.getColumns(bot,
				TalendMetadataTypeEnum.MYSQL, "tbi", "customer", "fname")[0];
		String address = TalendSwtbotTdqCommon.getColumns(bot,
		...
		bot.table().getTableItem(address).check();
		bot.button("OK").click();
		...
		TalendSwtbotTdqCommon.generateReport(bot, formBot, REPORTLABEL, TalendReportTemplate.Evolution, 
				TalendAnalysisTypeEnum.REDUNDANCY.toString());
	}

//	@After
//	public void cleanSource() {
//	//	TalendSwtbotTdqCommon.deleteAndCleanCycleBin(bot, TalendItemTypeEnum.REPORT,
//	//	REPORTLABEL);		
