...
public class EvolutionTypeReprotForColumnAnalysisOnOracleTest extends TalendSwtbotForTdq{
...
private final String REPORTLABEL = "report_evolution_oracle";
	...
	@Test
	public void evolutionTypeReprotForColumnAnalysisOnOracle(){
		...
		TalendSwtbotTdqCommon.generateReport(bot, formBot, REPORTLABEL, 
				TalendReportTemplate.Evolution, TalendAnalysisTypeEnum.COLUMN.toString());
