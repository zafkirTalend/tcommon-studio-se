...
public class CreateAHtmlReportTest extends TalendSwtbotForTdq{
	private final String REPORTLABEL = "generate_report_html";
...
//	}
	...
	public static void generateReport(SWTWorkbenchBot bot, SWTFormsBot formBot,
		...
		formBot.ccomboBoxWithLabel("File Type").setSelection("html");
