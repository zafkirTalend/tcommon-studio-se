...
public class CreateAnXmlReportTest extends TalendSwtbotForTdq{
	private final String REPORTLABEL = "generate_report_xml";
...
//	}
	...
	public static void generateReport(SWTWorkbenchBot bot, SWTFormsBot formBot,
		...
		formBot.ccomboBoxWithLabel("File Type").setSelection("xml");
