...
public class CreateAPdfReportWithPresentationSettingsTest extends TalendSwtbotForTdq{
private final String REPORTLABEL = "generate_report_pdf";
	...
	@Test
	public void createAPdfReportWithPresentationSettings(){
		TalendSwtbotTdqCommon.createReport(bot, REPORTLABEL);
		generateReport(bot,formBot,REPORTLABEL,TalendReportTemplate.Basic,TalendAnalysisTypeEnum.CONNECTION.toString());
...
//	}
	...
	public static void generateReport(SWTWorkbenchBot bot, SWTFormsBot formBot,
		...
		formBot.ccomboBoxWithLabel("File Type").setSelection("pdf");
		formBot.section("Presentation Settings").setFocus();
		formBot.ccomboBoxWithLabel("Top Left").setSelection("Report Author");
		formBot.ccomboBoxWithLabel("Top Middle").setSelection("Page Number");
		formBot.ccomboBoxWithLabel("Top Right").setSelection("Creation Date");
		formBot.textWithLabel("Logo: ").setText(System.getProperty("tdq.report.logo"));
