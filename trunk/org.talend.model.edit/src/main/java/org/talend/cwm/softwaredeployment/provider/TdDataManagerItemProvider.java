 ...
 * @generated
 */
public class TdDataManagerItemProvider extends DataManagerItemProvider implements IEditingDomainItemProvider,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_TdDataManager_type") : getString("_UI_TdDataManager_type")
                + " " + label;
    }
