...
public interface Conjoint extends Dimension {
     ...
     * accessing the values of the Conjoint Dimension. Valid values are HASH,
     * BTREE, NOHASH. <!-- end-model-doc -->
     * 
     ...
     * specified, this defines the type of page space to be allocated to data
     * relating specific values of the Conjoint to values of its base
     * Dimensions:
     * 
