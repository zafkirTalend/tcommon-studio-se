...
public interface CustomCalendarEvent extends PointInTimeEvent {
    ...
    /**
     * Returns the value of the '<em><b>Custom Calendar</b></em>' reference. It
     * is bidirectional and its opposite is '
     * {@link orgomg.cwm.management.warehouseprocess.events.CustomCalendar#getCustomCalendarEvent
     * <em>Custom Calendar Event</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> Indicates which custom calendar
