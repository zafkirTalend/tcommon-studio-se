...
public class EventsSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case EventsPackage.WAREHOUSE_EVENT: {
            ...
            if (result == null)
                result = caseEvent(warehouseEvent);
            if (result == null)
                result = caseModelElement(warehouseEvent);
            if (result == null)
                result = caseElement(warehouseEvent);
            if (result == null)
        ...
        case EventsPackage.SCHEDULE_EVENT: {
            ...
            if (result == null)
                result = caseWarehouseEvent(scheduleEvent);
            if (result == null)
                result = caseEvent(scheduleEvent);
            if (result == null)
                result = caseModelElement(scheduleEvent);
            if (result == null)
                result = caseElement(scheduleEvent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case EventsPackage.POINT_IN_TIME_EVENT: {
            ...
            if (result == null)
                result = caseScheduleEvent(pointInTimeEvent);
            if (result == null)
                result = caseWarehouseEvent(pointInTimeEvent);
            if (result == null)
                result = caseEvent(pointInTimeEvent);
            if (result == null)
                result = caseModelElement(pointInTimeEvent);
            if (result == null)
                result = caseElement(pointInTimeEvent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case EventsPackage.CUSTOM_CALENDAR_EVENT: {
            ...
            if (result == null)
                result = casePointInTimeEvent(customCalendarEvent);
            if (result == null)
                result = caseScheduleEvent(customCalendarEvent);
            if (result == null)
                result = caseWarehouseEvent(customCalendarEvent);
            if (result == null)
                result = caseEvent(customCalendarEvent);
            if (result == null)
                result = caseModelElement(customCalendarEvent);
            if (result == null)
                result = caseElement(customCalendarEvent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case EventsPackage.CUSTOM_CALENDAR: {
            ...
            if (result == null)
                result = casePackage(customCalendar);
            if (result == null)
                result = caseNamespace(customCalendar);
            if (result == null)
                result = caseModelElement(customCalendar);
            if (result == null)
                result = caseElement(customCalendar);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case EventsPackage.CALENDAR_DATE: {
            ...
            if (result == null)
                result = caseModelElement(calendarDate);
            if (result == null)
                result = caseElement(calendarDate);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case EventsPackage.INTERVAL_EVENT: {
            ...
            if (result == null)
                result = caseScheduleEvent(intervalEvent);
            if (result == null)
                result = caseWarehouseEvent(intervalEvent);
            if (result == null)
                result = caseEvent(intervalEvent);
            if (result == null)
                result = caseModelElement(intervalEvent);
            if (result == null)
                result = caseElement(intervalEvent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case EventsPackage.EXTERNAL_EVENT: {
            ...
            if (result == null)
                result = caseWarehouseEvent(externalEvent);
            if (result == null)
                result = caseEvent(externalEvent);
            if (result == null)
                result = caseModelElement(externalEvent);
            if (result == null)
                result = caseElement(externalEvent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case EventsPackage.INTERNAL_EVENT: {
            ...
            if (result == null)
                result = caseWarehouseEvent(internalEvent);
            if (result == null)
                result = caseEvent(internalEvent);
            if (result == null)
                result = caseModelElement(internalEvent);
            if (result == null)
        ...
        case EventsPackage.CASCADE_EVENT: {
            ...
            if (result == null)
                result = caseInternalEvent(cascadeEvent);
            if (result == null)
                result = caseWarehouseEvent(cascadeEvent);
            if (result == null)
                result = caseEvent(cascadeEvent);
            if (result == null)
                result = caseModelElement(cascadeEvent);
            if (result == null)
                result = caseElement(cascadeEvent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case EventsPackage.RETRY_EVENT: {
            ...
            if (result == null)
                result = caseInternalEvent(retryEvent);
            if (result == null)
                result = caseWarehouseEvent(retryEvent);
            if (result == null)
                result = caseEvent(retryEvent);
            if (result == null)
                result = caseModelElement(retryEvent);
            if (result == null)
                result = caseElement(retryEvent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case EventsPackage.RECURRING_POINT_IN_TIME_EVENT: {
            ...
            if (result == null)
                result = casePointInTimeEvent(recurringPointInTimeEvent);
            if (result == null)
                result = caseScheduleEvent(recurringPointInTimeEvent);
            if (result == null)
                result = caseWarehouseEvent(recurringPointInTimeEvent);
            if (result == null)
                result = caseEvent(recurringPointInTimeEvent);
            if (result == null)
                result = caseModelElement(recurringPointInTimeEvent);
            if (result == null)
                result = caseElement(recurringPointInTimeEvent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
