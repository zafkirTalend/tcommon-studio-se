...
public class WarehouseoperationPackageImpl extends EPackageImpl implements WarehouseoperationPackage {
    ...
    public static WarehouseoperationPackage init() {
        if (isInited)
            return (WarehouseoperationPackage) EPackage.Registry.INSTANCE.getEPackage(WarehouseoperationPackage.eNS_URI);
        ...
        WarehouseoperationPackageImpl theWarehouseoperationPackage = (WarehouseoperationPackageImpl) (EPackage.Registry.INSTANCE
                .get(eNS_URI) instanceof WarehouseoperationPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new WarehouseoperationPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getMeasurement_Value(), theCorePackage.getFloat(), "value", null, 0, 1, Measurement.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMeasurement_Unit(), theCorePackage.getString(), "unit", null, 0, 1, Measurement.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMeasurement_Type(), theCorePackage.getString(), "type", null, 0, 1, Measurement.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMeasurement_CreationDate(), theCorePackage.getTime(), "creationDate", null, 0, 1, Measurement.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMeasurement_EffectiveDate(), theCorePackage.getTime(), "effectiveDate", null, 0, 1, Measurement.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getMeasurement_ModelElement(), theCorePackage.getModelElement(),
                theCorePackage.getModelElement_Measurement(), "modelElement", null, 1, 1, Measurement.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);

        initEClass(changeRequestEClass, ChangeRequest.class, "ChangeRequest", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getChangeRequest_ChangeDescription(), theCorePackage.getString(), "changeDescription", null, 0, 1,
                ChangeRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getChangeRequest_ChangeReason(), theCorePackage.getString(), "changeReason", null, 0, 1,
                ChangeRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getChangeRequest_Status(), theCorePackage.getString(), "status", null, 0, 1, ChangeRequest.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getChangeRequest_Completed(), theCorePackage.getBoolean(), "completed", null, 0, 1, ChangeRequest.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getChangeRequest_RequestDate(), theCorePackage.getTime(), "requestDate", null, 0, 1, ChangeRequest.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getChangeRequest_CompletionDate(), theCorePackage.getTime(), "completionDate", null, 0, 1,
                ChangeRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getChangeRequest_ModelElement(), theCorePackage.getModelElement(),
                theCorePackage.getModelElement_ChangeRequest(), "modelElement", null, 1, -1, ChangeRequest.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);

        initEClass(transformationExecutionEClass, TransformationExecution.class, "TransformationExecution", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTransformationExecution_StartDate(), theCorePackage.getTime(), "startDate", null, 0, 1,
                TransformationExecution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTransformationExecution_EndDate(), theCorePackage.getTime(), "endDate", null, 0, 1,
                TransformationExecution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTransformationExecution_InProgress(), theCorePackage.getBoolean(), "inProgress", null, 0, 1,
                TransformationExecution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTransformationExecution_Successful(), theCorePackage.getBoolean(), "successful", null, 0, 1,
                TransformationExecution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getTransformationExecution_Status(), theCorePackage.getExpression(), null, "status", null, 0, 1,
                TransformationExecution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(activityExecutionEClass, ActivityExecution.class, "ActivityExecution", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getActivityExecution_TransformationActivity(), theTransformationPackage.getTransformationActivity(),
                theTransformationPackage.getTransformationActivity_Execution(), "transformationActivity", null, 1, 1,
                ActivityExecution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getActivityExecution_StepExecution(), this.getStepExecution(), this.getStepExecution_ActivityExecution(),
                "stepExecution", null, 0, -1, ActivityExecution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(stepExecutionEClass, StepExecution.class, "StepExecution", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getStepExecution_TransformationStep(), theTransformationPackage.getTransformationStep(),
                theTransformationPackage.getTransformationStep_Execution(), "transformationStep", null, 1, 1,
                StepExecution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getStepExecution_ActivityExecution(), this.getActivityExecution(),
                this.getActivityExecution_StepExecution(), "activityExecution", null, 0, 1, StepExecution.class, IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getStepExecution_CallAction(), theBehavioralPackage.getCallAction(),
                theBehavioralPackage.getCallAction_StepExecution(), "callAction", null, 0, 1, StepExecution.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
