...
public class ExpressionsSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case ExpressionsPackage.EXPRESSION_NODE: {
            ...
            if (result == null)
                result = caseElement(expressionNode);
            if (result == null)
        ...
        case ExpressionsPackage.CONSTANT_NODE: {
            ...
            if (result == null)
                result = caseExpressionNode(constantNode);
            if (result == null)
                result = caseElement(constantNode);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case ExpressionsPackage.ELEMENT_NODE: {
            ...
            if (result == null)
                result = caseExpressionNode(elementNode);
            if (result == null)
                result = caseElement(elementNode);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case ExpressionsPackage.FEATURE_NODE: {
            ...
            if (result == null)
                result = caseExpressionNode(featureNode);
            if (result == null)
                result = caseElement(featureNode);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
