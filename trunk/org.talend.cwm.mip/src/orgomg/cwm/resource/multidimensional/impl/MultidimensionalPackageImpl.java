...
public class MultidimensionalPackageImpl extends EPackageImpl implements MultidimensionalPackage {
    ...
    public static MultidimensionalPackage init() {
        if (isInited)
            return (MultidimensionalPackage) EPackage.Registry.INSTANCE.getEPackage(MultidimensionalPackage.eNS_URI);

        // Obtain or create and register package
        MultidimensionalPackageImpl theMultidimensionalPackage = (MultidimensionalPackageImpl) (EPackage.Registry.INSTANCE
                .get(eNS_URI) instanceof MultidimensionalPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
                : new MultidimensionalPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEReference(getDimension_DimensionedObject(), this.getDimensionedObject(), this.getDimensionedObject_Dimension(),
                "dimensionedObject", null, 0, -1, Dimension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDimension_Composite(), this.getDimension(), this.getDimension_Component(), "composite", null, 0, -1,
                Dimension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDimension_Component(), this.getDimension(), this.getDimension_Composite(), "component", null, 0, -1,
                Dimension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDimension_Schema(), this.getSchema(), this.getSchema_Dimension(), "schema", null, 1, 1,
                Dimension.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDimension_MemberSet(), this.getMemberSet(), this.getMemberSet_Dimension(), "memberSet", null, 0, -1,
                Dimension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(dimensionedObjectEClass, DimensionedObject.class, "DimensionedObject", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getDimensionedObject_Dimension(), this.getDimension(), this.getDimension_DimensionedObject(), "dimension",
                null, 0, -1, DimensionedObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDimensionedObject_Schema(), this.getSchema(), this.getSchema_DimensionedObject(), "schema", null, 1, 1,
                DimensionedObject.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
        ...
        initEReference(getMemberSet_Dimension(), this.getDimension(), this.getDimension_MemberSet(), "dimension", null, 1, 1,
                MemberSet.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getSchema_DimensionedObject(), this.getDimensionedObject(), this.getDimensionedObject_Schema(),
                "dimensionedObject", null, 0, -1, Schema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
