...
public interface Trigger extends ModelElement {
     ...
     * {@link orgomg.cwm.resource.relational.enumerations.EventManipulationType}
    ...
    /**
     * Returns the value of the '<em><b>Action Condition</b></em>' containment
     * reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> A boolean expression which defines when the trigger
     * has to be executed <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Action Condition</em>' containment
     *         reference.
    ...
    /**
     * Returns the value of the '<em><b>Action Statement</b></em>' containment
     * reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> The Trigger action itself <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Action Statement</em>' containment
     *         reference.
     ...
     * The literals are from the enumeration
     * {@link orgomg.cwm.resource.relational.enumerations.ActionOrientationType}
     * . <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * It indicates if the trigger is called once per statement execution or
     * before or after each row of the table is modified. <!-- end-model-doc -->
     * 
     ...
     * The literals are from the enumeration
     * {@link orgomg.cwm.resource.relational.enumerations.ConditionTimingType}.
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> It
     * indicates if the trigger activity is run before or after the statement or
     * row is modified. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Condition Reference New Table</b></em>'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> The alias for the owning table name, used in the
     * actionStatement, to represent the state of the table after the
     * insert/delete/update <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Condition Reference New Table</em>'
     *         attribute.
    ...
    /**
     * Returns the value of the '<em><b>Condition Reference Old Table</b></em>'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> The alias for the name of the owning table, used in
     * the actionStatement, to represent the state of the table before the
     * update/delete/insert. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Condition Reference Old Table</em>'
     *         attribute.
    ...
    /**
     * Returns the value of the '<em><b>Table</b></em>' reference. It is
     * bidirectional and its opposite is '
     * {@link orgomg.cwm.resource.relational.Table#getTrigger <em>Trigger</em>}
     * '. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The table which owns the Trigger <!-- end-model-doc -->
     * 
