...
public class NamedColumnSetImpl extends ColumnSetImpl implements NamedColumnSet {
    ...
    public EList<Trigger> getUsingTrigger() {
        if (usingTrigger == null) {
            usingTrigger = new EObjectWithInverseResolvingEList.ManyInverse<Trigger>(Trigger.class, this,
                    RelationalPackage.NAMED_COLUMN_SET__USING_TRIGGER, RelationalPackage.TRIGGER__USED_COLUMN_SET);
        }
        return usingTrigger;
    }
        ...
        if (type != null && type.eIsProxy()) {
            ...
            if (type != oldType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, RelationalPackage.NAMED_COLUMN_SET__TYPE, oldType,
                            type));
            }
        }
        return type;
    ...
    public NotificationChain basicSetType(SQLStructuredType newType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    RelationalPackage.NAMED_COLUMN_SET__TYPE, oldType, newType);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setType(SQLStructuredType newType) {
        if (newType != type) {
            ...
            if (type != null)
                msgs = ((InternalEObject) type).eInverseRemove(this, RelationalPackage.SQL_STRUCTURED_TYPE__COLUMN_SET,
                        SQLStructuredType.class, msgs);
            if (newType != null)
                msgs = ((InternalEObject) newType).eInverseAdd(this, RelationalPackage.SQL_STRUCTURED_TYPE__COLUMN_SET,
                        SQLStructuredType.class, msgs);
    ...
    public EList<Column> getOptionScopeColumn() {
        if (optionScopeColumn == null) {
            optionScopeColumn = new EObjectWithInverseResolvingEList<Column>(Column.class, this,
                    RelationalPackage.NAMED_COLUMN_SET__OPTION_SCOPE_COLUMN, RelationalPackage.COLUMN__OPTION_SCOPE_COLUMN_SET);
        }
