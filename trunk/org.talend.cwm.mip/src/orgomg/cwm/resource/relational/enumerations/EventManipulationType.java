 ...
 * <em><b>Event Manipulation Type</b></em>', and utility methods for working
 * with them. <!-- end-user-doc --> <!-- begin-model-doc --> Used in Trigger.
...
public enum EventManipulationType implements Enumerator {
     ...
     * end-user-doc --> <!-- begin-model-doc --> The Trigger activity is used
     * for each insert statement on the table. <!-- end-model-doc -->
     * 
     * @see #INSERT
     * @model name="insert"
     * @generated
     ...
     * end-user-doc --> <!-- begin-model-doc --> The Trigger is used for each
     * delete statement on the table. <!-- end-model-doc -->
     * 
     * @see #DELETE
     * @model name="delete"
     * @generated
     ...
     * end-user-doc --> <!-- begin-model-doc --> The Trigger is used for each
     * update statement of the table. <!-- end-model-doc -->
     * 
     * @see #UPDATE
     * @model name="update"
     * @generated
     ...
     * @generated
     */
    private static final EventManipulationType[] VALUES_ARRAY = new EventManipulationType[] { INSERT, DELETE, UPDATE, };
