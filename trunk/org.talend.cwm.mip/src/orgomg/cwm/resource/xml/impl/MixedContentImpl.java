...
public class MixedContentImpl extends ContentImpl implements MixedContent {
    ...
    public NotificationChain basicSetText(Text newText, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmlPackage.MIXED_CONTENT__TEXT,
                    oldText, newText);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case XmlPackage.MIXED_CONTENT__TEXT:
            if (text != null)
                msgs = ((InternalEObject) text).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmlPackage.MIXED_CONTENT__TEXT,
                        null, msgs);
