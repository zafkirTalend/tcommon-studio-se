...
public class XmlSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case XmlPackage.SCHEMA: {
            ...
            if (result == null)
                result = caseCore_Element(schema);
            if (result == null)
        ...
        case XmlPackage.ELEMENT_TYPE: {
            ...
            if (result == null)
                result = caseClass(elementType);
            if (result == null)
                result = caseClassifier(elementType);
            if (result == null)
                result = caseNamespace(elementType);
            if (result == null)
                result = caseModelElement(elementType);
            if (result == null)
                result = caseCore_Element(elementType);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case XmlPackage.ATTRIBUTE: {
            ...
            if (result == null)
                result = caseCore_Element(attribute);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case XmlPackage.CONTENT: {
            ...
            if (result == null)
                result = caseCore_Element(content);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case XmlPackage.ELEMENT_CONTENT: {
            ...
            if (result == null)
                result = caseContent(elementContent);
            if (result == null)
                result = caseModelElement(elementContent);
            if (result == null)
                result = caseCore_Element(elementContent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case XmlPackage.MIXED_CONTENT: {
            ...
            if (result == null)
                result = caseContent(mixedContent);
            if (result == null)
                result = caseModelElement(mixedContent);
            if (result == null)
                result = caseCore_Element(mixedContent);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case XmlPackage.ELEMENT_TYPE_REFERENCE: {
            ...
            if (result == null)
                result = caseCore_Attribute(elementTypeReference);
            if (result == null)
                result = caseStructuralFeature(elementTypeReference);
            if (result == null)
                result = caseFeature(elementTypeReference);
            if (result == null)
                result = caseModelElement(elementTypeReference);
            if (result == null)
                result = caseCore_Element(elementTypeReference);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case XmlPackage.TEXT: {
            ...
            if (result == null)
                result = caseCore_Attribute(text);
            if (result == null)
                result = caseStructuralFeature(text);
            if (result == null)
                result = caseFeature(text);
            if (result == null)
                result = caseModelElement(text);
            if (result == null)
                result = caseCore_Element(text);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case XmlPackage.ELEMENT: {
            ...
            if (result == null)
                result = caseObject(element);
            if (result == null)
                result = caseInstance(element);
            if (result == null)
                result = caseModelElement(element);
            if (result == null)
                result = caseCore_Element(element);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case XmlPackage.DOCUMENT: {
            ...
            if (result == null)
                result = caseExtent(document);
            if (result == null)
                result = casePackage(document);
            if (result == null)
                result = caseNamespace(document);
            if (result == null)
                result = caseModelElement(document);
            if (result == null)
                result = caseCore_Element(document);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
