...
public interface Schema extends orgomg.cwm.objectmodel.core.Package {
     ...
     * Identifies the version of the XML. <!-- end-model-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link orgomg.cwm.resource.xml.Schema#getVersion
     ...
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * Identifies the XML namespace of the Schema. <!-- end-model-doc -->
     * 
