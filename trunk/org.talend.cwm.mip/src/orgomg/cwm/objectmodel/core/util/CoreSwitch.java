...
public class CoreSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case CorePackage.SUBSYSTEM: {
            ...
            if (result == null)
                result = caseClassifier(subsystem);
            if (result == null)
                result = casePackage(subsystem);
            if (result == null)
                result = caseNamespace(subsystem);
            if (result == null)
                result = caseModelElement(subsystem);
            if (result == null)
                result = caseElement(subsystem);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        ...
        case CorePackage.PROCEDURE_EXPRESSION: {
            ...
            if (result == null)
                result = caseExpression(procedureExpression);
            if (result == null)
                result = caseElement(procedureExpression);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        ...
        case CorePackage.MULTIPLICITY_RANGE: {
            ...
            if (result == null)
                result = caseElement(multiplicityRange);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        ...
        case CorePackage.TAGGED_VALUE: {
            ...
            if (result == null)
                result = caseElement(taggedValue);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
