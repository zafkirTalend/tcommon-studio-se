...
public class TransformationPackageImpl extends EPackageImpl implements TransformationPackage {
    ...
    public static TransformationPackage init() {
        ...
        TransformationPackageImpl theTransformationPackage = (TransformationPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TransformationPackageImpl ? EPackage.Registry.INSTANCE
    ...
    public void initializePackageContents() {
        ...
        WarehouseprocessPackage theWarehouseprocessPackage = (WarehouseprocessPackage) EPackage.Registry.INSTANCE
                .getEPackage(WarehouseprocessPackage.eNS_URI);
        ...
        initEReference(getTransformation_Function(), theCorePackage.getProcedureExpression(), null, "function", null, 0, 1,
                Transformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTransformation_FunctionDescription(), theCorePackage.getString(), "functionDescription", null, 0, 1,
                Transformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getTransformation_IsPrimary(), theCorePackage.getBoolean(), "isPrimary", null, 0, 1, Transformation.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTransformation_Source(), this.getDataObjectSet(), this.getDataObjectSet_SourceTransformation(),
                "source", null, 0, -1, Transformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTransformation_Target(), this.getDataObjectSet(), this.getDataObjectSet_TargetTransformation(),
                "target", null, 0, -1, Transformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTransformation_Task(), this.getTransformationTask(), this.getTransformationTask_Transformation(),
                "task", null, 0, -1, Transformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(dataObjectSetEClass, DataObjectSet.class, "DataObjectSet", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getDataObjectSet_SourceTransformation(), this.getTransformation(), this.getTransformation_Source(),
                "sourceTransformation", null, 0, -1, DataObjectSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDataObjectSet_TargetTransformation(), this.getTransformation(), this.getTransformation_Target(),
                "targetTransformation", null, 0, -1, DataObjectSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDataObjectSet_Element(), theCorePackage.getModelElement(), theCorePackage.getModelElement_Set(),
                "element", null, 1, -1, DataObjectSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(transformationTaskEClass, TransformationTask.class, "TransformationTask", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getTransformationTask_Step(), this.getTransformationStep(), this.getTransformationStep_Task(), "step",
                null, 0, -1, TransformationTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTransformationTask_OriginalTask(), this.getTransformationTask(),
                this.getTransformationTask_InverseTask(), "originalTask", null, 0, -1, TransformationTask.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getTransformationTask_InverseTask(), this.getTransformationTask(),
                this.getTransformationTask_OriginalTask(), "inverseTask", null, 0, -1, TransformationTask.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getTransformationTask_Transformation(), this.getTransformation(), this.getTransformation_Task(),
                "transformation", null, 1, -1, TransformationTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(transformationStepEClass, TransformationStep.class, "TransformationStep", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getTransformationStep_Task(), this.getTransformationTask(), this.getTransformationTask_Step(), "task",
                null, 1, 1, TransformationStep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTransformationStep_WarehouseStep(), theWarehouseprocessPackage.getWarehouseStep(),
                theWarehouseprocessPackage.getWarehouseStep_TransformationStep(), "warehouseStep", null, 0, -1,
                TransformationStep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTransformationStep_Execution(), theWarehouseoperationPackage.getStepExecution(),
                theWarehouseoperationPackage.getStepExecution_TransformationStep(), "execution", null, 0, -1,
                TransformationStep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(transformationActivityEClass, TransformationActivity.class, "TransformationActivity", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTransformationActivity_CreationDate(), theCorePackage.getString(), "creationDate", null, 0, 1,
                TransformationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getTransformationActivity_WarehouseActivity(), theWarehouseprocessPackage.getWarehouseActivity(),
                theWarehouseprocessPackage.getWarehouseActivity_TransformationActivity(), "warehouseActivity", null, 0, -1,
                TransformationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTransformationActivity_Execution(), theWarehouseoperationPackage.getActivityExecution(),
                theWarehouseoperationPackage.getActivityExecution_TransformationActivity(), "execution", null, 0, -1,
                TransformationActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(precedenceConstraintEClass, PrecedenceConstraint.class, "PrecedenceConstraint", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(transformationUseEClass, TransformationUse.class, "TransformationUse", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTransformationUse_Type(), theCorePackage.getString(), "type", null, 0, 1, TransformationUse.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(transformationMapEClass, TransformationMap.class, "TransformationMap", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(transformationTreeEClass, TransformationTree.class, "TransformationTree", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTransformationTree_Type(), this.getTreeType(), "type", null, 0, 1, TransformationTree.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTransformationTree_Body(), theExpressionsPackage.getExpressionNode(), null, "body", null, 0, 1,
                TransformationTree.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(classifierMapEClass, ClassifierMap.class, "ClassifierMap", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getClassifierMap_Function(), theCorePackage.getProcedureExpression(), null, "function", null, 0, 1,
                ClassifierMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getClassifierMap_FunctionDescription(), theCorePackage.getString(), "functionDescription", null, 0, 1,
                ClassifierMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getClassifierMap_FeatureMap(), this.getFeatureMap(), this.getFeatureMap_ClassifierMap(), "featureMap",
                null, 0, -1, ClassifierMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getClassifierMap_CfMap(), this.getClassifierFeatureMap(), this.getClassifierFeatureMap_ClassifierMap(),
                "cfMap", null, 0, -1, ClassifierMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getClassifierMap_Source(), theCorePackage.getClassifier(), theCorePackage.getClassifier_ClassifierMap(),
                "source", null, 1, -1, ClassifierMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(featureMapEClass, FeatureMap.class, "FeatureMap", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getFeatureMap_Function(), theCorePackage.getProcedureExpression(), null, "function", null, 0, 1,
                FeatureMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getFeatureMap_FunctionDescription(), theCorePackage.getString(), "functionDescription", null, 0, 1,
                FeatureMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getFeatureMap_ClassifierMap(), this.getClassifierMap(), this.getClassifierMap_FeatureMap(),
                "classifierMap", null, 0, 1, FeatureMap.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getFeatureMap_Target(), theCorePackage.getFeature(), theCorePackage.getFeature_FeatureMap(), "target",
                null, 1, -1, FeatureMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(stepPrecedenceEClass, StepPrecedence.class, "StepPrecedence", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);

        initEClass(classifierFeatureMapEClass, ClassifierFeatureMap.class, "ClassifierFeatureMap", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getClassifierFeatureMap_Function(), theCorePackage.getProcedureExpression(), null, "function", null, 0, 1,
                ClassifierFeatureMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getClassifierFeatureMap_FunctionDescription(), theCorePackage.getString(), "functionDescription", null, 0,
                1, ClassifierFeatureMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getClassifierFeatureMap_ClassifierToFeature(), theCorePackage.getBoolean(), "classifierToFeature", null,
                0, 1, ClassifierFeatureMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getClassifierFeatureMap_ClassifierMap(), this.getClassifierMap(), this.getClassifierMap_CfMap(),
                "classifierMap", null, 0, 1, ClassifierFeatureMap.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getClassifierFeatureMap_Classifier(), theCorePackage.getClassifier(),
                theCorePackage.getClassifier_CfMap(), "classifier", null, 1, -1, ClassifierFeatureMap.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getClassifierFeatureMap_Feature(), theCorePackage.getFeature(), theCorePackage.getFeature_CfMap(),
                "feature", null, 1, -1, ClassifierFeatureMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
