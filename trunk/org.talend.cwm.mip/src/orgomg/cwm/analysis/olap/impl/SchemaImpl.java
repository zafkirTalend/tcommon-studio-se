...
public class SchemaImpl extends PackageImpl implements Schema {
    ...
    /**
     * The cached value of the '{@link #getDeploymentGroup()
     * <em>Deployment Group</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    public EList<Cube> getCube() {
        if (cube == null) {
            cube = new EObjectContainmentWithInverseEList<Cube>(Cube.class, this, OlapPackage.SCHEMA__CUBE,
                    OlapPackage.CUBE__SCHEMA);
        }
        return cube;
    }
    ...
    public EList<Dimension> getDimension() {
        if (dimension == null) {
            dimension = new EObjectContainmentWithInverseEList<Dimension>(Dimension.class, this, OlapPackage.SCHEMA__DIMENSION,
                    OlapPackage.DIMENSION__SCHEMA);
        }
        return dimension;
    }
    ...
    public EList<DeploymentGroup> getDeploymentGroup() {
        if (deploymentGroup == null) {
            deploymentGroup = new EObjectContainmentWithInverseEList<DeploymentGroup>(DeploymentGroup.class, this,
                    OlapPackage.SCHEMA__DEPLOYMENT_GROUP, OlapPackage.DEPLOYMENT_GROUP__SCHEMA);
        }
