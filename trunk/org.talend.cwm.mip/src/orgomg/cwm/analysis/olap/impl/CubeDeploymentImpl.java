...
public class CubeDeploymentImpl extends ClassImpl implements CubeDeployment {
    ...
    public CubeRegion getCubeRegion() {
        if (eContainerFeatureID() != OlapPackage.CUBE_DEPLOYMENT__CUBE_REGION)
            return null;
    ...
    public void setCubeRegion(CubeRegion newCubeRegion) {
        if (newCubeRegion != eInternalContainer()
                || (eContainerFeatureID() != OlapPackage.CUBE_DEPLOYMENT__CUBE_REGION && newCubeRegion != null)) {
            ...
            if (newCubeRegion != null)
                msgs = ((InternalEObject) newCubeRegion).eInverseAdd(this, OlapPackage.CUBE_REGION__CUBE_DEPLOYMENT,
                        CubeRegion.class, msgs);
            msgs = basicSetCubeRegion(newCubeRegion, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.CUBE_DEPLOYMENT__CUBE_REGION, newCubeRegion,
                    newCubeRegion));
    }
        ...
        if (deploymentGroup != null && deploymentGroup.eIsProxy()) {
            ...
            if (deploymentGroup != oldDeploymentGroup) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OlapPackage.CUBE_DEPLOYMENT__DEPLOYMENT_GROUP,
    ...
    public NotificationChain basicSetDeploymentGroup(DeploymentGroup newDeploymentGroup, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    OlapPackage.CUBE_DEPLOYMENT__DEPLOYMENT_GROUP, oldDeploymentGroup, newDeploymentGroup);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDeploymentGroup(DeploymentGroup newDeploymentGroup) {
        if (newDeploymentGroup != deploymentGroup) {
            ...
            if (deploymentGroup != null)
                msgs = ((InternalEObject) deploymentGroup).eInverseRemove(this, OlapPackage.DEPLOYMENT_GROUP__CUBE_DEPLOYMENT,
                        DeploymentGroup.class, msgs);
            if (newDeploymentGroup != null)
                msgs = ((InternalEObject) newDeploymentGroup).eInverseAdd(this, OlapPackage.DEPLOYMENT_GROUP__CUBE_DEPLOYMENT,
                        DeploymentGroup.class, msgs);
            msgs = basicSetDeploymentGroup(newDeploymentGroup, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.CUBE_DEPLOYMENT__DEPLOYMENT_GROUP,
    ...
    public EList<ContentMap> getContentMap() {
        if (contentMap == null) {
            contentMap = new EObjectContainmentWithInverseEList<ContentMap>(ContentMap.class, this,
                    OlapPackage.CUBE_DEPLOYMENT__CONTENT_MAP, OlapPackage.CONTENT_MAP__CUBE_DEPLOYMENT);
        }
        return contentMap;
    }
