 ...
 * <em><b>Hierarchy Level Association</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class HierarchyLevelAssociationImpl extends ClassImpl implements HierarchyLevelAssociation {
    ...
    public LevelBasedHierarchy getLevelBasedHierarchy() {
        if (eContainerFeatureID() != OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__LEVEL_BASED_HIERARCHY)
            return null;
    ...
    public NotificationChain basicSetLevelBasedHierarchy(LevelBasedHierarchy newLevelBasedHierarchy, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newLevelBasedHierarchy,
                OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__LEVEL_BASED_HIERARCHY, msgs);
        return msgs;
    }
    ...
    public void setLevelBasedHierarchy(LevelBasedHierarchy newLevelBasedHierarchy) {
        if (newLevelBasedHierarchy != eInternalContainer()
                || (eContainerFeatureID() != OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__LEVEL_BASED_HIERARCHY && newLevelBasedHierarchy != null)) {
            ...
            if (newLevelBasedHierarchy != null)
                msgs = ((InternalEObject) newLevelBasedHierarchy).eInverseAdd(this,
                        OlapPackage.LEVEL_BASED_HIERARCHY__HIERARCHY_LEVEL_ASSOCIATION, LevelBasedHierarchy.class, msgs);
            msgs = basicSetLevelBasedHierarchy(newLevelBasedHierarchy, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__LEVEL_BASED_HIERARCHY,
                    newLevelBasedHierarchy, newLevelBasedHierarchy));
    }
            ...
            if (currentLevel != oldCurrentLevel) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__CURRENT_LEVEL, oldCurrentLevel, currentLevel));
            }
        }
        return currentLevel;
    }
    ...
    public NotificationChain basicSetCurrentLevel(Level newCurrentLevel, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__CURRENT_LEVEL, oldCurrentLevel, newCurrentLevel);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setCurrentLevel(Level newCurrentLevel) {
        if (newCurrentLevel != currentLevel) {
            ...
            if (currentLevel != null)
                msgs = ((InternalEObject) currentLevel).eInverseRemove(this, OlapPackage.LEVEL__HIERARCHY_LEVEL_ASSOCIATION,
                        Level.class, msgs);
            if (newCurrentLevel != null)
                msgs = ((InternalEObject) newCurrentLevel).eInverseAdd(this, OlapPackage.LEVEL__HIERARCHY_LEVEL_ASSOCIATION,
                        Level.class, msgs);
            msgs = basicSetCurrentLevel(newCurrentLevel, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__CURRENT_LEVEL,
    ...
    public EList<DimensionDeployment> getDimensionDeployment() {
        if (dimensionDeployment == null) {
            dimensionDeployment = new EObjectContainmentWithInverseEList<DimensionDeployment>(DimensionDeployment.class, this,
                    OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__DIMENSION_DEPLOYMENT,
                    OlapPackage.DIMENSION_DEPLOYMENT__HIERARCHY_LEVEL_ASSOCIATION);
        }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__LEVEL_BASED_HIERARCHY:
            return eInternalContainer().eInverseRemove(this, OlapPackage.LEVEL_BASED_HIERARCHY__HIERARCHY_LEVEL_ASSOCIATION,
                    LevelBasedHierarchy.class, msgs);
        }
