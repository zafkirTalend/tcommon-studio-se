...
public interface DimensionDeployment extends orgomg.cwm.objectmodel.core.Class {
    ...
    /**
     * Returns the value of the '<em><b>Hierarchy Level Association</b></em>'
     * container reference. It is bidirectional and its opposite is '
     * {@link orgomg.cwm.analysis.olap.HierarchyLevelAssociation#getDimensionDeployment
     * <em>Dimension Deployment</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The HierarchyLevelAssociation
     * owning DimensionDeployments. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Hierarchy Level Association</em>' container
     *         reference.
     ...
     * {@link orgomg.cwm.analysis.olap.DimensionDeployment#getHierarchyLevelAssociation
     * <em>Hierarchy Level Association</em>}' container reference. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Hierarchy Level Association</em>'
     *            container reference.
    ...
    /**
     * Returns the value of the '<em><b>Value Based Hierarchy</b></em>'
     * container reference. It is bidirectional and its opposite is '
     * {@link orgomg.cwm.analysis.olap.ValueBasedHierarchy#getDimensionDeployment
     * <em>Dimension Deployment</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The ValueBasedHierarchy owning
     * a DimensionDeployment. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Value Based Hierarchy</em>' container
     *         reference.
    ...
    /**
     * Returns the value of the '<em><b>Structure Map</b></em>' containment
     * reference list. The list contents are of type
     * {@link orgomg.cwm.analysis.olap.StructureMap}. It is bidirectional and
     * its opposite is '
     * {@link orgomg.cwm.analysis.olap.StructureMap#getDimensionDeployment
     * <em>Dimension Deployment</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The StructureMaps owned by a
     * DimensionDeployment. <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>List Of Values</b></em>' reference. It
     * is bidirectional and its opposite is '
     * {@link orgomg.cwm.analysis.olap.StructureMap#getDimensionDeploymentLV
     * <em>Dimension Deployment LV</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The StructureMap referenced by
     * a DimensionDeployment as its "list of values" StructureMap. <!--
     * end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Immediate Parent</b></em>' reference. It
     * is bidirectional and its opposite is '
     * {@link orgomg.cwm.analysis.olap.StructureMap#getDimensionDeploymentIP
     * <em>Dimension Deployment IP</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The StructureMap referenced by
     * a DimensionDeployment as its "immediate parent". <!-- end-model-doc -->
     * 
    ...
    /**
     * Returns the value of the '<em><b>Deployment Group</b></em>' reference. It
     * is bidirectional and its opposite is '
     * {@link orgomg.cwm.analysis.olap.DeploymentGroup#getDimensionDeployment
     * <em>Dimension Deployment</em>}'. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The DeploymentGroups
     * referencing a DimensionDeployment. <!-- end-model-doc -->
     * 
