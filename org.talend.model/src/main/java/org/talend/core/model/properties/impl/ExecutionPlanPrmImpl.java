 ...
 *   <li>{@link org.talend.core.model.properties.impl.ExecutionPlanPrmImpl#isActive <em>Active</em>}</li>
...
public class ExecutionPlanPrmImpl extends EObjectImpl implements ExecutionPlanPrm {
    ...
    public void setActive(boolean newActive) {
        ...
        active = newActive;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PropertiesPackage.EXECUTION_PLAN_PRM__ACTIVE, oldActive, active));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case PropertiesPackage.EXECUTION_PLAN_PRM__ACTIVE:
