...
public class ComponentCachePackageImpl extends EPackageImpl implements ComponentCachePackage {
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getComponentInfo_IsTechnical(), ecorePackage.getEBoolean(), "isTechnical", null, 0, 1, ComponentInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getComponentInfo_IsVisibleInComponentDefinition(), ecorePackage.getEBoolean(), "isVisibleInComponentDefinition", null, 0, 1, ComponentInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
