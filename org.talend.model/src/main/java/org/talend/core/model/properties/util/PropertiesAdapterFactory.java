...
public class PropertiesAdapterFactory extends AdapterFactoryImpl {
    ...
    protected PropertiesSwitch modelSwitch =
        new PropertiesSwitch() {
            ...
            public Object caseExecutionServerPhysicalVirtualRelation(ExecutionServerPhysicalVirtualRelation object) {
                return createExecutionServerPhysicalVirtualRelationAdapter();
            }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.core.model.properties.ExecutionServerPhysicalVirtualRelation <em>Execution Server Physical Virtual Relation</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createExecutionServerPhysicalVirtualRelationAdapter() {
        return null;
    }
