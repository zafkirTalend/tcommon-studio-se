...
public class ExecutionTaskCmdPrmImpl extends EObjectImpl implements ExecutionTaskCmdPrm {
    ...
    public ExecutionTask getExecutionTask() {
        if (executionTask != null && executionTask.eIsProxy()) {
            ...
            if (executionTask != oldExecutionTask) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, PropertiesPackage.EXECUTION_TASK_CMD_PRM__EXECUTION_TASK, oldExecutionTask, executionTask));
            }
        }
    ...
    public void setExecutionTask(ExecutionTask newExecutionTask) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, PropertiesPackage.EXECUTION_TASK_CMD_PRM__EXECUTION_TASK, oldExecutionTask, executionTask));
    }
