 ...
 * <em><b>SAP Function Parameter Column</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.talend.core.model.metadata.builder.connection.impl.SAPFunctionParameterColumnImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link org.talend.core.model.metadata.builder.connection.impl.SAPFunctionParameterColumnImpl#getDescription <em>Description</em>}</li>
 ...
 * @generated
 */
public class SAPFunctionParameterColumnImpl extends AbstractMetadataObjectImpl
		implements SAPFunctionParameterColumn {
	/**
	...
	public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__NAME, oldName, name));
    }
	...
	public void setParameterType(String newParameterType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__PARAMETER_TYPE, oldParameterType, parameterType));
    }
	...
	public void setStructureOrTableName(String newStructureOrTableName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__STRUCTURE_OR_TABLE_NAME, oldStructureOrTableName, structureOrTableName));
    }
	...
	public void setDataType(String newDataType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__DATA_TYPE, oldDataType, dataType));
    }
	...
	public void setLength(String newLength) {
        ...
        length = newLength;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__LENGTH, oldLength, length));
    }
	...
	public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__DESCRIPTION, oldDescription, description));
    }
	...
	public void setValue(String newValue) {
        ...
        value = newValue;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__VALUE, oldValue, value));
    }
     ...
     * @generated
     */
	public NotificationChain basicSetParameterTable(
			SAPFunctionParameterTable newParameterTable, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject)newParameterTable, ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__PARAMETER_TABLE, msgs);
        return msgs;
    }
	...
	public void setParameterTable(SAPFunctionParameterTable newParameterTable) {
        if (newParameterTable != eInternalContainer() || (eContainerFeatureID != ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__PARAMETER_TABLE && newParameterTable != null)) {
            ...
            if (newParameterTable != null)
                msgs = ((InternalEObject)newParameterTable).eInverseAdd(this, ConnectionPackage.SAP_FUNCTION_PARAMETER_TABLE__COLUMNS, SAPFunctionParameterTable.class, msgs);
            msgs = basicSetParameterTable(newParameterTable, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__PARAMETER_TABLE, newParameterTable, newParameterTable));
    }
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__NAME:
                return getName();
            ...
            case ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__LENGTH:
                return getLength();
            case ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__DESCRIPTION:
	...
	public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__STRUCTURE_OR_TABLE_NAME:
                return STRUCTURE_OR_TABLE_NAME_EDEFAULT == null ? structureOrTableName != null : !STRUCTURE_OR_TABLE_NAME_EDEFAULT.equals(structureOrTableName);
            case ConnectionPackage.SAP_FUNCTION_PARAMETER_COLUMN__DATA_TYPE:
