 ...
 * @generated
 */
public class InputSAPFunctionParameterTableImpl extends
		SAPFunctionParameterTableImpl implements InputSAPFunctionParameterTable {
	/**
	...
	public SAPFunctionUnit getFunctionUnit() {
        if (eContainerFeatureID != ConnectionPackage.INPUT_SAP_FUNCTION_PARAMETER_TABLE__FUNCTION_UNIT) return null;
	...
	public NotificationChain basicSetFunctionUnit(
        ...
        msgs = eBasicSetContainer((InternalEObject)newFunctionUnit, ConnectionPackage.INPUT_SAP_FUNCTION_PARAMETER_TABLE__FUNCTION_UNIT, msgs);
        return msgs;
    }
	...
	public void setFunctionUnit(SAPFunctionUnit newFunctionUnit) {
        if (newFunctionUnit != eInternalContainer() || (eContainerFeatureID != ConnectionPackage.INPUT_SAP_FUNCTION_PARAMETER_TABLE__FUNCTION_UNIT && newFunctionUnit != null)) {
            ...
            if (newFunctionUnit != null)
                msgs = ((InternalEObject)newFunctionUnit).eInverseAdd(this, ConnectionPackage.SAP_FUNCTION_UNIT__INPUT_PARAMETER_TABLE, SAPFunctionUnit.class, msgs);
            msgs = basicSetFunctionUnit(newFunctionUnit, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ConnectionPackage.INPUT_SAP_FUNCTION_PARAMETER_TABLE__FUNCTION_UNIT, newFunctionUnit, newFunctionUnit));
    }
	...
	public NotificationChain eBasicRemoveFromContainerFeature(
        ...
        switch (eContainerFeatureID) {
            case ConnectionPackage.INPUT_SAP_FUNCTION_PARAMETER_TABLE__FUNCTION_UNIT:
                return eInternalContainer().eInverseRemove(this, ConnectionPackage.SAP_FUNCTION_UNIT__INPUT_PARAMETER_TABLE, SAPFunctionUnit.class, msgs);
        }
