...
public class PropertiesPackageImpl extends EPackageImpl implements PropertiesPackage {
     ...
     * @generated
     */
    public EReference getFolderItem_Parent() {
        return (EReference)folderItemEClass.getEStructuralFeatures().get(2);
    }
    ...
    public void createPackageContents() {
        ...
        createEReference(folderItemEClass, FOLDER_ITEM__PARENT);
    ...
    public void initializePackageContents() {
        ...
        folderItemEClass.getESuperTypes().add(this.getContainer());
        ...
        initEReference(getProject_Components(), this.getComponent(), this.getComponent_Projects(), "components", null, 0, -1, Project.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getProperty_ModificationDate(), ecorePackage.getEDate(), "modificationDate", null, 1, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getFolderItem_Children(), this.getItem(), this.getFolderItem_Parent(), "children", null, 0, -1, FolderItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getFolderItem_Parent(), this.getContainer(), this.getFolderItem_Children(), "parent", null, 0, 1, FolderItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getComponent_Projects(), this.getProject(), this.getProject_Components(), "projects", null, 0, -1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        EOperation op = addEOperation(containerEClass, this.getFolderItem(), "findChildFolder", 0, 1);
        addEParameter(op, ecorePackage.getEString(), "name", 0, 1);

        addEOperation(containerEClass, ecorePackage.getEEList(), "getContent", 0, 1);

        addEOperation(containerEClass, this.getContainer(), "getContainer", 0, 1);
