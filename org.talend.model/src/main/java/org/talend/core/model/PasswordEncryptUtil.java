...
public class PasswordEncryptUtil {
	...
	public static void encryptPassword(DatabaseConnection dbConn)
			throws Exception {
		String password = encryptPassword(dbConn
				.getRawPassword());
		dbConn.setPassword(password);
	}
	
	public static void encryptPassword(ContextParameterType param)
			throws Exception {
