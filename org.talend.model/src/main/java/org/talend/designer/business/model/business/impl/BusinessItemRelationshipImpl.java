...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Item Relationship</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.talend.designer.business.model.business.impl.BusinessItemRelationshipImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.talend.designer.business.model.business.impl.BusinessItemRelationshipImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BusinessItemRelationshipImpl extends BusinessItemImpl implements BusinessItemRelationship {
        ...
        if (source != null && source.eIsProxy()) {
            ...
            if (source != oldSource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, BusinessPackage.BUSINESS_ITEM_RELATIONSHIP__SOURCE, oldSource, source));
            }
        }
        return source;
    }
    ...
    public NotificationChain basicSetSource(BusinessItemShape newSource, NotificationChain msgs) {
        ...
        source = newSource;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BusinessPackage.BUSINESS_ITEM_RELATIONSHIP__SOURCE, oldSource, newSource);
    ...
    public void setSource(BusinessItemShape newSource) {
        if (newSource != source) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, BusinessPackage.BUSINESS_ITEM_RELATIONSHIP__SOURCE, newSource, newSource));
    }
    ...
    public BusinessItemShape getTarget() {
        if (target != null && target.eIsProxy()) {
            ...
            if (target != oldTarget) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, BusinessPackage.BUSINESS_ITEM_RELATIONSHIP__TARGET, oldTarget, target));
            }
        }
        return target;
    }
    ...
    public NotificationChain basicSetTarget(BusinessItemShape newTarget, NotificationChain msgs) {
        ...
        target = newTarget;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BusinessPackage.BUSINESS_ITEM_RELATIONSHIP__TARGET, oldTarget, newTarget);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setTarget(BusinessItemShape newTarget) {
        if (newTarget != target) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, BusinessPackage.BUSINESS_ITEM_RELATIONSHIP__TARGET, newTarget, newTarget));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case BusinessPackage.BUSINESS_ITEM_RELATIONSHIP__SOURCE:
                if (source != null)
                    msgs = ((InternalEObject)source).eInverseRemove(this, BusinessPackage.BUSINESS_ITEM_SHAPE__OUTGOING_RELATIONSHIPS, BusinessItemShape.class, msgs);
                return basicSetSource((BusinessItemShape)otherEnd, msgs);
            case BusinessPackage.BUSINESS_ITEM_RELATIONSHIP__TARGET:
                if (target != null)
                    msgs = ((InternalEObject)target).eInverseRemove(this, BusinessPackage.BUSINESS_ITEM_SHAPE__INCOMING_RELATIONSHIPS, BusinessItemShape.class, msgs);
