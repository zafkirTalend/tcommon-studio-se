 ...
 */
package com.quantum.editors.graphical.directedit;
 ...
 * @author Phil Zoio
 */
public class AliasNameCellEditorValidator implements ICellEditorValidator
{
	 ...
	 */
	public AliasNameCellEditorValidator(ValidationMessageHandler validationMessageHandler)
	{
	...
	public String isValid(Object value)
	{
		...
		if (name.indexOf(" ") != -1)
		{
			String text = "Alias name should not include the space character";
