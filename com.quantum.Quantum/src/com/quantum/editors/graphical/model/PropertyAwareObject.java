...
public abstract class PropertyAwareObject extends Object implements Serializable
{
    ...
    public static final String RELATIONSHIPNAMES = "RELATIONSHIPNAMES";
    public static final String SHOWCOLUMNS = "SHOWCOLUMNS";
    public static final String MARKEDFOROUTPUT= "MARKEDFOROUTPUT";
    public static final String P_BEND_POINT = "__bend_point";
    public static final String COLUMNIMAGE= "COLUMNIMAGE";
    public static final String SIZE_TYPE_PRECISION = "SIZE";
