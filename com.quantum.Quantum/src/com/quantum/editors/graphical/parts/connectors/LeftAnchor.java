...
/**
 * Left anchor for joining connections between figures
 * 
 * @author jhvdv
 */
public class LeftAnchor extends AbstractConnectionAnchor
{
	...
	public LeftAnchor(IFigure source, ConnectionEditPart connection)
	{
		super(source);
