...
public class SQLGrammar {
	...
	private SQLGrammar() {
		this.keywords = Collections.synchronizedSet(new HashSet());
		this.keywords.addAll(Arrays.asList(KEYWORDS));
	};	// So the user does not instantiate it
    
	private static SQLGrammar instance;
	private Set keywords = null;

    public static synchronized SQLGrammar getInstance() {
    	if (instance == null) {
...
//    private String[] NON_RESERVED_WORDS = { 
