 ...
 */
public class ReusableMultiKeyMap
     ...
     */
    protected ReusableMultiKeyMap(AbstractHashedMap map) {
        super();
        this.map = map;
    }
    ...
    public Object put(Object key1, Object key2, Object value) {
        ...
        map.addMapping(index, hashCode, new ReusableMultiKey(key1, key2), value);
        return null;
    }
    ...
    protected boolean isEqualKey(AbstractHashedMap.HashEntry entry, Object key1, Object key2) {
        ReusableMultiKey multi = (ReusableMultiKey) entry.getKey();
        return
            multi.size() == 2 &&
    ...
    public Object put(Object key1, Object key2, Object key3, Object value) {
        ...
        map.addMapping(index, hashCode, new ReusableMultiKey(key1, key2, key3), value);
        return null;
    }
    ...
    public Object put(Object key1, Object key2, Object key3, Object key4, Object value) {
        ...
        map.addMapping(index, hashCode, new ReusableMultiKey(key1, key2, key3, key4), value);
        return null;
    }
    ...
    public Object put(Object key1, Object key2, Object key3, Object key4, Object key5, Object value) {
        ...
        map.addMapping(index, hashCode, new ReusableMultiKey(key1, key2, key3, key4, key5), value);
        return null;
    }
     ...
     * <p>
     * This method removes all the mappings where the <code>ReusableMultiKey</code>
    ...
    public boolean removeAll(Object key1) {
        ...
        while (it.hasNext()) {
            ReusableMultiKey multi = (ReusableMultiKey) it.next();
            if (multi.size() >= 1 &&
                (key1 == null ? multi.getKey(0) == null : key1.equals(multi.getKey(0)))) {
                it.remove();
                modified = true;
    ...
    //-----------------------------------------------------------------------
    /**
     * Check to ensure that input keys are valid ReusableMultiKey objects.
     * 
     ...
     */
    public Object clone() {
        return new ReusableMultiKeyMap((AbstractHashedMap) map.clone());
    }

    /**
     * Puts the key and value into the map, where the key must be a non-null
     * ReusableMultiKey object.
     * 
     * @param key  the non-null ReusableMultiKey object
     * @param value  the value to store
     * @return the previous value for the key
     * @throws NullPointerException if the key is null
     * @throws ClassCastException if the key is not a ReusableMultiKey
     */
     ...
     * Each key must be non-null and a ReusableMultiKey object.
     * 
     * @param mapToCopy  to this map
     * @throws NullPointerException if the mapToCopy or any key within is null
     * @throws ClassCastException if any key in mapToCopy is not a ReusableMultiKey
     */
