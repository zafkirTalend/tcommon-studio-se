...
public enum EDatabaseTypeName {
    ...
    ORACLEFORSID("Oracle", "Oracle with SID", new Boolean(true), "ORACLE_SID", "DBORACLE"),
    ORACLESN("Oracle with service name", "Oracle with service name", new Boolean(true), "ORACLE_SERIVCE_NAME", "DBORACLE"),
