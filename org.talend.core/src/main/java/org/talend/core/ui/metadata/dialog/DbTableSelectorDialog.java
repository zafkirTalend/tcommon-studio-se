...
public class DbTableSelectorDialog extends Dialog {
    ...
    private static Image dbImage = CorePlugin.getImageDescriptor("/icons/database/connection.png").createImage();

    private static Image columnImage = CorePlugin.getImageDescriptor("/icons/database/columns.gif").createImage();
