...
public enum ECoreImage implements IImage {
    ...
    COMPARE_ICON("/icons/compare_view.gif"), //$NON-NLS-1$

    STANDARD_ICON("/icons/palette.gif"), //$NON-NLS-1$

    STANDARD_DISICON("/icons/standard_dis.png"), //$NON-NLS-1$

    FAVORITE_DISICON("/icons/favorite_dis.png"), //$NON-NLS-1$

    FAVORITE_ICON("/icons/palette_fav.png"), //$NON-NLS-1$
    ...
    METADATA_MDM_CONNECTION_ICON("/icons/mdm_metadata.png"), //$NON-NLS-1$
    METADATA_MDM_CONNECTION_WIZ("/icons/talendMDM_wiz.png"), //$NON-NLS-1$

    METADATA_RULES_ICON("/icons/rules_wiz.gif"), //$NON-NLS-1$
    METADATA_RULES_WIZ("/icons/rules_wiz.gif"), //$NON-NLS-1$
    ...
    PROGRESSGRAYBAR("/icons/gray.gif"), //$NON-NLS-1$
    PROGRESSGRAYGEBAR("/icons/graygeBar.gif"), //$NON-NLS-1$
    TRIANGLE("/icons/triangle.gif"), // triangle.gif //$NON-NLS-1$
    COMPARE("/icons/compare.gif"); //$NON-NLS-N$
