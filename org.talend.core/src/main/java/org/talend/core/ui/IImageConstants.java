...
public interface IImageConstants {
    ...
    public static final String FILE_ICON = "/icons/file.png";

    public static final String FILE_DELIMITED_ICON = "/icons/filedelimited.png";

    public static final String FILE_POSITIONAL_ICON = "/icons/filepositional.png";
    ...
    public static final String FILE_XML_LDIF = "/icons/fileldif.png";

    public static final String TABLE_ICON = "/icons/table.gif";

    public static final String CONNECTION_ICON = "/icons/connection.png";

    public static final String METADATA_ICON = "/icons/metadata.png";

    public static final String DOCUMENTATION_ICON = "/icons/documentation.png";

    public static final String ICONS_SUBROUTINE_GIF = "/icons/subroutine.gif";
    ...
    public static final String RECYCLE_BIN_EMPTY_ICON = "/icons/recyclebinempty.png";
    ...
    public static final String DOC_PDF_ICON = "/icons/docs/pdf.png";

    public static final String DOC_POWERPOINT_ICON = "/icons/docs/powerpoint.png";

    public static final String DOC_IMAGE_ICON = "/icons/docs/image.png";
