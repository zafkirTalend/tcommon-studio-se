...
public class Project {
    ...
    private Element statsAndLog;

    private Element initialContextLoad;
    ...
    public Element getStatsAndLog() {
        return this.statsAndLog;
    }

    public void setStatsAndLog(Element statsAndLog) {
        this.statsAndLog = statsAndLog;
    }

    public Element getInitialContextLoad() {
        return this.initialContextLoad;
    }

    public void setInitialContextLoad(Element initialContextLoad) {
