...
public abstract class AbstractNode implements INode {
	...
	public AbstractNode getSubProcessStartNode(boolean withConditions) {
		...
		for (int j = 0; j < getIncomingConnections().size(); j++) {
			...
			if (!connec.getLineStyle().equals(EConnectionType.FLOW_REF)) {
				return ((AbstractNode) connec.getSource())
	 ...
	 * 
	 * @param hasConditionalOutputs
	 *            the hasConditionnalOutputs to set
	 */
	 ...
	 * 
	 * @param isMultiplyingOutputs
	 *            the isMultiplyingOutputs to set
	 */
	 ...
	 * 
	 * @param isThereLinkWithHash
	 *            the isThereLinkWithHash to set
	 */
	...
	public IElementParameter getElementParameter(String name) {
		...
		for (IElementParameter elementParam : elementParameters) {
			for (String key : elementParam.getChildParameters().keySet()) {
				IElementParameter param = elementParam.getChildParameters()
						.get(key);
	 ...
	 * 
	 * @see
	 * org.talend.core.model.process.INode#getOutgoingConnections(org.talend
	 * .core.model.process.EConnectionType)
	 */
	public List<? extends IConnection> getOutgoingConnections(
	 ...
	 * 
	 * @see
	 * org.talend.core.model.process.INode#getOutgoingConnections(java.lang.
	 * String)
	 */
	public List<? extends IConnection> getOutgoingConnections(
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.talend.core.model.process.INode#renameData(java.lang.String,
	 * java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.talend.core.model.process.INode#getIncomingConnections(org.talend
	 * .core.model.process.EConnectionType)
	 */
	public List<? extends IConnection> getIncomingConnections(
			EConnectionType connectionType) {
	 ...
	 * 
	 * @see
	 * org.talend.core.model.process.INode#getConnectorFromName(java.lang.String
	 * )
	 */
	 ...
	 * 
	 * @see
	 * org.talend.core.model.process.INode#reloadComponent(org.talend.core.model
	 * .components.IComponent, java.util.Map)
	 */
	 ...
	 * 
	 * @param designSubjobStart
	 *            the designSubjobStart to set
	 */
	 ...
	 * 
	 */
	private String renameValues(final String value, final String oldName,
		...
		if (matcher.contains(value, pattern)) {
			// replace
			String returnValue = Util.substitute(matcher, pattern,
					substitution, value, Util.SUBSTITUTE_ALL);
			return returnValue;
	...
	public List<? extends IElementParameter> getElementParametersWithChildrens() {
		List<IElementParameter> fullListParam = new ArrayList<IElementParameter>(
		...
		for (IElementParameter curParam : elementParameters) {
			if (curParam.getChildParameters() != null) {
				for (String key : curParam.getChildParameters().keySet()) {
					IElementParameter childParam = curParam
							.getChildParameters().get(key);
	...
	public boolean isGeneratedAsVirtualComponent() {
		List<IMultipleComponentManager> multipleComponentManagers = getComponent()
