...
public class SchemaIndicatorImpl extends CompositeIndicatorImpl implements SchemaIndicator {
    ...
    public void setTableCount(int newTableCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.SCHEMA_INDICATOR__TABLE_COUNT,
                    oldTableCount, tableCount));
    }
    ...
    public void setKeyCount(int newKeyCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.SCHEMA_INDICATOR__KEY_COUNT,
    ...
    public void setIndexCount(int newIndexCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.SCHEMA_INDICATOR__INDEX_COUNT,
    ...
    public void setViewCount(int newViewCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.SCHEMA_INDICATOR__VIEW_COUNT,
    ...
    public void setTriggerCount(int newTriggerCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.SCHEMA_INDICATOR__TRIGGER_COUNT,
