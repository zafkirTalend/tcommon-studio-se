 ...
 * @generated
 */
public enum SqlRelationalOperator implements Enumerator {
    /**
    ...
    /**
     * An array of all the '<em><b>Sql Relational Operator</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private static final SqlRelationalOperator[] VALUES_ARRAY =
        new SqlRelationalOperator[] {
            EQUAL,
            NOT_EQUAL,
            GREATER,
            LESS,
    ...
    /**
     * A public read-only list of all the '<em><b>Sql Relational Operator</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static final List<SqlRelationalOperator> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>Sql Relational Operator</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static SqlRelationalOperator get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            SqlRelationalOperator result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Sql Relational Operator</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static SqlRelationalOperator getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            SqlRelationalOperator result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Sql Relational Operator</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static SqlRelationalOperator get(int value) {
        switch (value) {
     ...
     * @generated
     */
    private SqlRelationalOperator(int value, String name, String literal) {
        this.value = value;
        this.name = name;
