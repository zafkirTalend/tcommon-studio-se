...
public class MetadataTypeLengthPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    public MetadataTypeLengthPreferencePage() {
        super(GRID);
        setPreferenceStore(MetadataManagmentUiPlugin.getDefault().getPreferenceStore());
    }
    ...
    private void createPerlFieldEditors(Composite com) {
        ...
        comboValueTypeField = new ComboFieldEditor(MetadataTypeLengthConstants.PERL_VALUE_DEFAULT_TYPE,
        ...
        valueLengthField = new StringFieldEditor(MetadataTypeLengthConstants.PERL_VALUE_DEFAULT_LENGTH,
        ...
        comboFieldTypeField = new ComboFieldEditor(MetadataTypeLengthConstants.PERL_FIELD_DEFAULT_TYPE,
        ...
        gridLayout.numColumns = 6;
        com.setLayout(gridLayout);
        fieldLengthField = new StringFieldEditor(MetadataTypeLengthConstants.PERL_FIELD_DEFAULT_LENGTH,
        ...
        booleanField = new StringFieldEditor(MetadataTypeLengthConstants.PERL_BOOLEAN,
                Messages.getString("MetadataTypeLengthConstants.BOOLEAN_LENGTH"), dbTypeGroup); //$NON-NLS-1$
        bigDecimalField = new StringFieldEditor(MetadataTypeLengthConstants.PERL_DECIMAL,
        ...
        integerField = new StringFieldEditor(MetadataTypeLengthConstants.PERL_INT,
        ...
        dateField = new StringFieldEditor(MetadataTypeLengthConstants.PERL_DATE,
        ...
        stringField = new StringFieldEditor(MetadataTypeLengthConstants.PERL_STRING,
        ...
        datetimeField = new StringFieldEditor(MetadataTypeLengthConstants.PERL_DATETIME,
                Messages.getString("MetadataTypeLengthConstants.DATETIME_LENGTH"), dbTypeGroup); //$NON-NLS-1$
