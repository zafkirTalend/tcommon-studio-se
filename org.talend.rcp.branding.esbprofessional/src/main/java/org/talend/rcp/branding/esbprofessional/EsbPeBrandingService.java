...
//
// ============================================================================
package org.talend.rcp.branding.esbprofessional;
...
import org.talend.rcp.branding.esbprofessional.i18n.Messages;

/**
 * DOC guanglong.du class global comment. Detailled comment
 */
public class EsbPeBrandingService extends AbstractTalendBrandingService {

    protected IBrandingConfiguration brandingConfigure;

    public String getShortProductName() {
        return "ESB PE"; //$NON-NLS-1$
    }
