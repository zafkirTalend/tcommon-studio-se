...
//		selenium.setSpeed(MID_SPEED);
		Assert.assertTrue(this.waitForTextPresent("Save failed: End time cannot be before start time -- For more information see your log file",WAIT_TIME),"SimpleTrigger endTime before startTime failed!");
		Thread.sleep(3000);
