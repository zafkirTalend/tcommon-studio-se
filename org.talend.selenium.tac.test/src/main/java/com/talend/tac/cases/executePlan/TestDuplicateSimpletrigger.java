...
public class TestDuplicateSimpletrigger extends Login {
	...
	public void testAddTriggerAddSimpleTrigger(String plan,String simpleTriggerToduplicate) {
		...
		selenium.mouseDown("//div[text()='" + simpleTriggerToduplicate + "']");//
		...
		selenium.click("//span[text()='" + date.getFuture(24).days + "']");
		...
		selenium.setSpeed(MAX_SPEED);
		// selenium.click("//div[@class=' x-icon-btn x-nodrag x-date-left-icon x-component ']");
		selenium.click("//span[text()='" + date.getFuture(72).days + "']");
		selenium.setSpeed(MIN_SPEED);
