...
public class AddESBConductor extends WebDriverBase{
	...
	public void editEsbConductor(String label, String des, String repository,
        ...
        this.waitforElementDisplayed(By.xpath("//span[text()='Select" +
				" Feature from Talend repository']"), WAIT_TIME_MAX);		
        this.waitforElementDisplayed(By.xpath("//label[text()='Repository:']//following-sibling::div//div[contains(@class,'x-form-trigger x-form-trigger-arrow')]"), 60);         
        this.clickElementByXpath("//label[text()='Repository:']//following-sibling::div//div[contains(@class,'x-form-trigger x-form-trigger-arrow')]");
        logger.info("--------Repository:"+repository);
        this.waitforElementDisplayed(By.xpath("//div[text()='"+repository+"'and @role='listitem']"), 30);
        getElementByXpath("//div[text()='"+repository+"'and @role='listitem']").click();
		this.getElementByXpath("//span[text()='" + group + "']").click();
		this.getElementByXpath("//div[text()='" + artifact + "']")
			.click();
	...
	public void verifyEditedConductor(String label, String des, String repository,
		...
		Assert.assertTrue(this.getElementById("idESBConductorTaskFeatureUrlInput").getAttribute("value").equals("mvn:org."+group+"/"+artifact+"/"+version+"/xml"));
