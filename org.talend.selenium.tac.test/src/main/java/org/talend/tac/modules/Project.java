...
public class Project extends WebDriverBase {
	...
	protected void deleteProject(String projectLabel) {
		...
		this.isElementPresent(By.xpath("//div[text()='Projects' and @class='header-title']/ancestor::div[@class='x-panel-body x-panel-body-noheader x-panel-body-noborder x-border-layout-ct']//button[@id='idSubModuleDeleteButton' and @aria-disabled='false']"), WAIT_TIME_MIN);
