 ...
 * @generated
 */
public class RelationalItemProviderAdapterFactory extends RelationalAdapterFactory implements ComposeableAdapterFactory,
    ...
    public void dispose() {
        if (tdTableItemProvider != null)
            tdTableItemProvider.dispose();
        if (tdViewItemProvider != null)
            tdViewItemProvider.dispose();
        if (tdColumnItemProvider != null)
            tdColumnItemProvider.dispose();
        if (tdSqlDataTypeItemProvider != null)
            tdSqlDataTypeItemProvider.dispose();
        if (tdTriggerItemProvider != null)
