...
/**
 * This is the item provider adapter for a {@link org.talend.core.model.properties.LinkType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkTypeItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LinkType_URI_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_LinkType_URI_feature", "_UI_LinkType_type"),
                 PropertiesPackage.Literals.LINK_TYPE__URI,
                 true,
                 false,
                 false,
    ...
    protected void addStatePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LinkType_state_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_LinkType_state_feature", "_UI_LinkType_type"),
                 PropertiesPackage.Literals.LINK_TYPE__STATE,
                 true,
                 false,
                 false,
    ...
    public String getText(Object object) {
        String label = ((LinkType)object).getURI();
