            ...
            treeViewer.setSorter(new ViewerSorter() {
                ...
                public int compare(Viewer viewer, Object e1, Object e2) {
                    if (e1 instanceof RepositoryNode && e2 instanceof RepositoryNode) {
                        ...
                        if (node1.isBin() || node1.getType().equals(ENodeType.REFERENCED_PROJECT)) { // recycle bin is always in bottom
                            return 1;
                        }
                        if (node2.isBin() || node2.getType().equals(ENodeType.REFERENCED_PROJECT)) { // recycle bin is always in bottom
                            return -1;
                        }
