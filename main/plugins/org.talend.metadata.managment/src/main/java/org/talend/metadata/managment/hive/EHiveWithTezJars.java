...
public enum EHiveWithTezJars {
    ...
    HDP_2_3(new String[] { "aopalliance-1.0.jar", "apacheds-i18n-2.0.0-M15.jar", "apacheds-kerberos-codec-2.0.0-M15.jar",
            ...
            "guice-servlet-3.0.jar", "hadoop-auth-2.7.1.2.3.0.0-2557.jar", "hadoop-common-2.7.1.2.3.0.0-2557.jar",
            "hadoop-hdfs-2.7.1.2.3.0.0-2557.jar", "hadoop-yarn-api-2.7.1.2.3.0.0-2557.jar",
            "hadoop-yarn-client-2.7.1.2.3.0.0-2557.jar", "hadoop-yarn-common-2.7.1.2.3.0.0-2557.jar",
            ...
            "xercesImpl-2.9.1.jar", "xml-apis-1.3.04.jar", "xmlenc-0.52.jar", "xz-1.0.jar", "zookeeper-3.4.6.2.3.0.0-2557.jar" }),
