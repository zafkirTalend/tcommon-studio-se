...
public class JunitContainerFigure extends Figure {
    ...
    private void refreshNodes() {
        boolean isRed = false;// new JobletUtil().isRed(this.jobletContainer);
        // Project refProject =
        // ProjectManager.getInstance().getProject(this.jobletContainer.getProcess().getProperty().getItem());
