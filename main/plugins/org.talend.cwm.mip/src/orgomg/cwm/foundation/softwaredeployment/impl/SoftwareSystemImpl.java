...
public class SoftwareSystemImpl extends SubsystemImpl implements SoftwareSystem {
    ...
    public void setSubtype(String newSubtype) {
        ...
        subtype = newSubtype;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.SOFTWARE_SYSTEM__SUBTYPE, oldSubtype,
                    subtype));
    }
    ...
    public void setSupplier(String newSupplier) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.SOFTWARE_SYSTEM__SUPPLIER,
    ...
    public void setVersion(String newVersion) {
        ...
        version = newVersion;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.SOFTWARE_SYSTEM__VERSION, oldVersion,
                    version));
    }
    ...
    public EList<DeployedSoftwareSystem> getDeployment() {
        if (deployment == null) {
            deployment = new EObjectWithInverseResolvingEList<DeployedSoftwareSystem>(DeployedSoftwareSystem.class, this,
                    SoftwaredeploymentPackage.SOFTWARE_SYSTEM__DEPLOYMENT,
                    SoftwaredeploymentPackage.DEPLOYED_SOFTWARE_SYSTEM__SOFTWARE_SYSTEM);
        }
        return deployment;
    }
    ...
    public EList<TypeSystem> getTypespace() {
        if (typespace == null) {
            typespace = new EObjectWithInverseResolvingEList.ManyInverse<TypeSystem>(TypeSystem.class, this,
                    SoftwaredeploymentPackage.SOFTWARE_SYSTEM__TYPESPACE, TypemappingPackage.TYPE_SYSTEM__SUPPORTING_SYSTEM);
        }
        return typespace;
    }
