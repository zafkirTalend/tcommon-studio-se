...
public class ProviderConnectionImpl extends ModelElementImpl implements ProviderConnection {
    ...
    public void setIsReadOnly(boolean newIsReadOnly) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.PROVIDER_CONNECTION__IS_READ_ONLY,
    ...
    public DataProvider getDataProvider() {
        if (eContainerFeatureID() != SoftwaredeploymentPackage.PROVIDER_CONNECTION__DATA_PROVIDER)
            return null;
    ...
    public NotificationChain basicSetDataProvider(DataProvider newDataProvider, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newDataProvider,
                SoftwaredeploymentPackage.PROVIDER_CONNECTION__DATA_PROVIDER, msgs);
        return msgs;
    }
    ...
    public void setDataProvider(DataProvider newDataProvider) {
        if (newDataProvider != eInternalContainer()
                || (eContainerFeatureID() != SoftwaredeploymentPackage.PROVIDER_CONNECTION__DATA_PROVIDER && newDataProvider != null)) {
            ...
            if (newDataProvider != null)
                msgs = ((InternalEObject) newDataProvider).eInverseAdd(this,
                        SoftwaredeploymentPackage.DATA_PROVIDER__RESOURCE_CONNECTION, DataProvider.class, msgs);
            msgs = basicSetDataProvider(newDataProvider, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.PROVIDER_CONNECTION__DATA_PROVIDER,
            ...
            if (dataManager != oldDataManager) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            SoftwaredeploymentPackage.PROVIDER_CONNECTION__DATA_MANAGER, oldDataManager, dataManager));
            }
        }
        return dataManager;
    }
    ...
    public NotificationChain basicSetDataManager(DataManager newDataManager, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SoftwaredeploymentPackage.PROVIDER_CONNECTION__DATA_MANAGER, oldDataManager, newDataManager);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDataManager(DataManager newDataManager) {
        if (newDataManager != dataManager) {
            NotificationChain msgs = null;
            if (dataManager != null)
                msgs = ((InternalEObject) dataManager).eInverseRemove(this,
                        SoftwaredeploymentPackage.DATA_MANAGER__CLIENT_CONNECTION, DataManager.class, msgs);
            if (newDataManager != null)
                msgs = ((InternalEObject) newDataManager).eInverseAdd(this,
                        SoftwaredeploymentPackage.DATA_MANAGER__CLIENT_CONNECTION, DataManager.class, msgs);
            msgs = basicSetDataManager(newDataManager, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SoftwaredeploymentPackage.PROVIDER_CONNECTION__DATA_MANAGER,
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case SoftwaredeploymentPackage.PROVIDER_CONNECTION__DATA_PROVIDER:
            return eInternalContainer().eInverseRemove(this, SoftwaredeploymentPackage.DATA_PROVIDER__RESOURCE_CONNECTION,
                    DataProvider.class, msgs);
        }
