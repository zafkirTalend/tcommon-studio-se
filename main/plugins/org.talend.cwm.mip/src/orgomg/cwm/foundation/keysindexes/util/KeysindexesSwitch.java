...
public class KeysindexesSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case KeysindexesPackage.UNIQUE_KEY: {
            ...
            if (result == null)
                result = caseModelElement(uniqueKey);
            if (result == null)
                result = caseElement(uniqueKey);
            if (result == null)
        ...
        case KeysindexesPackage.KEY_RELATIONSHIP: {
            ...
            if (result == null)
                result = caseModelElement(keyRelationship);
            if (result == null)
                result = caseElement(keyRelationship);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case KeysindexesPackage.INDEXED_FEATURE: {
            ...
            if (result == null)
                result = caseModelElement(indexedFeature);
            if (result == null)
                result = caseElement(indexedFeature);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
