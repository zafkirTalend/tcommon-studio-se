...
public class KeysindexesPackageImpl extends EPackageImpl implements KeysindexesPackage {
     ...
     * 
     * <p>
     * This method is used to initialize {@link KeysindexesPackage#eINSTANCE}
    ...
    public static KeysindexesPackage init() {
        if (isInited)
            return (KeysindexesPackage) EPackage.Registry.INSTANCE.getEPackage(KeysindexesPackage.eNS_URI);

        // Obtain or create and register package
        KeysindexesPackageImpl theKeysindexesPackage = (KeysindexesPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof KeysindexesPackageImpl ? EPackage.Registry.INSTANCE
                .get(eNS_URI) : new KeysindexesPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEReference(getUniqueKey_Feature(), theCorePackage.getStructuralFeature(),
                theCorePackage.getStructuralFeature_UniqueKey(), "feature", null, 1, -1, UniqueKey.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getUniqueKey_KeyRelationship(), this.getKeyRelationship(), this.getKeyRelationship_UniqueKey(),
                "keyRelationship", null, 0, -1, UniqueKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(indexEClass, Index.class, "Index", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getIndex_IsPartitioning(), theCorePackage.getBoolean(), "isPartitioning", null, 0, 1, Index.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getIndex_IsSorted(), theCorePackage.getBoolean(), "isSorted", null, 0, 1, Index.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getIndex_IsUnique(), theCorePackage.getBoolean(), "isUnique", null, 0, 1, Index.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getIndex_IndexedFeature(), this.getIndexedFeature(), this.getIndexedFeature_Index(), "indexedFeature",
                null, 0, -1, Index.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getIndex_SpannedClass(), theCorePackage.getClass_(), theCorePackage.getClass_Index(), "spannedClass",
                null, 1, 1, Index.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(keyRelationshipEClass, KeyRelationship.class, "KeyRelationship", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getKeyRelationship_Feature(), theCorePackage.getStructuralFeature(),
                theCorePackage.getStructuralFeature_KeyRelationship(), "feature", null, 1, -1, KeyRelationship.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getKeyRelationship_UniqueKey(), this.getUniqueKey(), this.getUniqueKey_KeyRelationship(), "uniqueKey",
                null, 1, 1, KeyRelationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(indexedFeatureEClass, IndexedFeature.class, "IndexedFeature", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getIndexedFeature_IsAscending(), theCorePackage.getBoolean(), "isAscending", null, 0, 1,
                IndexedFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getIndexedFeature_Feature(), theCorePackage.getStructuralFeature(),
                theCorePackage.getStructuralFeature_IndexedFeature(), "feature", null, 1, 1, IndexedFeature.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getIndexedFeature_Index(), this.getIndex(), this.getIndex_IndexedFeature(), "index", null, 1, 1,
                IndexedFeature.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
