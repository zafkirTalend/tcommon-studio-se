...
public class IndexImpl extends ModelElementImpl implements Index {
    ...
    /**
     * The cached value of the '{@link #getIndexedFeature()
     * <em>Indexed Feature</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    public void setIsPartitioning(boolean newIsPartitioning) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KeysindexesPackage.INDEX__IS_PARTITIONING, oldIsPartitioning,
                    isPartitioning));
    }
    ...
    public EList<IndexedFeature> getIndexedFeature() {
        if (indexedFeature == null) {
            indexedFeature = new EObjectContainmentWithInverseEList<IndexedFeature>(IndexedFeature.class, this,
                    KeysindexesPackage.INDEX__INDEXED_FEATURE, KeysindexesPackage.INDEXED_FEATURE__INDEX);
        }
    ...
    public orgomg.cwm.objectmodel.core.Class getSpannedClass() {
        if (spannedClass != null && spannedClass.eIsProxy()) {
            ...
            if (spannedClass != oldSpannedClass) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, KeysindexesPackage.INDEX__SPANNED_CLASS,
                            oldSpannedClass, spannedClass));
            }
        }
        return spannedClass;
    }
    ...
    public NotificationChain basicSetSpannedClass(orgomg.cwm.objectmodel.core.Class newSpannedClass, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    KeysindexesPackage.INDEX__SPANNED_CLASS, oldSpannedClass, newSpannedClass);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setSpannedClass(orgomg.cwm.objectmodel.core.Class newSpannedClass) {
        if (newSpannedClass != spannedClass) {
            ...
            if (spannedClass != null)
                msgs = ((InternalEObject) spannedClass).eInverseRemove(this, CorePackage.CLASS__INDEX,
                        orgomg.cwm.objectmodel.core.Class.class, msgs);
            if (newSpannedClass != null)
                msgs = ((InternalEObject) newSpannedClass).eInverseAdd(this, CorePackage.CLASS__INDEX,
                        orgomg.cwm.objectmodel.core.Class.class, msgs);
            msgs = basicSetSpannedClass(newSpannedClass, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KeysindexesPackage.INDEX__SPANNED_CLASS, newSpannedClass,
                    newSpannedClass));
    }
