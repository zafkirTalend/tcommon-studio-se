...
public class ResponsiblePartyImpl extends NamespaceImpl implements ResponsibleParty {
    ...
    public void setResponsibility(String newResponsibility) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BusinessinformationPackage.RESPONSIBLE_PARTY__RESPONSIBILITY,
    ...
    public EList<ModelElement> getModelElement() {
        if (modelElement == null) {
            modelElement = new EObjectWithInverseResolvingEList.ManyInverse<ModelElement>(ModelElement.class, this,
                    BusinessinformationPackage.RESPONSIBLE_PARTY__MODEL_ELEMENT, CorePackage.MODEL_ELEMENT__RESPONSIBLE_PARTY);
        }
        return modelElement;
    }
