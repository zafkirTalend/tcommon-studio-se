 ...
 * <em><b>Tagged Value</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class TaggedValueImpl extends ElementImpl implements TaggedValue {
    ...
    public Stereotype getStereotype() {
        if (eContainerFeatureID() != CorePackage.TAGGED_VALUE__STEREOTYPE)
            return null;
    ...
    public void setStereotype(Stereotype newStereotype) {
        if (newStereotype != eInternalContainer()
                || (eContainerFeatureID() != CorePackage.TAGGED_VALUE__STEREOTYPE && newStereotype != null)) {
            ...
            if (newStereotype != null)
                msgs = ((InternalEObject) newStereotype).eInverseAdd(this, CorePackage.STEREOTYPE__REQUIRED_TAG,
                        Stereotype.class, msgs);
            msgs = basicSetStereotype(newStereotype, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.TAGGED_VALUE__STEREOTYPE, newStereotype,
                    newStereotype));
    }
    ...
    public ModelElement getModelElement() {
        if (eContainerFeatureID() != CorePackage.TAGGED_VALUE__MODEL_ELEMENT)
            return null;
    ...
    public void setModelElement(ModelElement newModelElement) {
        if (newModelElement != eInternalContainer()
                || (eContainerFeatureID() != CorePackage.TAGGED_VALUE__MODEL_ELEMENT && newModelElement != null)) {
            ...
            if (newModelElement != null)
                msgs = ((InternalEObject) newModelElement).eInverseAdd(this, CorePackage.MODEL_ELEMENT__TAGGED_VALUE,
                        ModelElement.class, msgs);
            msgs = basicSetModelElement(newModelElement, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.TAGGED_VALUE__MODEL_ELEMENT, newModelElement,
                    newModelElement));
    }
