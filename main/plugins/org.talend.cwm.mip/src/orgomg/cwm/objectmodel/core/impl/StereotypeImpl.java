...
public class StereotypeImpl extends ModelElementImpl implements Stereotype {
    ...
    /**
     * The cached value of the '{@link #getStereotypeConstraint()
     * <em>Stereotype Constraint</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    public EList<Constraint> getStereotypeConstraint() {
        if (stereotypeConstraint == null) {
            stereotypeConstraint = new EObjectContainmentWithInverseEList<Constraint>(Constraint.class, this,
                    CorePackage.STEREOTYPE__STEREOTYPE_CONSTRAINT, CorePackage.CONSTRAINT__CONSTRAINED_STEREOTYPE);
        }
    ...
    public EList<ModelElement> getExtendedElement() {
        if (extendedElement == null) {
            extendedElement = new EObjectWithInverseResolvingEList<ModelElement>(ModelElement.class, this,
                    CorePackage.STEREOTYPE__EXTENDED_ELEMENT, CorePackage.MODEL_ELEMENT__STEREOTYPE);
        }
    ...
    public EList<TaggedValue> getRequiredTag() {
        if (requiredTag == null) {
            requiredTag = new EObjectContainmentWithInverseEList<TaggedValue>(TaggedValue.class, this,
                    CorePackage.STEREOTYPE__REQUIRED_TAG, CorePackage.TAGGED_VALUE__STEREOTYPE);
        }
        return requiredTag;
    }
