...
public interface Operation extends BehavioralFeature {
     ...
     * true, then the Operation does not have an implementation, and one must be
     * supplied by a descendant. If false, the Operation must have an
     * implementation in the class or inherited from an ancestor. <!--
     * end-model-doc -->
     * 
     ...
     * {@link orgomg.cwm.objectmodel.behavioral.CallAction}. It is bidirectional
     * and its opposite is '
     * {@link orgomg.cwm.objectmodel.behavioral.CallAction#getOperation
     * <em>Operation</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Identifies the CallAction instance representing a
     * particular invocation of an Operation. <!-- end-model-doc -->
     * 
