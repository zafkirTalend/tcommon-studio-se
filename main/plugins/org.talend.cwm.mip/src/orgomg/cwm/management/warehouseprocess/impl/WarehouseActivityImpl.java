...
public class WarehouseActivityImpl extends WarehouseProcessImpl implements WarehouseActivity {
    ...
    public EList<WarehouseStep> getWarehouseStep() {
        if (warehouseStep == null) {
            warehouseStep = new EObjectContainmentWithInverseEList<WarehouseStep>(WarehouseStep.class, this,
                    WarehouseprocessPackage.WAREHOUSE_ACTIVITY__WAREHOUSE_STEP,
                    WarehouseprocessPackage.WAREHOUSE_STEP__WAREHOUSE_ACTIVITY);
        }
            ...
            if (transformationActivity != oldTransformationActivity) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            WarehouseprocessPackage.WAREHOUSE_ACTIVITY__TRANSFORMATION_ACTIVITY, oldTransformationActivity,
        ...
        if (newTransformationActivity != transformationActivity) {
            ...
            if (transformationActivity != null)
                msgs = ((InternalEObject) transformationActivity).eInverseRemove(this,
                        TransformationPackage.TRANSFORMATION_ACTIVITY__WAREHOUSE_ACTIVITY, TransformationActivity.class, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WarehouseprocessPackage.WAREHOUSE_ACTIVITY__TRANSFORMATION_ACTIVITY, newTransformationActivity,
                    newTransformationActivity));
    }
