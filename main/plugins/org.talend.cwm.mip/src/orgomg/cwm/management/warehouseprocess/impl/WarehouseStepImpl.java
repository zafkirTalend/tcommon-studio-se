...
public class WarehouseStepImpl extends WarehouseProcessImpl implements WarehouseStep {
            ...
            if (transformationStep != oldTransformationStep) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            WarehouseprocessPackage.WAREHOUSE_STEP__TRANSFORMATION_STEP, oldTransformationStep,
                            transformationStep));
            }
        }
    ...
    public NotificationChain basicSetTransformationStep(TransformationStep newTransformationStep, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    WarehouseprocessPackage.WAREHOUSE_STEP__TRANSFORMATION_STEP, oldTransformationStep, newTransformationStep);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newTransformationStep != transformationStep) {
            ...
            if (transformationStep != null)
                msgs = ((InternalEObject) transformationStep).eInverseRemove(this,
                        TransformationPackage.TRANSFORMATION_STEP__WAREHOUSE_STEP, TransformationStep.class, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, WarehouseprocessPackage.WAREHOUSE_STEP__TRANSFORMATION_STEP,
    ...
    public WarehouseActivity getWarehouseActivity() {
        if (eContainerFeatureID() != WarehouseprocessPackage.WAREHOUSE_STEP__WAREHOUSE_ACTIVITY)
            return null;
    ...
    public NotificationChain basicSetWarehouseActivity(WarehouseActivity newWarehouseActivity, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newWarehouseActivity,
                WarehouseprocessPackage.WAREHOUSE_STEP__WAREHOUSE_ACTIVITY, msgs);
        return msgs;
    }
    ...
    public void setWarehouseActivity(WarehouseActivity newWarehouseActivity) {
        if (newWarehouseActivity != eInternalContainer()
                || (eContainerFeatureID() != WarehouseprocessPackage.WAREHOUSE_STEP__WAREHOUSE_ACTIVITY && newWarehouseActivity != null)) {
            ...
            if (newWarehouseActivity != null)
                msgs = ((InternalEObject) newWarehouseActivity).eInverseAdd(this,
                        WarehouseprocessPackage.WAREHOUSE_ACTIVITY__WAREHOUSE_STEP, WarehouseActivity.class, msgs);
            msgs = basicSetWarehouseActivity(newWarehouseActivity, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WarehouseprocessPackage.WAREHOUSE_STEP__WAREHOUSE_ACTIVITY,
                    newWarehouseActivity, newWarehouseActivity));
    }
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        ...
        case WarehouseprocessPackage.WAREHOUSE_STEP__WAREHOUSE_ACTIVITY:
            return eInternalContainer().eInverseRemove(this, WarehouseprocessPackage.WAREHOUSE_ACTIVITY__WAREHOUSE_STEP,
                    WarehouseActivity.class, msgs);
        }
