...
public class TransformationTaskImpl extends ComponentImpl implements TransformationTask {
    ...
    public EList<TransformationStep> getStep() {
        if (step == null) {
            step = new EObjectWithInverseResolvingEList<TransformationStep>(TransformationStep.class, this,
                    TransformationPackage.TRANSFORMATION_TASK__STEP, TransformationPackage.TRANSFORMATION_STEP__TASK);
        }
        return step;
    }
    ...
    public EList<TransformationTask> getOriginalTask() {
        if (originalTask == null) {
            originalTask = new EObjectWithInverseResolvingEList.ManyInverse<TransformationTask>(TransformationTask.class, this,
                    TransformationPackage.TRANSFORMATION_TASK__ORIGINAL_TASK,
                    TransformationPackage.TRANSFORMATION_TASK__INVERSE_TASK);
        }
        return originalTask;
    }
    ...
    public EList<TransformationTask> getInverseTask() {
        if (inverseTask == null) {
            inverseTask = new EObjectWithInverseResolvingEList.ManyInverse<TransformationTask>(TransformationTask.class, this,
                    TransformationPackage.TRANSFORMATION_TASK__INVERSE_TASK,
                    TransformationPackage.TRANSFORMATION_TASK__ORIGINAL_TASK);
        }
        return inverseTask;
    ...
    public EList<Transformation> getTransformation() {
        if (transformation == null) {
            transformation = new EObjectWithInverseResolvingEList.ManyInverse<Transformation>(Transformation.class, this,
                    TransformationPackage.TRANSFORMATION_TASK__TRANSFORMATION, TransformationPackage.TRANSFORMATION__TASK);
        }
