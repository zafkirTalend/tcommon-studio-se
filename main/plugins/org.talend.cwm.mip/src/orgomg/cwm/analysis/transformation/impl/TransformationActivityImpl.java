...
public class TransformationActivityImpl extends SubsystemImpl implements TransformationActivity {
    ...
    public void setCreationDate(String newCreationDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TransformationPackage.TRANSFORMATION_ACTIVITY__CREATION_DATE,
    ...
    public EList<WarehouseActivity> getWarehouseActivity() {
        if (warehouseActivity == null) {
            warehouseActivity = new EObjectWithInverseResolvingEList<WarehouseActivity>(WarehouseActivity.class, this,
                    TransformationPackage.TRANSFORMATION_ACTIVITY__WAREHOUSE_ACTIVITY,
                    WarehouseprocessPackage.WAREHOUSE_ACTIVITY__TRANSFORMATION_ACTIVITY);
        }
    ...
    public EList<ActivityExecution> getExecution() {
        if (execution == null) {
            execution = new EObjectWithInverseResolvingEList<ActivityExecution>(ActivityExecution.class, this,
                    TransformationPackage.TRANSFORMATION_ACTIVITY__EXECUTION,
                    WarehouseoperationPackage.ACTIVITY_EXECUTION__TRANSFORMATION_ACTIVITY);
        }
        return execution;
    }
