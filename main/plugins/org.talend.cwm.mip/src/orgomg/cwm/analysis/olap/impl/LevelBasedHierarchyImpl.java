...
public class LevelBasedHierarchyImpl extends HierarchyImpl implements LevelBasedHierarchy {
    ...
    /**
     * The cached value of the '{@link #getHierarchyLevelAssociation()
     * <em>Hierarchy Level Association</em>}' containment reference list. <!--
    ...
    public EList<HierarchyLevelAssociation> getHierarchyLevelAssociation() {
        if (hierarchyLevelAssociation == null) {
            hierarchyLevelAssociation = new EObjectContainmentWithInverseEList<HierarchyLevelAssociation>(
                    HierarchyLevelAssociation.class, this, OlapPackage.LEVEL_BASED_HIERARCHY__HIERARCHY_LEVEL_ASSOCIATION,
                    OlapPackage.HIERARCHY_LEVEL_ASSOCIATION__LEVEL_BASED_HIERARCHY);
        }
