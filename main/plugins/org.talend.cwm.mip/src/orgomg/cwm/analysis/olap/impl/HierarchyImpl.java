 ...
 * <em><b>Hierarchy</b></em>'. <!-- end-user-doc -->
 * <p>
...
public abstract class HierarchyImpl extends ClassImpl implements Hierarchy {
    ...
    public Dimension getDimension() {
        if (eContainerFeatureID() != OlapPackage.HIERARCHY__DIMENSION)
            return null;
    ...
    public void setDimension(Dimension newDimension) {
        if (newDimension != eInternalContainer()
                || (eContainerFeatureID() != OlapPackage.HIERARCHY__DIMENSION && newDimension != null)) {
            ...
            if (newDimension != null)
                msgs = ((InternalEObject) newDimension)
                        .eInverseAdd(this, OlapPackage.DIMENSION__HIERARCHY, Dimension.class, msgs);
        ...
        if (defaultedDimension != null && defaultedDimension.eIsProxy()) {
            ...
            if (defaultedDimension != oldDefaultedDimension) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, OlapPackage.HIERARCHY__DEFAULTED_DIMENSION,
                            oldDefaultedDimension, defaultedDimension));
            }
        }
    ...
    public NotificationChain basicSetDefaultedDimension(Dimension newDefaultedDimension, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    OlapPackage.HIERARCHY__DEFAULTED_DIMENSION, oldDefaultedDimension, newDefaultedDimension);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setDefaultedDimension(Dimension newDefaultedDimension) {
        if (newDefaultedDimension != defaultedDimension) {
            ...
            if (defaultedDimension != null)
                msgs = ((InternalEObject) defaultedDimension).eInverseRemove(this, OlapPackage.DIMENSION__DISPLAY_DEFAULT,
                        Dimension.class, msgs);
            if (newDefaultedDimension != null)
                msgs = ((InternalEObject) newDefaultedDimension).eInverseAdd(this, OlapPackage.DIMENSION__DISPLAY_DEFAULT,
                        Dimension.class, msgs);
            msgs = basicSetDefaultedDimension(newDefaultedDimension, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OlapPackage.HIERARCHY__DEFAULTED_DIMENSION,
                    newDefaultedDimension, newDefaultedDimension));
    }
    ...
    public EList<CubeDimensionAssociation> getCubeDimensionAssociation() {
        if (cubeDimensionAssociation == null) {
            cubeDimensionAssociation = new EObjectWithInverseResolvingEList<CubeDimensionAssociation>(
                    CubeDimensionAssociation.class, this, OlapPackage.HIERARCHY__CUBE_DIMENSION_ASSOCIATION,
                    OlapPackage.CUBE_DIMENSION_ASSOCIATION__CALC_HIERARCHY);
        }
