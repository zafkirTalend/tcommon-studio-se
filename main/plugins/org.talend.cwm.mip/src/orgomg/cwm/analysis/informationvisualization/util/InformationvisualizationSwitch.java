...
public class InformationvisualizationSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case InformationvisualizationPackage.RENDERED_OBJECT: {
            ...
            if (result == null)
                result = caseClassifier(renderedObject);
            if (result == null)
                result = caseNamespace(renderedObject);
            if (result == null)
                result = caseModelElement(renderedObject);
            if (result == null)
                result = caseElement(renderedObject);
            if (result == null)
        ...
        case InformationvisualizationPackage.RENDERED_OBJECT_SET: {
            ...
            if (result == null)
                result = casePackage(renderedObjectSet);
            if (result == null)
                result = caseNamespace(renderedObjectSet);
            if (result == null)
                result = caseModelElement(renderedObjectSet);
            if (result == null)
                result = caseElement(renderedObjectSet);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case InformationvisualizationPackage.RENDERING: {
            ...
            if (result == null)
                result = caseFeature(rendering);
            if (result == null)
                result = caseModelElement(rendering);
            if (result == null)
                result = caseElement(rendering);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case InformationvisualizationPackage.XSL_RENDERING: {
            ...
            if (result == null)
                result = caseRendering(xslRendering);
            if (result == null)
                result = caseFeature(xslRendering);
            if (result == null)
                result = caseModelElement(xslRendering);
            if (result == null)
                result = caseElement(xslRendering);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
