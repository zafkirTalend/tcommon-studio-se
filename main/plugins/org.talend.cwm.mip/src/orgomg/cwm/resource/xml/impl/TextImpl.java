...
public class TextImpl extends AttributeImpl implements Text {
    ...
    public MixedContent getOwnerContent() {
        if (eContainerFeatureID() != XmlPackage.TEXT__OWNER_CONTENT)
            return null;
    ...
    public void setOwnerContent(MixedContent newOwnerContent) {
        if (newOwnerContent != eInternalContainer()
                || (eContainerFeatureID() != XmlPackage.TEXT__OWNER_CONTENT && newOwnerContent != null)) {
            ...
            if (newOwnerContent != null)
                msgs = ((InternalEObject) newOwnerContent).eInverseAdd(this, XmlPackage.MIXED_CONTENT__TEXT, MixedContent.class,
                        msgs);
            msgs = basicSetOwnerContent(newOwnerContent, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XmlPackage.TEXT__OWNER_CONTENT, newOwnerContent,
                    newOwnerContent));
    }
