 ...
 * <em><b>Referential Rule Type</b></em>', and utility methods for working with
 * them. <!-- end-user-doc --> <!-- begin-model-doc --> Used in Foreign Key. It
 * indicates the action taken on the row containing a foreign key value, when
 * the primary key value referenced is deleted or updated. <!-- end-model-doc
 * -->
 * 
...
public enum ReferentialRuleType implements Enumerator {
     ...
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The row
     * with the foreign key remains and the foreign key will not match a primary
     * key. <!-- end-model-doc -->
     * 
     ...
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The row
     * with the foreign key is deleted. <!-- end-model-doc -->
     * 
     ...
     * foreign key value is set to NULL. <!-- end-model-doc -->
     * 
     ...
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The
     * deletion or update of the primary key is not permitted and will fail.
     * <!-- end-model-doc -->
     * 
     ...
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The
     * foreign key is set to the default value of its column. <!-- end-model-doc
     * -->
     * 
     ...
     * @generated
     */
    private static final ReferentialRuleType[] VALUES_ARRAY = new ReferentialRuleType[] { IMPORTED_KEY_NO_ACTION,
            IMPORTED_KEY_CASCADE, IMPORTED_KEY_SET_NULL, IMPORTED_KEY_RESTRICT, IMPORTED_KEY_SET_DEFAULT, };
    ...
    public static ReferentialRuleType get(int value) {
        switch (value) {
        case IMPORTED_KEY_NO_ACTION_VALUE:
            return IMPORTED_KEY_NO_ACTION;
        case IMPORTED_KEY_CASCADE_VALUE:
            return IMPORTED_KEY_CASCADE;
        case IMPORTED_KEY_SET_NULL_VALUE:
            return IMPORTED_KEY_SET_NULL;
        case IMPORTED_KEY_RESTRICT_VALUE:
            return IMPORTED_KEY_RESTRICT;
        case IMPORTED_KEY_SET_DEFAULT_VALUE:
