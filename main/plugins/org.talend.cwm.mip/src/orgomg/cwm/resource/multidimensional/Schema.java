...
public interface Schema extends orgomg.cwm.objectmodel.core.Package {
    ...
    /**
     * Returns the value of the '<em><b>Dimensioned Object</b></em>' containment
     * reference list. The list contents are of type
     * {@link orgomg.cwm.resource.multidimensional.DimensionedObject}. It is
     * bidirectional and its opposite is '
     * {@link orgomg.cwm.resource.multidimensional.DimensionedObject#getSchema
     * <em>Schema</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> DimensionedObjects owned by a Schema. <!--
     * end-model-doc -->
     * 
     * @return the value of the '<em>Dimensioned Object</em>' containment
     *         reference list.
     ...
     * bidirectional and its opposite is '
     * {@link orgomg.cwm.resource.multidimensional.Dimension#getSchema
     * <em>Schema</em>}'. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Dimensions owned by a Schema. <!-- end-model-doc -->
     * 
