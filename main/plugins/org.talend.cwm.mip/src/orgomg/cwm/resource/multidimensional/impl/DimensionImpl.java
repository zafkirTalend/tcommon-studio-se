...
public class DimensionImpl extends ClassImpl implements Dimension {
    ...
    public EList<DimensionedObject> getDimensionedObject() {
        if (dimensionedObject == null) {
            dimensionedObject = new EObjectWithInverseResolvingEList.ManyInverse<DimensionedObject>(DimensionedObject.class,
                    this, MultidimensionalPackage.DIMENSION__DIMENSIONED_OBJECT,
                    MultidimensionalPackage.DIMENSIONED_OBJECT__DIMENSION);
        }
    ...
    public EList<Dimension> getComposite() {
        if (composite == null) {
            composite = new EObjectWithInverseResolvingEList.ManyInverse<Dimension>(Dimension.class, this,
                    MultidimensionalPackage.DIMENSION__COMPOSITE, MultidimensionalPackage.DIMENSION__COMPONENT);
        }
        return composite;
    }
    ...
    public EList<Dimension> getComponent() {
        if (component == null) {
            component = new EObjectWithInverseResolvingEList.ManyInverse<Dimension>(Dimension.class, this,
                    MultidimensionalPackage.DIMENSION__COMPONENT, MultidimensionalPackage.DIMENSION__COMPOSITE);
        }
        return component;
    }
    ...
    public Schema getSchema() {
        if (eContainerFeatureID() != MultidimensionalPackage.DIMENSION__SCHEMA)
            return null;
    ...
    public void setSchema(Schema newSchema) {
        if (newSchema != eInternalContainer()
                || (eContainerFeatureID() != MultidimensionalPackage.DIMENSION__SCHEMA && newSchema != null)) {
            ...
            if (newSchema != null)
                msgs = ((InternalEObject) newSchema).eInverseAdd(this, MultidimensionalPackage.SCHEMA__DIMENSION, Schema.class,
                        msgs);
    ...
    public EList<MemberSet> getMemberSet() {
        if (memberSet == null) {
            memberSet = new EObjectContainmentWithInverseEList<MemberSet>(MemberSet.class, this,
                    MultidimensionalPackage.DIMENSION__MEMBER_SET, MultidimensionalPackage.MEMBER_SET__DIMENSION);
        }
        return memberSet;
    }
