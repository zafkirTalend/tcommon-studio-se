...
public enum EDatabaseVersion4Drivers {
    ...
    MSSQL_2012(new DbVersion4Drivers(EDatabaseTypeName.MSSQL,
            "Microsoft SQL Server 2012", "Microsoft SQL Server 2012", "jtds-1.2.5.jar")), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    IMPALA_CDH5_4(new DbVersion4Drivers(EDatabaseTypeName.IMPALA, "Cloudera 5_4", "CLOUDERA_5_4", new String[] {
