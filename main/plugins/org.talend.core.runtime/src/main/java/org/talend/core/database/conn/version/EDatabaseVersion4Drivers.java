...
public enum EDatabaseVersion4Drivers {
    ...
    IMPALA_CDH4(new DbVersion4Drivers(EDatabaseTypeName.IMPALA, "Cloudera 4", "Cloudera 4", new String[] {
    ...
    IMPALA_CDH5(new DbVersion4Drivers(EDatabaseTypeName.IMPALA, "Cloudera 5", "Cloudera 5", new String[] {
