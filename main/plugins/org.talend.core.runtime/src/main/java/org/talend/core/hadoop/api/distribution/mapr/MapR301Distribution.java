 ...
 *
 */
public class MapR301Distribution extends AbstractMapRDistribution implements HDFSComponent, MRComponent {

    public MapR301Distribution(EHadoopVersion4Drivers version) {
