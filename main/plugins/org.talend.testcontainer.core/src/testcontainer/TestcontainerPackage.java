 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see testcontainer.TestcontainerFactory
 * @model kind="package"
 * @generated
 */
public interface TestcontainerPackage extends EPackage {
     ...
     * @generated
     */
    TestcontainerPackage eINSTANCE = testcontainer.impl.TestcontainerPackageImpl.init();

    /**
     * The meta object id for the '{@link testcontainer.impl.TestContainerImpl <em>Test Container</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see testcontainer.impl.TestContainerImpl
     * @see testcontainer.impl.TestcontainerPackageImpl#getTestContainer()
     * @generated
     */
     ...
     * @ordered
     */
    int TEST_CONTAINER_OPERATION_COUNT = TalendFilePackage.PROCESS_TYPE_OPERATION_COUNT + 0;

    /**
     * The meta object id for the '{@link testcontainer.impl.TestContainerNodeImpl <em>Test Container Node</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see testcontainer.impl.TestContainerNodeImpl
     * @see testcontainer.impl.TestcontainerPackageImpl#getTestContainerNode()
     * @generated
     */
    ...
    /**
     * The number of operations of the '<em>Test Container Node</em>' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    int TEST_CONTAINER_NODE_OPERATION_COUNT = TalendFilePackage.NODE_TYPE_OPERATION_COUNT + 0;


    /**
     * Returns the meta object for class '{@link testcontainer.TestContainer <em>Test Container</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for class '<em>Test Container</em>'.
     * @see testcontainer.TestContainer
     * @generated
     */
    EClass getTestContainer();

    /**
     * Returns the meta object for the containment reference list '{@link testcontainer.TestContainer#getTestContainerNodes <em>Test Container Nodes</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the containment reference list '<em>Test Container Nodes</em>'.
     * @see testcontainer.TestContainer#getTestContainerNodes()
    ...
    /**
     * Returns the meta object for class '{@link testcontainer.TestContainerNode <em>Test Container Node</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for class '<em>Test Container Node</em>'.
     * @see testcontainer.TestContainerNode
     * @generated
     */
    EClass getTestContainerNode();

    /**
     * Returns the meta object for the attribute '{@link testcontainer.TestContainerNode#getDescription <em>Description</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the attribute '<em>Description</em>'.
     * @see testcontainer.TestContainerNode#getDescription()
    ...
    /**
     * Returns the meta object for the attribute '{@link testcontainer.TestContainerNode#isInput <em>Input</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the attribute '<em>Input</em>'.
     * @see testcontainer.TestContainerNode#isInput()
     * @see #getTestContainerNode()
     * @generated
     */
    ...
    interface Literals {
        /**
         * The meta object literal for the '{@link testcontainer.impl.TestContainerImpl <em>Test Container</em>}' class.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see testcontainer.impl.TestContainerImpl
         * @see testcontainer.impl.TestcontainerPackageImpl#getTestContainer()
        ...
        /**
         * The meta object literal for the '{@link testcontainer.impl.TestContainerNodeImpl <em>Test Container Node</em>}' class.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see testcontainer.impl.TestContainerNodeImpl
         * @see testcontainer.impl.TestcontainerPackageImpl#getTestContainerNode()
