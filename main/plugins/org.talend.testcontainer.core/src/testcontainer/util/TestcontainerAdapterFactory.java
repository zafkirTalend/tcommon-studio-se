...
public class TestcontainerAdapterFactory extends AdapterFactoryImpl {
    ...
    /**
     * Creates a new adapter for an object of class '{@link testcontainer.TestContainer <em>Test Container</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link testcontainer.TestContainerNode <em>Test Container Node</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
